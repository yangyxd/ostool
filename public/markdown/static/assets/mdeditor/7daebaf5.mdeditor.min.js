      ...
      , C = function(a, b, c) {
        ...
        if ("markdown" === b)
            ...
            var i = com.zybuluo.mdeditor.common.getCurrentThemeClassName()
                , j = ' class="theme ' + i + '"';
            e = x();
            var k = `*:not(pre){color:#000!important}*{text-shadow:none!important;background:transparent!important;box-shadow:none!important}a,a:visited{text-decoration:underline;color:#04c!important}a[href]:after{content:" ("attr(href)")"}abbr[title]:after{content:" ("attr(title)")"}.ir a:after,a[href^="javascript:"]:after,a[href^="#"]:after{content:""}pre{border:1px solid#999;page-break-inside:avoid;padding:4px 4px 4px 15px!important}pre.prettyprint{display:block;box-shadow:0 1px 2px rgba(255,255,255,0.1)inset,45px 0 0 rgba(102,128,153,0.05)inset,0 1px 0 rgba(102,128,153,0.05)!important;padding:4px 4px 4px 9.5px!important}blockquote{padding:0 0 0 15px!important;margin:0 0 20px!important;border-left:5px solid#eee;line-height:25px;font-weight:300;page-break-inside:avoid}code,pre{font-family:Monaco,Menlo,Consolas,"Courier New",monospace}thead{display:table-header-group}tr,img{page-break-inside:avoid}img{max-width:100%!important}@page{margin:.5cm}p,h2,h3{orphans:3;widows:3}h2,h3{page-break-after:avoid}table{max-width:100%;border-collapse:collapse;border-spacing:0}.table{width:100%;margin-bottom:20px;display:block;border-collapse:collapse;border-spacing:0}.table th,.table td{padding:6px;line-height:20px;text-align:left;vertical-align:top;border:1px solid#666}.table th{font-weight:500}.table thead th{vertical-align:bottom}ol.linenums{margin-top:0;margin-bottom:0;color:rgba(0,0,0,0.65)!important}ul.todo-list-item,ol.todo-list-item{padding:0;margin:0 0 10px 25px}li.todo-list-item{list-style:none}li.todo-list-item i{margin:0 6px 0-20px;vertical-align:middle}`;
            var icon = `
@font-face {
...
blockquote>p {text-indent:0em!important; padding-left: 0!important}
...
com.zybuluo.mdeditor.init = function(a) {
    ...
    Markdown.Extra.init(A, {
        extensions: ["tables", "fenced_code_gfm", "def_list", "attr_list", "footnotes", "smartypants", "strikethrough", "iconfonts", "newlines"],
