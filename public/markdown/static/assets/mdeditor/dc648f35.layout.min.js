    ...
    a.fn.pasteImageReader = function(c) {
        ...
        this.each(function() {
            ...
            b.bind("paste", function(a) {
                ...
                return e = !1,
                b = a.clipboardData,
                Array.prototype.forEach.call(b.types, function(a, f) {
                    var g;
                    if (!e)
                        return a.match(c.matchType) || b.items[f].type.match(c.matchType) ? (g = b.items[f].getAsFile(),
                        c.callback.call(d, g),
                        e = !0) : void 0
                })
            })
...
var fullScreenApi = function() {
    ...
    if ("undefined" != typeof document.cancelFullScreen)
        ...
        for (var c = 0, d = b.length; d > c; c++)
            if (a.prefix = b[c],
            "undefined" != typeof document[a.prefix + "CancelFullScreen"]) {
                a.supportsFullScreen = !0;
                break
            }
    return a.supportsFullScreen && (a.fullScreenEventName = a.prefix + "fullscreenchange",
...
com.zybuluo.mdeditor.common.setCursorPositionEndOfContenteditable = function(a) {
    ...
    a.focus();
    var b, c, d = a.get(0);
    document.createRange ? (b = document.createRange(),
    b.selectNodeContents(d),
    b.collapse(!1),
    c = window.getSelection(),
    c.removeAllRanges(),
    c.addRange(b)) : document.selection && (b = document.body.createTextRange(),
...
com.zybuluo.mdeditor.common.getCurrentMode = function() {
    if (com.zybuluo.mdeditor.user_note)
        return null;
    ...
    return null !== a.match(/^#(\d+-)?full-editor/) ? b.isFullEditor = !0 : null !== a.match(/^#(\d+-)?full-reader/) ? b.isFullReader = !0 : (a && null === a.match(/^#\d+$/) && (b.isHashMode = !0),
    b.isEditorReader = !0),
    b
}
,
...
com.zybuluo.mdeditor.common.bindingFullScreenApi = function(a) {
    fullScreenApi.supportsFullScreen ? $(a).on("click", function() {
...
com.zybuluo.mdeditor.common.colorWmdButtons = function() {
    var drak = $("body").hasClass("theme-black"); 
    var a = com.zybuluo.mdeditor.common.buttonBinding;
    console.log("colorWmdButtons drak: " + drak);
    a(".wmd-button > span", (drak ? "#F9F9F5" : "#101010"), "#BBBBBB");
}
,
com.zybuluo.mdeditor.common.attachMermaidStyle = function(a, b) {
    var c = "gantt";
    a.hasClass("graph") ? c = "graph" : a.hasClass("sequence") && (c = "sequence"),
    b || (b = $("body").hasClass("theme-black") ? "theme-black" : "theme-white");
    var d = "";
    "theme-white" == b ? "gantt" === c ? d = '<style type="text/css" title="mermaid-svg-internal-css"> .section { stroke: none; opacity: 0.2;} .section0 { fill: rgba(102, 102, 255, 0.490196);} .section2 { fill: rgb(255, 244, 0);} .section1, .section3 { fill: white; opacity: 0.2;} .sectionTitle0 { fill: rgb(51, 51, 51);} .sectionTitle1 { fill: rgb(51, 51, 51);} .sectionTitle2 { fill: rgb(51, 51, 51);} .sectionTitle { text-anchor: start; font-size: 11px;} .grid .tick { stroke: lightgrey; opacity: 0.3; shape-rendering: crispEdges;} .grid path { stroke-width: 0;} .today { fill: none; stroke: red; stroke-width: 2px;} .task { stroke-width: 2;} .taskText { text-anchor: middle; font-size: 11px;} .taskText0, .taskText1, .taskText2, .taskText3 { fill: white;} .task0, .task1, .task2, .task3 { fill: rgb(138, 144, 221); stroke: rgb(83, 79, 188);} .titleText { text-anchor: middle; font-size: 18px; fill: black;} </style>' : "graph" === c ? d = '<style type="text/css" title="mermaid-svg-internal-css"> .node&gt;rect { ; } .node text  { fill:#000; stroke:none; font-weight:300; font-family:"Helvetica Neue",Helvetica,Arial,sans-serf; font-size:14px; } .edgeLabel text  { fill:#000; stroke:none; font-weight:300; font-family:"Helvetica Neue",Helvetica,Arial,sans-serf; font-size:14px; } .cluster rect  { rx:4px; fill: rgb(255, 255, 222); rx: 4px; stroke: rgb(170, 170, 51); stroke-width: 1px; } .label, .badge { display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: rgb(255, 255, 255); text-shadow: rgba(0, 0, 0, 0.247059) 0px -1px 0px; white-space: nowrap; vertical-align: baseline; background-color: rgb(153, 153, 153);} .label { border-radius: 3px;} .mermaid .label { color: rgb(51, 51, 51);} .node rect, .node circle, .node ellipse, .node polygon { fill: rgb(236, 236, 255); stroke: rgb(204, 204, 255); stroke-width: 1px;} .edgePath .path { stroke: rgb(51, 51, 51);} .edgeLabel { background-color: rgb(232, 232, 232);} .cluster rect { fill: rgb(255, 255, 222) !important; rx: 4 !important; stroke: rgb(170, 170, 51) !important; stroke-width: 1px !important;} .cluster text { fill: rgb(51, 51, 51);} </style>' : "sequence" === c && (d = '<style type="text/css" title="mermaid-svg-internal-css"> .actor { stroke: rgb(204, 204, 255); fill: rgb(236, 236, 255);} text.actor { fill: black; stroke: none;} .actor-line { stroke: grey;} .messageLine0 { stroke-width: 1.5; stroke: rgb(51, 51, 51);} .messageLine1 { stroke-width: 1.5; stroke: rgb(51, 51, 51);} #arrowhead { fill: rgb(51, 51, 51);} #crosshead path { fill: rgb(51, 51, 51) !important; stroke: rgb(51, 51, 51) !important;} .messageText { fill: rgb(51, 51, 51); stroke: none;} .labelBox { stroke: rgb(204, 204, 255); fill: rgb(236, 236, 255);} .labelText { fill: black; stroke: none;} .loopText { fill: black; stroke: none;} .loopLine { stroke-width: 2; stroke: rgb(204, 204, 255);} .note { stroke: rgb(170, 170, 51); fill: rgb(255, 245, 173);} .noteText { fill: black; stroke: none; font-family: "trebuchet ms", verdana, arial; font-size: 14px;} </style>') : "gantt" === c ? d = '<style type="text/css" title="mermaid-svg-internal-css"> .section { stroke: none; opacity: 0.2;} .section0 { fill: rgb(110, 170, 73);} .sectionTitle0 { fill: rgb(51, 51, 51);} .sectionTitle { text-anchor: start; font-size: 11px;} .grid .tick { stroke: lightgrey; opacity: 0.3; shape-rendering: crispEdges;} .grid path { stroke-width: 0;} .today { fill: none; stroke: red; stroke-width: 2px;} .task { stroke-width: 2;} .taskText { text-anchor: middle; font-size: 11px;} .taskText0, .taskText1, .taskText2, .taskText3 { fill: white;} .task0, .task1, .task2, .task3 { fill: rgb(72, 126, 58); stroke: rgb(19, 84, 12);} .titleText { text-anchor: middle; font-size: 18px; fill: black;} </style>' : "graph" === c ? d = '<style type="text/css" title="mermaid-svg-internal-css"> .node&gt;rect { ; } .node text  { fill:#000; stroke:none; font-weight:300; font-family:"Helvetica Neue",Helvetica,Arial,sans-serf; font-size:14px; } .edgeLabel text  { fill:#000; stroke:none; font-weight:300; font-family:"Helvetica Neue",Helvetica,Arial,sans-serf; font-size:14px; } .cluster rect  { rx:4px; fill: rgb(255, 255, 222); rx: 4px; stroke: rgb(170, 170, 51); stroke-width: 1px; } .label, .badge { display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: rgb(255, 255, 255); text-shadow: rgba(0, 0, 0, 0.247059) 0px -1px 0px; white-space: nowrap; vertical-align: baseline; background-color: rgb(153, 153, 153);} .label { border-radius: 3px;} .mermaid .label { font-family: "trebuchet ms", verdana, arial; color: rgb(51, 51, 51);} .node rect, .node circle, .node ellipse, .node polygon { fill: rgb(205, 228, 152); stroke: rgb(19, 84, 12); stroke-width: 1px;} .edgePath .path { stroke: green; stroke-width: 1.5px;} .edgeLabel { background-color: rgb(232, 232, 232);} .cluster rect { fill: rgb(205, 255, 178) !important; rx: 4 !important; stroke: rgb(110, 170, 73) !important; stroke-width: 1px !important;} .cluster text { fill: rgb(51, 51, 51);} </style>' : "sequence" === c && (d = '<style type="text/css" title="mermaid-svg-internal-css"> .actor { stroke: rgb(19, 84, 12); fill: rgb(205, 228, 152);} text.actor { fill: black; stroke: none;} .actor-line { stroke: grey;} .messageLine0 { stroke-width: 1.5; stroke: rgb(51, 51, 51);} .messageLine1 { stroke-width: 1.5; stroke: rgb(51, 51, 51);} #arrowhead { fill: rgb(51, 51, 51);} #crosshead path { fill: rgb(51, 51, 51) !important; stroke: rgb(51, 51, 51) !important;} .messageText { fill: rgb(21, 21, 21); stroke: none;} .note { stroke: rgb(110, 170, 73); fill: rgb(255, 245, 173);} .noteText { fill: black; stroke: none; font-family: "trebuchet ms", verdana, arial; font-size: 14px;} .labelBox { stroke: rgb(50, 105, 50); fill: rgb(205, 228, 152);} .labelText { fill: black; stroke: none;} .loopText { fill: black; stroke: none;} .loopLine { stroke-width: 2; stroke: rgb(50, 105, 50);} </style>');
    var e = a.children("svg");
    e.children("style").remove(),
    e.prepend(d)
}
,
com.zybuluo.mdeditor.common.applyPreviewElementTheme = function(a) {
    var $highlightStyle = $("#highlight-style");
    $prettifyStyle = $("#prettify-style");
    var b = $prettifyStyle.attr("href");
    b = b.match(/.*\//)[0],
    null === a && (a = $("body").hasClass("theme-black") ? "theme-black" : "theme-white");
    var c = com.zybuluo.mdeditor.common.buttonBinding;

    console.log("applyPreviewElementTheme", a);
    "theme-white" == a ? (
        $("#wmd-preview table").each(function() {
        ...
        // 亮色主题使用 github 样式
        $highlightStyle.attr("href", "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/github.min.css"),
        c(".in-page-button > span", "rgba(44, 62, 80, 0.65)", "rgba(102, 128, 153, 0.45)"),
        c(".wmd-button > span", "#101010", "#BBBBBB"),
        $(".wmd-preview blockquote").removeClass().addClass("white-blockquote")
    ) : (
        $("#wmd-preview table").each(function() {
        ...
        // 暗色主题使用 atom-one-dark 样式
        $highlightStyle.attr("href", "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/atom-one-dark.min.css"),
        c(".in-page-button > span", "rgba(249, 249, 245, 0.65)", "rgb(187, 187, 187, 0.45)"),
        $(".wmd-preview blockquote").removeClass().addClass("black-blockquote")
    );
    ...
    $('pre').each(function(index) {
        ...
        console.log("code className: ", $code[0].className);   
        // 如果没有 language-* 类，添加默认类
        var hasLanguageClass = $code[0].className.split(' ').some(function(cls) {
            return cls !== 'language-undefined' && cls.startsWith('language-');
        });
        console.log("hasLanguageClass: " + hasLanguageClass);
        if (hasLanguageClass) {            
            $(this).addClass('hljs linenums');
        } else {            
            $(this).addClass('language-undefined');
        }
    });
    $('pre.hljs').each(function() {
        ...
        var className = $code[0].className;
        ...
        // 移除已有的行号容器
        $pre.find('.linenums').remove();
        $pre.find('.code-header').remove();
        
        // 创建行号容器
        var $lineNumbers = $('<ol class="linenums">');    
        for (var i = 1; i <= lines.length; i++) {
            $lineNumbers.append('<li></li>');
        }
        $lineNumbers.append('</ol>');  

        // 创建代码头部（语言类型 + 复制按钮）
        var $header = $('<div class="code-header">');
        $header.append('<span class="code-lang">' + language + '</span>');
        $header.append('<button class="code-copy-btn" title="复制代码">复制</button>');
    ...
    hljs.highlightAll();
    console.log("highlightAll time: " + (new Date().getTime() - t));
    ...
    $('.code-copy-btn').on('click', function() {
        ...
        // 获取代码文本（去除HTML标签）
        var codeText = $code[0].textContent || $code[0].innerText;
    ...
    $("div.mermaid:has(>svg)").each(function() {
        $mermaid = $(this),
        com.zybuluo.mdeditor.common.attachMermaidStyle($mermaid, a)
    });
}
,
...
com.zybuluo.mdeditor.common.switchSiteTheme = function(a) {
    ...
    var drak = $("body").hasClass("theme-white");
    $("body").hasClass("theme-white") 
        ? (a && a.applyTheme("theme-black"), b("theme-black")) 
        : (a && a.applyTheme("theme-white"), b("theme-white"));
    console.log("theme: " + drak);
    if (drak) {
        $("#wmd-button-bar").addClass("drak");
        $("#preview-button-bar").addClass("drak");
        $("#wmd-preview").addClass("drak");
    } else {
        $("#wmd-preview").removeClass("drak");
        $("#wmd-button-bar").removeClass("drak");
        $("#preview-button-bar").removeClass("drak");
    }
    var h = com.zybuluo.mdeditor.common.buttonBinding;
...
com.zybuluo.mdeditor.common.initialHiddenSideToolBar = function() {
    ...
    var b = !1
      , c = function() {
        $("#reader-full-toolbar-tail").hasClass("reader-full-toolbar-tail-hidden") || (b ? ($("#reader-full-toolbar").show(),
        $("#preview-hidden-button span").attr("title", "隐藏工具栏 Ctrl+Alt+I").removeClass("icon-chevron-sign-left").addClass("icon-chevron-sign-right"),
        a("#preview-hidden-button span", "#F9F9F5", "#BBBBBB"),
        b = !1) : ($("#reader-full-toolbar").hide(),
        $("#preview-hidden-button span").attr("title", "显示工具栏 Ctrl+Alt+I").removeClass("icon-chevron-sign-right").addClass("icon-chevron-sign-left"),
        a("#preview-hidden-button span", "#BBBBBB", "#BBBBBB"),
        b = !0))
    };
...
com.zybuluo.mdeditor.common.caculateAndFillPreviewCharacters = function() {
    ...
    var t = $(".article-title"), title = docList && docList.length > 0 ? docList[0].name : "未命名";
    0 !== b.length && b.each(function() {
        $(this).text(a)
    });
    t.each(function() {$(this).text(title)})
}
,
com.zybuluo.mdeditor.common.generateUUID = function(a) {
    var b = 0
      , c = "";
    for (b = 0; a > b; b++)
        c += "0123456789abcdefghijklmnopqrstuvwxyz"[Math.floor(36 * Math.random())];
    return c
}
,
...
com.zybuluo.mdeditor.common.doUserTierFeature = function(a, b, c) {
    $.ajax({
        ...
        if (a.loggedin === !1)
            window.location = com.zybuluo.mdeditor.initData.loginComeFromUrl;
        else if (a.user_tier)
            b();
        else {
            if (c)
                return void c(!0);
            window.desktopGui ? window.open(com.zybuluo.mdeditor.initData.paymentUrl) : (toastr.clear(),
            com.zybuluo.mdeditor.common.setToastrOptions("toast-bottom-right", !0, "10000", "1000", function() {
...
com.zybuluo.mdeditor.common.clickToOpenSequenceFlowDiagram = function() {
    $("#wmd-preview").on("click", ".sequence-diagram:has(>svg), .flow-diagram:has(>svg), div.mermaid:has(>svg)", function() {
        var a = $(this).find("svg")[0];
        if (a.id.startsWith('mindmap_')) return;
        var b = parseInt(a.width.baseVal.value, 10)
...
com.zybuluo.mdeditor.common.initiateSearchFileComponent = function(a) {
    $("#file-list-topbar").on("click", function(a) {
        a.stopPropagation(),
    ...
    var b = 0
      ...
      , e = function(a, b) {
        b.stopPropagation(),
        a.data("hidden") === !0 ? (a.siblings().show(),
        a.data("hidden", !1)) : (a.siblings().hide(),
        a.data("hidden", !0))
    };
    $("#file-list").on("click", ".tag-item", function(a) {
        e($(this), a)
    });
    var f = null
      , g = function() {
      ...
      , h = _.debounce(function() {
        ...
        if ("" === a)
            ...
            for (var b in f)
                -1 !== f[b][0].toLowerCase().indexOf(a.toLowerCase()) || "*" === a ? f[b][1].show() : f[b][1].hide();
    ...
    var i = function(a, d) {
        ...
        if (0 !== e.length) {
            ...
            var g = null;
            a === !0 ? (g = e.index(".item:visible") + 1,
            g >= f.length && (g = 0)) : (g = e.index(".item:visible") - 1,
            0 > g && (g = $("#file-list .item:visible").length - 1));
            var h = $(f[g]);
    ...
    $("#search-file-textbox").on("keydown", function(a) {
    ...
    $("#preview-list-button").on("show", function() {
...
com.zybuluo.mdeditor.common.populateFileList = function(a, b) {
    ...
    for (var f in b) {
        ...
        for (var k in j) {
            ...
            a === l.id ? q.children("span").attr("id", l.id).addClass("whiter-on-black").text(l.title) : m === !1 ? q.children("span").attr("id", l.id).text(l.title) : (q.children("i").addClass("yellow-on-black"),
            q.children("span").attr("id", l.id).addClass("yellow-on-black").text(l.title)),
            h.append(p)
        }
...
function(a, b) {
    ...
    function c(a, b) {
        ...
        if (void 0 === a)
            return b;
        for (c in b)
            b.hasOwnProperty(c) && a.hasOwnProperty(c) === !1 && (a[c] = b[c]);
        return a
    }
    function d() {
        var c, d, e, f, g = "";
        if (void 0 !== a.getSelection) {
            if (d = a.getSelection(),
            d.rangeCount) {
                for (f = b.createElement("div"),
                c = 0,
                e = d.rangeCount; e > c; c += 1)
                    f.appendChild(d.getRangeAt(c).cloneContents());
                g = f.innerHTML
            }
        } else
            void 0 !== b.selection && "Text" === b.selection.type && (g = b.selection.createRange().htmlText);
        return g
    }
    function e() {
        var c = "";
    ...
    MediumEditor.prototype = {
        ...
        initElements: function() {
            ...
            for (a = 0; a < this.elements.length; a += 1)
                this.elements[a].setAttribute("data-medium-element", !0);
        ...
        initToolbar: function() {
            return this.toolbar ? this : (this.toolbar = this.createToolbar(),
        ...
        toolbarButtons: function() {
            var a, c, d, e, g = this.options.buttons, h = b.createElement("ul");
            for (h.id = "medium-editor-toolbar-actions",
            h.className = "medium-editor-toolbar-actions clearfix",
            c = 0; c < g.length; c += 1)
                this.options.extensions.hasOwnProperty(g[c]) ? (e = this.options.extensions[g[c]],
                d = void 0 !== e.getButton ? e.getButton() : null) : d = this.buttonTemplate(g[c]),
                d && (a = b.createElement("li"),
                f(d) ? a.appendChild(d) : a.innerHTML = d,
                h.appendChild(a));
            return h
        },
        bindSelect: function() {
        ...
        checkSelection: function() {
            ...
            if (null === c || c === !1 || this.getSideRemark().isPopulatedNoteRemarks() === !1)
                return this.hideToolbarActions(),
                this;
            if (this.keepToolbarAlive !== !0 && !this.options.disableToolbar)
                if (b = a.getSelection(),
                "" !== b.toString().trim() && this.isToolbarShowableForSelection()) {
        ...
        getMediumElementForShowingToolBar: function() {
            var b, c, d, e, f = a.getSelection(), g = this.toolbarShownForMediumElements, h = function(a) {
                var b = !0
                  , c = a;
                try {
                    for (; !c.getAttribute("data-medium-element"); )
                        b === !0 && -1 === g.indexOf(c.tagName.toLowerCase()) && (b = !1),
                        c = c.parentNode
                } catch (d) {
                    return null
                }
            ...
            try {
                ...
                d = c.parentNode,
                c.getAttribute("data-medium-element"))
                    return !1;
                e = h(d)
            } catch (i) {
                e = h(d)
        ...
        setToolbarPosition: function() {
            ...
            return e.top < b ? (this.toolbar.classList.add("medium-toolbar-arrow-over"),
            this.toolbar.classList.remove("medium-toolbar-arrow-under"),
            this.toolbar.style.top = b + e.bottom - this.options.diffTop + a.pageYOffset - this.toolbar.offsetHeight + "px") : (this.toolbar.classList.add("medium-toolbar-arrow-under"),
            this.toolbar.classList.remove("medium-toolbar-arrow-over"),
            this.toolbar.style.top = e.top + this.options.diffTop + a.pageYOffset - this.toolbar.offsetHeight + "px"),
            this.toolbar.style.left = h > g ? f + h + "px" : a.innerWidth - g < h ? a.innerWidth + f - h + "px" : f + g + "px",
            this
        },
        bindButtons: function() {
            var a, b = this.toolbar.querySelectorAll("button"), c = this, d = function(a) {
                a.preventDefault(),
                a.stopPropagation(),
            ...
            for (a = 0; a < b.length; a += 1)
                b[a].addEventListener("click", d);
            return this.setFirstAndLastItems(b),
            this
        },
        setFirstAndLastItems: function(a) {
            return a.length > 0 && (a[0].className += " " + this.options.firstButtonClass,
            a[a.length - 1].className += " " + this.options.lastButtonClass),
            this
        },
        ...
        getTopLevelMediumElement: function(a) {
            ...
            var c = null;
            try {
                for (; !a.getAttribute("data-medium-element"); )
                    c = a,
                    a = a.parentNode
            } catch (d) {
                return null
            ...
            var e = b.createRange()
              ...
              , i = function(a) {
                for (var b in a.childNodes) {
                    ...
                    if (j = 3 === j.nodeType ? j : i(j),
                    null !== j && void 0 !== j && 0 !== j.textContent.length) {
                        if (h === !0)
                            return;
                        if (g === !1) {
                            if (j.textContent.length - 1 + f >= c && (e.setStart(j, c - f),
                            g = !0,
                            j.textContent.length + f >= d))
                                return e.setEnd(j, d - f),
                                void (h = !0)
                        } else if (j.textContent.length + f >= d)
                            return e.setEnd(j, d - f),
                            void (h = !0);
        ...
        highlightSelection: function() {
            ...
            if (d && !c.isCollapsed) {
                ...
                if (!h)
                    return null;
                for (var i = d.startOffset, j = d.startContainer; j !== g; )
                    null !== j.previousSibling ? (j = j.previousSibling,
                    i += j.textContent.length) : j = j.parentNode;
                var k = f.length
                  , l = i + k;
        ...
        hideToolbarActions: function() {
            this.keepToolbarAlive = !1,
            void 0 !== this.toolbar && (this.toolbar.classList.remove("medium-editor-toolbar-active"),
            this.toolbar.classList.remove("medium-toolbar-arrow-under"),
            this.toolbar.classList.remove("medium-toolbar-arrow-over"),
            this.toolbar.removeAttribute("style"),
            this.toolbarActions.removeAttribute("style"))
        },
...
com.zybuluo.mdeditor.sideRemark = function() {
    var a = com.zybuluo.mdeditor.common.setCursorPositionInContenteditable
      ...
      , x = function(a, b) {
        ...
        var d = null;
        if (b.clipboardData) {
            if (d = (b.originalEvent || b).clipboardData.getData("text/plain"),
            d = d.replace(/(\n|\r)/gim, "").replace(/\s+/gim, " ").trim(),
            "" === d)
                return !1;
            document.execCommand("insertText", !1, d)
        } else if (window.clipboardData) {
            if (d = window.clipboardData.getData("Text"),
            d = d.replace(/(\n|\r)/gim, "").replace(/\s+/gim, " ").trim(),
            "" === d)
                return !1;
      ...
      , y = function(a, b, c) {
        ...
        d.get(0).addEventListener("paste", function(a) {
            return x(d, a)
        });
        var f = a.children(".remark-footer");
        e.loggedInUsername === b.username ? (f.children(".remark-save").hide(),
        f.children(".remark-cancel").hide(),
        f.children(".remark-delete").hide()) : f.hide()
    }
      , z = function(a) {
        ...
        e.isPageOwner === !0 ? (a.public === !0 ? (c.append(f.show()),
        c.append(d.hide()),
        h.show(),
        h.css("right", "95px"),
        h.tooltip({
        ...
        c.append(f.hide())),
        c.append(g.hide())) : a.public === !0 ? (c.hide(),
        h.show(),
        h.tooltip({
            title: "点击更新地址栏以获取可分享此批注的链接",
            placement: "top"
        ...
        return m > 3 && (k.text("展开较早的 " + (m - 3) + " 条回复"),
        k.show()),
      ...
      , A = function() {
        ...
        j.scrollTop() > a ? j.scrollTop(a - 100) : (a -= j.height(),
        j.scrollTop() < a + 100 && j.scrollTop(a + j.height() / 2))
    }
      , B = function(a, b, c) {
        var e = null
          , g = null
          ...
          , l = null
          , o = null;
        if (m.hasClass("side-remark-hidden"))
            return null;
        c !== !0 && A();
        ...
        v + w > j.width()) {
            ...
            l += w;
        if (a === !0)
            i -= q.is(":visible") ? m.height() - q.height() : m.height() - s.height();
        else if (void 0 !== b && b > 0) {
            for (var y = 0, z = n.children(".remark-item"), B = 0; b > B; B++) {
                var C = $(z[B]);
      ...
      , G = function() {
        var a = c();
        if (null === a)
            window.location.hash.match(/([0-9a-z]{4})-([0-9a-z]{12})/) && window.history.pushState && window.history.pushState(null, "", window.location.pathname);
      ...
      , I = function(b) {
        ...
        return "" === c.text().trim() ? (c.html(b.hasClass("new-reply") ? '<p><span id="default-span">在此处回复批注</span><br></p>' : '<p><span id="default-span">在此处批注</span><br></p>'),
        a(c.get(0), 0, 0),
        !0) : !1
    }
      ...
      , L = null
      , M = function() {
        null !== L && L.hasClass("remark-icon-clicked") === !1 && (clearTimeout(K),
        L.hide(),
        L = null)
    }
      , N = function(a) {
      ...
      , O = function(a) {
        a.hasClass("remark-icon-clicked") === !1 && (clearTimeout(K),
      ...
      , P = function(a, b, c, d) {
        if (c && c.length > 0) {
            ...
            d === !1 && (b.find(".remark-count").text("+"),
            b.addClass("remark-icon-empty"))
    };
    u.on("mouseenter.bind", ".remark-icon[data-anchor-id]", function() {
        var a = $(this)
    ...
    }).on("mouseleave.bind", ".remark-icon[data-anchor-id]", function() {
        var a = $(this)
          , b = a.attr("data-anchor-id");
        if (null !== g) {
            var c = g[b];
    ...
    k.on("mouseenter.bind", "[data-anchor-id]", function() {
        var a = this
        ...
        if (null !== g && null !== i) {
            ...
            if (void 0 !== d) {
                var e = null;
                c && c.length > 0 ? (d.find(".remark-count").text(c.length),
                M(),
                e = Q(a),
                d.attr("style", "top:" + e.top + "px;left:" + e.left + "px;")) : (d.find(".remark-count").text("+"),
                e = Q(a),
                d.attr("style", "top:" + e.top + "px;left:" + e.left + "px;"),
                N(d))
            }
        }
    }).on("mouseleave.bind", "[data-anchor-id]", function() {
        var a = this
          , b = a.getAttribute("data-anchor-id");
        if (null !== g && null !== i) {
            var c = g[b]
    ...
    var Q = function(a) {
        var b = a.getBoundingClientRect().top
          , c = 0
          , d = 0;
        "relative" === u.parent().css("position") ? (c = k.width() + f.remarkIconRightAdditionalGutter,
        d = b + (document.documentElement.scrollTop || document.body.scrollTop) + f.remarkIconTopGutter - l.position().top + l.scrollTop()) : (c = a.getBoundingClientRect().right,
        d = b + (document.documentElement.scrollTop || document.body.scrollTop) + f.remarkIconTopGutter);
      ...
      , T = function() {
        ...
        var a = function() {
            ...
            j && !j.hasClass("remark-icon-empty")) {
                ...
                k.each(function() {
                    var a = $(this);
                    return e === a.attr("data-rand-id") ? (l = a,
                    !1) : void 0
                }),
        ...
        null === g ? $.get(e.noteRemarksUrl, {}, function(b) {
            b.anchorUserNoteRemarkUIsMap ? (g = JSON.parse(b.anchorUserNoteRemarkUIsMap),
            a()) : b.error
    ...
    $(".remark-list").on("mousedown", ".remark-editor", function(b) {
        if (0 !== $(this).find("span#default-span").length && window.getSelection().rangeCount > 0) {
            ...
            if (c && c.commonAncestorContainer) {
                ...
                if (d && "function" == typeof d.getAttribute && "default-span" === d.getAttribute("id"))
    ...
    var V = com.zybuluo.common.popupConfirm.popup
      , W = function(a) {
        if (m.hasClass("side-remark-shown")) {
            var c = function(c) {
                V("提醒", "您有未保存的批注信息，是否确认放弃？", function() {
            ...
            if ($(".remark-item>.remark-editor[contentEditable='true'], .remark-reply>.remark-editor[contentEditable='true']").each(function() {
                ...
                if (0 === g.length) {
                    ...
                    if (a.text() !== f.userNoteRemarkReplyUIs[h].content)
                        return c(a),
                        d = !0,
                        !1
                }
            ...
            $(".new-reply>.remark-editor[contentEditable='true'], .new-remark>.remark-editor[contentEditable='true']").each(function() {
                ...
                return 0 === e.length && b.text().trim().length > 0 && (0 !== b.parent(".new-reply").length || "高亮批注" !== b.text()) ? (c(b),
                d = !0,
                !1) : void a()
            })
        } else
    ...
    u.on("mouseup", ".remark-icon", function() {
        return !1
    }),
    $("#notification-popup-window").on("mouseup", function() {
        return !1
    }),
    $("#preview-reader-small-button").on("mouseup", function() {
        return !1
    });
    var X = com.zybuluo.common.browserType;
    X.isOpera || X.isFirefox ? ($(".remark-list").on("input", ".remark-editor[contentEditable='true']", function() {
    ...
    $(".remark-list").on("keypress", ".remark-editor[contentEditable='true']", function(a) {
        var b = a.charCode || a.keyCode;
        return 13 === b ? ($(this).next(".remark-footer").children(".remark-save").trigger("click"),
        !1) : void 0
    })) : ($(".remark-list").on("keydown", ".remark-editor[contentEditable='true']", function(a) {
        var b = a.charCode || a.keyCode;
        if (13 === b)
            return $(this).next(".remark-footer").children(".remark-save").trigger("click"),
            !1;
        var c = $(this).find("span#default-span");
        0 !== c.length && c.remove()
    }),
    $(".remark-list").on("keyup", ".remark-editor[contentEditable='true']", function() {
        var a = $(this);
    ...
    r.get(0).addEventListener("paste", function(a) {
        return x(r, a)
    });
    var Y = function(a, b, c) {
        ...
        var e = a.text().trim()
          , f = e.length;
        return f > b ? null : 0 === f ? (c.trigger("click"),
        null) : e
    };
    n.on("click", ".remark-edit", function() {
    ...
    n.on("click", ".remark-item > .remark-footer > .remark-cancel, .remark-reply > .remark-footer > .remark-cancel", function() {
        ...
        if (f.length > 0) {
            ...
            e.removeAttr("contentEditable").text(c.content);
    ...
    var _ = function(a) {
        var b = "【" + a + "】需要用户登录，现在登录？";
        return e.loggedInUsername ? !0 : (V(a, b, function() {
      ...
      , ab = function(a) {
        var b = "确认删除这条批注吗？";
        window.confirm(b) && (Pace.restart(),
        $.post(e.deleteNoteRemarkUrl, {
            ...
            if (b.loggedin === !1)
                ...
                b.version_error === !0 ? V("删除批注", '批注已在别处被更新，请 <a href="javascript:window.location.reload();void 0;">刷新</a> 页面后重试') : b.error && V("删除批注", '出错啦，请 <a href="javascript:window.location.reload();void 0;">刷新</a> 页面后重试')
        }, "json").fail(function() {
            V("删除批注", '出错啦，请 <a href="javascript:window.location.reload();void 0;">刷新</a> 页面后重试')
        }))
    };
    n.on("click", ".remark-item > .remark-footer > .remark-delete", function() {
        var a = $(this).parents(".remark-item");
        ab(a)
    }),
    n.on("click", ".remark-item > .remark-options > .remark-delete", function() {
        var a = $(this).parents(".remark-item");
        ab(a)
    });
    var bb = function(a, b) {
        var c = "确认删除这条批注回复吗？";
        window.confirm(c) && (Pace.restart(),
        $.post(e.deleteNoteRemarkReplyUrl, {
            remark_rand_id: a.attr("data-rand-id"),
            ...
            if (c.loggedin === !1)
                ...
                var g = a.children(".remark-reply-view-more")
                  ...
                  , j = i.length;
                j === h.children(".remark-reply:visible").length ? j > 3 ? g.text("收起较早的 " + (j - 3) + " 条回复") : g.hide() : j >= 3 && ($(i[j - 3]).show(),
                j - 3 > 0 ? g.text("展开较早的 " + (j - 3) + " 条回复") : g.hide())
            } else
                c.version_error === !0 ? V("删除批注回复", '批注回复已在别处被更新，请 <a href="javascript:window.location.reload();void 0;">刷新</a> 页面后重试') : c.error && V("删除批注回复", '出错啦，请 <a href="javascript:window.location.reload();void 0;">刷新</a> 页面后重试')
        }, "json").fail(function() {
            V("删除批注回复", '出错啦，请 <a href="javascript:window.location.reload();void 0;">刷新</a> 页面后重试')
        }))
    };
    n.on("click", ".remark-reply > .remark-footer > .remark-delete", function() {
        var a = $(this)
          , b = a.parents(".remark-item")
          , c = a.parent(".remark-footer").parent(".remark-reply");
        bb(b, c)
    }),
    n.on("click", ".remark-reply > .remark-delete-link", function() {
        var a = $(this)
          , b = a.parents(".remark-item")
          , c = a.parent(".remark-reply");
        bb(b, c)
    }),
    n.on("click", ".remark-item > .remark-footer > .remark-save", function() {
        ...
        if (null !== c) {
            ...
            $.post(e.updateNoteRemarkUrl, {
                ...
                if (b.loggedin === !1)
                    ...
                    b.version_error === !0 ? V("保存失败", '批注已在别处被更新，请 <a href="javascript:window.location.reload();void 0;">刷新</a> 页面后重试') : b.error && V("保存失败", '出错啦，请 <a href="javascript:window.location.reload();void 0;">刷新</a> 页面后重试')
            }, "json").fail(function() {
                V("保存失败", '出错啦，请 <a href="javascript:window.location.reload();void 0;">刷新</a> 页面后重试')
            })
        }
    }),
    n.on("click", ".remark-reply > .remark-footer > .remark-save", function() {
        var a = $(this).parent(".remark-footer").siblings(".remark-editor")
          , b = $(this).siblings(".remark-delete")
        ...
        if (null !== c) {
            ...
            $.post(e.updateNoteRemarkReplyUrl, {
                ...
                if (b.loggedin === !1)
                    ...
                    b.version_error === !0 ? V("保存失败", '批注回复已在别处被更新，请 <a href="javascript:window.location.reload();void 0;">刷新</a> 页面后重试') : b.error && V("保存失败", '出错啦，请 <a href="javascript:window.location.reload();void 0;">刷新</a> 页面后重试')
            }, "json").fail(function() {
                V("保存失败", '出错啦，请 <a href="javascript:window.location.reload();void 0;">刷新</a> 页面后重试')
            })
        }
    ...
    var cb = function(a, b) {
        ...
        b !== d.public && (Pace.restart(),
        $.post(e.publishNoteRemarkUrl, {
            remark_rand_id: a.attr("data-rand-id"),
            version_id: a.attr("data-version-id"),
            is_public: b
        }, function(b) {
            if (b.loggedin === !1)
                ...
                b.is_public === !0 ? (c.prepend(c.children(".remark-public")),
                f.show(),
                f.css("right", "95px"),
                f.tooltip({
                    title: "点击更新地址栏以获取可分享此批注的链接",
    ...
    n.on("click", ".remark-item > .remark-options > .remark-public", function() {
        var a = $(this).parents(".remark-item");
        cb(a, !0)
    }),
    n.on("click", ".remark-item > .remark-options > .remark-private", function() {
        var a = $(this).parents(".remark-item");
        cb(a, !1)
    }),
    n.on("click", ".remark-item > .remark-published-link", function() {
        var a = $(this).parents(".remark-item")
          , b = C()
          , d = c();
        if (null === d)
            window.location.hash = b + "-" + a.attr("data-rand-id");
    ...
    n.on("click", ".leave-reply span", function() {
        if (_("添加新回复")) {
    ...
    n.on("click", ".new-reply .remark-cancel", function() {
        var a = $(this).parents(".new-reply").html("").hide();
        a.siblings(".leave-reply").show()
    }),
    n.on("click", ".new-reply .remark-save", function() {
        var a = $(this)
        ...
        if (null !== g) {
            ...
            Pace.restart(),
            $.post(e.newNoteRemarkReplyUrl, i, function(a) {
                if (a.loggedin === !1)
                    window.location = e.loginComeFromUrl;
                    ...
                    i ? i.push(c) : (i = [c],
                    g.userNoteRemarkReplyUIs = i)
                } else
                    a.error
            }, "json").fail(function() {})
        }
    }),
    n.on("click", ".remark-reply-view-more", function() {
        var a = $(this)
        ...
        a.text("展开较早的 " + (d - 3) + " 条回复")) : (c.show(),
        a.text("收起较早的 " + (d - 3) + " 条回复"))
    }),
    s.on("click", function() {
        _("添加新批注") && (s.hide(),
        q.show(),
    ...
    q.on("click", ".remark-cancel", function() {
        n.children(".remark-item").length > 0 ? (r.text(""),
        r.next(".inline-error").remove(),
        q.hide(),
        s.show()) : (H(),
        d.removeHighlight())
    }),
    q.on("click", ".remark-save", function() {
        var a = $(this)
          , b = a.siblings(".remark-cancel")
        ...
        if (null !== c) {
            ...
            if (0 !== i.length) {
                ...
                Pace.restart(),
                $.post(e.newNoteRemarkUrl, l, function(b) {
                    if (b.loggedin === !1)
                        window.location = e.loginComeFromUrl;
    ...
    n.on("mouseenter", ".remark-item .remark-options", function() {
        $(this).children().show()
    }).on("mouseleave", ".remark-item .remark-options", function() {
        $(this).children().hide(),
        $(this).children("li:first").show()
    }),
    u.on("mouseenter", ".remark-icon", function() {
        $(this).addClass("remark-icon-hover")
    }).on("mouseleave", ".remark-icon", function() {
        $(this).removeClass("remark-icon-hover")
    }),
    n.on("mouseenter", ".remark-reply", function() {
        $(this).children(".remark-delete-link").show()
    }).on("mouseleave", ".remark-reply", function() {
        $(this).children(".remark-delete-link").hide()
    }),
    n.on("mouseup", ".remark-item", function(a) {
        var b = $(this);
        if (b.hasClass("remark-item-active")) {
            ...
            n.children(".remark-item-active").removeClass("remark-item-active"),
            b.addClass("remark-item-active"),
            B(!1, $(this).prevAll().length)
    });
    var db = !1;
    n.on("mouseenter", ".remark-item", function() {
        var a = $(this);
        if (db)
            return X.isFirefox && setTimeout(function() {
    ...
    }).on("mouseleave", ".remark-item", function() {
        var a = $(this);
        if (db)
            return X.isFirefox && setTimeout(function() {
            ...
            !1;
        if (d.removeHighlight(),
        $remarkItemActive = n.children(".remark-item-active"),
        1 === $remarkItemActive.length) {
            var b = u.children(".remark-icon-clicked")
              , c = b.attr("data-anchor-id");
    ...
    var eb = function(a, b, c) {
        var f = u.children(".remark-icon-clicked")
          , g = function() {
            if (a.addClass("remark-icon-clicked"),
            b === !0)
                e.loggedInUsername ? E(!0, !0, c) : E(!1, !0, null);
            else if (a.hasClass("remark-icon-empty") === !0)
                e.loggedInUsername ? E(!0, !1, null) : E(!1, !1, null);
            else {
                E(!1, !1, null);
        ...
        0 === f.length ? g() : (d.removeHighlight(),
        a.attr("data-anchor-id") !== f.attr("data-anchor-id") ? (F(),
        g()) : (H(),
        a.hasClass("remark-icon-empty") === !0 && a.show()))
    };
    u.on("click", ".remark-icon", function() {
    ...
    u.on("highlightClick", ".remark-icon", function(a) {
        var b = $(this);
        W(function() {
