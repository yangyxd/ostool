...
com.zybuluo.mdeditor.unifiedEditor = function() {
    ...
    var h = {
        ...
        getDefaultDocument: function() {
            return localStorage.getItem('lastMarkdown_data') ?? g;
        },
        setValue: function(a) {
...
com.zybuluo.mdeditor.fileManager = function() {
    ...
    function d(a) {
        s.get(function(b) {
            if (null === b)
                return void t.warningToSaveBeforeLogin(function() {
                    u(p.loginComeFromUrl, "此功能需要登录，离线状态下无法登录，请连接网络后重试。")
                });
            var c = null
              , d = null;
            a === !0 ? (c = "新建离线文稿",
            d = '离线文稿只存储在本机（Cmd 客户端可指定本机保存路径），任何情况下不与云端同步，保障企业级私密，确认新建离线文稿（高级会员功能）？<input style="display:none;" id="nwNewFileDialog" type="file" nwsaveas="未命名.md" />') : (c = "新建文稿",
            d = "当前文稿内容已保存至云端，确认新建文稿？");
            var e = !1
              , f = !0;
            r(c, d, function() {
                if (a === !0 && e === !1)
                    $("#notification-popup-window").modal("hide"),
                    f === !0 ? window.open(p.paymentUrl) : (toastr.clear(),
                ...
                a === !0 && com.zybuluo.mdeditor.common.doUserTierFeature(b, function() {
                    e = !0
                }, function(a) {
                    f = a,
                    e = !1
    ...
    function e() {
        s.get(function(a) {
            ...
            r(b, d, function() {
                e.checkLocalNoteAction(p.currentId, function(a) {
                    a ? "offline" === a.action ? ($("#notification-popup-window").modal("hide"),
                    e.deleteLocalNoteAction(p.currentId, function() {
                    ...
                    $.post(p.deleteUserNoteUrl, {
                        ...
                        if (a.loggedin === !1)
                            ...
                            var b = function() {
                                $("#notification-popup-window").modal("hide"),
                                -1 !== a.userNoteId ? ($.localStorage("currentId", a.userNoteId),
                                window.location.hash = "#" + a.userNoteId) : ($.localStorage("currentId", null),
                        ...
                        p.currentId > 0 ? e.updateLocalNoteAction(p.currentId, function(a) {
                            a.action = "delete",
    ...
    function f(a, b) {
        s.get(function(c) {
            return null === c ? void t.warningToSaveBeforeLogin(function() {
                u(p.loginComeFromUrl, "此功能需要登录，离线状态下无法登录，请连接网络后重试。")
            }) : void ("markdowns" === a || "template-html" === a || "pdf" === a ? com.zybuluo.mdeditor.common.doUserTierFeature(c, function() {
                C(c, a, b)
            }) : C(c, a, b))
        })
    }
    function g(a) {
        s.get(function(b) {
            return null === b ? void t.warningToSaveBeforeLogin(function() {
                u(p.loginComeFromUrl, "此功能需要登录，离线状态下无法登录，请连接网络后重试。")
            }) : void com.zybuluo.mdeditor.common.doUserTierFeature(b, function() {
      ...
      , D = function(a) {
        ...
        "yinxiang" === a || "evernote" === a) {
            var d = $("ul#file-list span#" + p.currentId).text()
              ...
              , h = "";
            r(e, f, function() {
                return g === !1 ? void $("#notification-popup-window").modal("hide") : "" !== h ? ($("#notification-popup-window").modal("hide"),
                void window.open(window.desktopGui ? p.thirdPartyAccountUrl + a : h)) : void $("#notification-popup-window").modal("hide")
            }, null, function() {
                A(function(b) {
                    $("#notification-cancel").hide(),
                    $.post(p.thirdPartyAccountExportUrl + a, {
                        ...
                        a.loggedin === !1 ? ($("#notification-popup-window").modal("hide"),
                        window.location = p.loginComeFromUrl) : a.success ? $("#notification-popup-window").find(".modal-body p").html("当前文稿<strong>【" + d + "</strong>】已成功导出/同步到您的" + c + "帐号。") : a.authorized_url ? ($("#notification-cancel").show(),
                        h = a.authorized_url,
                        $("#notification-popup-window").find(".modal-body p").html("尚未绑定" + c + "帐号或绑定过期，请点击确认按钮进行绑定。")) : a.error && $("#notification-popup-window").find(".modal-body p").html("导出当前文稿出错，请重试或联系我们，错误详情：" + a.error)
                    }, "json").fail(function(a) {
...
com.zybuluo.mdeditor.scrollLink = function() {
    ...
    c.onEditorConfigure = function(a) {
        ...
        a.getConverter().hooks.chain("postConversion", function(a) {
            return u.height(u.height() * 1.115),
            a
        });
        var b = "^.+[ \\t]*\\n=+[ \\t]*\\n+|^.+[ \\t]*\\n-+[ \\t]*\\n+|^\\#{1,6}[ \\t]*.+?[ \\t]*\\#*\\n+";
        b = "^```.*\\n[\\s\\S]*?\\n```|" + b,
...
com.zybuluo.mdeditor.mode = function() {
    ...
    var j = function() {
      ...
      , o = function() {
        $("#article-loading-alert").hasClass("editor-reader-hidden") || ($("#article-loading-alert").removeAttr("style"),
        $("#article-loading-alert").addClass("editor-reader-hidden"))
    }
      , p = function(a) {
...
com.zybuluo.mdeditor.render = function(a) {
    var b = com.zybuluo.mdeditor.initData
      ...
      , s = function(d, e, g, h) {
        ...
        b.isEditablePage === !0 && (c.noteRemarksUrl = c.noteRemarksUrl.replace("current_id_placeholder", j)),
        // c.newNoteRemarkUrl = c.newNoteRemarkUrl.replace("current_id_placeholder", j),
        // c.updateNoteRemarkUrl = c.updateNoteRemarkUrl.replace("current_id_placeholder", j),
        // c.deleteNoteRemarkUrl = c.deleteNoteRemarkUrl.replace("current_id_placeholder", j),
        // c.publishNoteRemarkUrl = c.publishNoteRemarkUrl.replace("current_id_placeholder", j),
        // c.newNoteRemarkReplyUrl = c.newNoteRemarkReplyUrl.replace("current_id_placeholder", j),
        // c.updateNoteRemarkReplyUrl = c.updateNoteRemarkReplyUrl.replace("current_id_placeholder", j),
        // c.deleteNoteRemarkReplyUrl = c.deleteNoteRemarkReplyUrl.replace("current_id_placeholder", j)),
...
com.zybuluo.mdeditor.init = function(a) {
    ...
    var L = !1
      ...
      , S = function(b, c) {
        if (n.isEditablePage === !0) {
            ...
            gb = !1;
            localStorage.setItem("lastMarkdown_data", j.getValue());
            // ,
            // n.isUrlMode === !0 ? ($("#wmd-editor-save-button").show(),
            // $("#wmd-editor-save-button > span").text("只读模式")) : ($("#wmd-editor-save-button > span").css("color", "#FFFFAA").text("登录后保存"),
            // $("#wmd-editor-save-button").show().delay(3e3).fadeOut())
        }
    }
      , T = _.debounce(S, 1e3)
      , U = function() {
    ...
    B.hooks.chain("onPreviewRefresh", function() {
        function b() {
            ++c === d && (p(null), k.onPreviewFinished(), a && n.isEditablePage === !0 && J === !1 && t.populateNoteRemarks(), o.closeArticleLoadingAlert())
        }
...
$(function() {
    var a = com.zybuluo.mdeditor.unifiedEditor
      ...
      , v = function(a) {
        ...
        $("#customized-style-css").text(a.textCustomizedCss.replace(/(^|\})([\s\S]+?)\{/g, function(a, b, c) {
            c = c.replace(/[\n]+/g, "");
            var d = []
              , e = c.split(",");
            for (var f in e)
