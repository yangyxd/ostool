...
function onUpdateReady() {
    com.zybuluo.common.popupConfirm.popup("新版本通知", '发现新版本， 在这里查看<a href="https://www.zybuluo.com/ghosert/note/102771" target="_blank"> <i class="icon-wrench"></i> 更新详细</a>，点击下方按钮进行更新操作。', function() {
...
!function(a, b) {
    ...
    function H(a, b, c) {
        var d, e = 0, f = $c.length, g = $.Deferred().always(function() {
            ...
            for (var b = Vc || F(), c = Math.max(0, i.startTime + i.duration - b), d = c / i.duration || 0, e = 1 - d, f = 0, h = i.tweens.length; h > f; f++)
                i.tweens[f].run(e);
    ...
    $.extend({
        ...
        parseJSON: function(b) {
            ...
            a.JSON && a.JSON.parse ? a.JSON.parse(b) : fb.test(b.replace(hb, "@").replace(ib, "]").replace(gb, "")) ? new Function("return " + b)() : void $.error("Invalid JSON: " + b)) : null
        },
        parseXML: function(c) {
            var d, e;
    ...
    $.event = {
        ...
        trigger: function(c, d, e, f) {
            if (!e || 3 !== e.nodeType && 8 !== e.nodeType) {
                ...
                if (!Gb.test(q + $.event.triggered) && (q.indexOf("!") >= 0 && (q = q.slice(0, -1),
                h = !0),
    ...
    function(a, b) {
        ...
        function h(a, b) {
            ...
            j = t.preFilter; h; ) {
                ...
                for (g in t.filter)
                    !(e = hb[g].exec(h)) || j[g] && !(e = j[g](e)) || (f.push(d = new E(e.shift())),
                    h = h.slice(d.length),
                    d.type = g,
                    d.matches = e);
                if (!d)
    ...
    var cc, dc, ec, fc = /alpha\([^)]*\)/i, gc = /opacity=([^)]*)/, hc = /^(top|right|bottom|left)$/, ic = /^(none|table(?!-c[ea]).+)/, jc = /^margin/, kc = new RegExp("^(" + _ + ")(.*)$","i"), lc = new RegExp("^(" + _ + ")(?!px)[a-z%]+$","i"), mc = new RegExp("^([-+])=(" + _ + ")","i"), nc = {
        BODY: "block"
    }, oc = {
        position: "absolute",
        visibility: "hidden",
    ...
    $.extend({
        ...
        ajax: function(a, c) {
            ...
            null == m.crossDomain && (j = Ic.exec(m.url.toLowerCase()),
            m.crossDomain = !(!j || j[1] === yc[1] && j[2] === yc[2] && (j[3] || ("http:" === j[1] ? 80 : 443)) == (yc[3] || ("http:" === yc[1] ? 80 : 443)))),
...
function(a, b, c) {
    ...
    g = {
        ...
        set: function(a, d) {
            ...
            return h ? h[0].value = d : g.data("placeholder-enabled") ? ("" == d ? (a.value = d,
    ...
    a.map(["localStorage", "sessionStorage"], function(d) {
        ...
        a[d] = function(f, g) {
            ...
            this.removeItem = function(c) {
                return a.support[d] ? b[d].removeItem(c) : a.cookie(h.cookiePrefix + c, null, a.extend(h.cookieOptions, {
                    expires: -1
                }))
            }
            ,
...
!function(a) {
    ...
    b.prototype = {
        ...
        hide: function() {
            var b;
            this.transitioning || (b = this.dimension(),
    ...
    e.prototype = {
        ...
        keydown: function(b) {
            ...
            !d.is(".disabled, :disabled"))) {
                ...
                e.length && (h = e.index(e.filter(":focus")),
                38 == b.keyCode && h > 0 && h--,
    ...
    b.prototype = {
        ...
        backdrop: function(b) {
            ...
            if (this.isShown && this.options.backdrop) {
                ...
                a.support.transition && this.$element.hasClass("fade") ? this.$backdrop.one(a.support.transition.end, a.proxy(this.removeBackdrop, this)) : this.removeBackdrop()) : b && b()
        }
    };
    var c = a.fn.modal;
...
!function(a) {
    ...
    b.prototype = {
        ...
        init: function(b, c, d) {
            ...
            this.enabled = !0,
            "click" == this.options.trigger ? this.$element.on("click." + this.type, this.options.selector, a.proxy(this.toggle, this)) : "manual" != this.options.trigger && (e = "hover" == this.options.trigger ? "mouseenter" : "focus",
        ...
        enter: function(b) {
            ...
            return c.options.delay && c.options.delay.show ? (clearTimeout(this.timeout),
            c.hoverState = "in",
...
!function(a) {
    ...
    b.prototype = {
        ...
        lookup: function() {
            ...
            !this.query || this.query.length < this.options.minLength ? this.shown ? this.hide() : this : (b = a.isFunction(this.source) ? this.source(this.query, a.proxy(this.process, this)) : this.source,
    ...
    a(document).on("focus.typeahead.data-api", '[data-provide="typeahead"]', function(b) {
        var c = a(this);
        c.data("typeahead") || (b.preventDefault(),
        c.typeahead(c.data()))
    })
}(window.jQuery),
!function(a) {
...
function(a, b) {
    ...
    a.fn.dropdownHover = function(d) {
        return "ontouchstart"in document ? this : (c = c.add(this.parent()),
        this.each(function() {
            ...
            g.hover(function(a) {
                return g.hasClass("open") || f.is(a.target) ? (l.instantlyCloseOthers === !0 && c.removeClass("open"),
                b.clearTimeout(e),
                g.addClass("open"),
                void f.trigger(j)) : !0
            }, function() {
...
function() {
    ...
    var a = {
        ...
        o: function() {
            var a = new Date(this.valueOf());
            return a.setDate(a.getDate() - (this.getDay() + 6) % 7 + 3),
            a.getFullYear()
        },
        Y: function() {
...
!function() {
    ...
    function() {
        function b(a) {
            ...
            function c(a) {
                return 32 > a ? (16 > a ? "\\x0" : "\\x") + a.toString(16) : (a = String.fromCharCode(a),
                "\\" === a || "-" === a || "]" === a || "^" === a ? "\\" + a : a)
            }
            function d(a) {
                ...
                for (var e = e ? 1 : 0, g = d.length; g > e; ++e) {
                    ...
                    if (/\\[bdsw]/i.test(h))
                        ...
                        var i, h = b(h);
                        g > e + 2 && "-" === d[e + 1] ? (i = b(d[e + 2]),
                        e += 2) : i = h,
                        a.push([h, i]),
                        65 > i || h > 122 || (65 > i || h > 90 || a.push([32 | Math.max(65, h), 32 | Math.min(i, 90)]),
            ...
            function e(a) {
                ...
                for (j = i = 0; e > i; ++i)
                    k = b[i],
                    "(" === k ? (++j,
                    h[j] || (b[i] = "(?:")) : "\\" === k.charAt(0) && (k = +k.substring(1)) && j >= k && (b[i] = "\\" + h[k]);
                for (i = 0; e > i; ++i)
                    "^" === b[i] && "^" !== b[i + 1] && (b[i] = "");
                if (a.ignoreCase && g)
                    for (i = 0; e > i; ++i)
        ...
        function e(a) {
            for (var b = void 0, c = a.firstChild; c; c = c.nextSibling)
                var d = c.nodeType
                  , b = 1 === d ? b ? a : c : 3 === d ? v.test(c.nodeValue) ? a : b : b;
            return b === a ? void 0 : b
        }
        function f(c, e) {
            function f(a) {
        ...
        function g(b) {
            ...
            d.push(["str", /^<(?:(?:(?:\.\.\/)*|\/?)(?:[\w-]+(?:\/[\w-]+)+)?[\w-]+\.h(?:h|pp|\+\+)?|[a-z]\w*)>/, a])) : c.push(["com", /^#[^\n\r]*/, a, "#"])),
            ...
            return (e = b.types) && d.push(["typ", e]),
            e = ("" + b.keywords).replace(/^ | $/g, ""),
            e.length && d.push(["kwd", RegExp("^(?:" + e.replace(/[\s,]+/g, "|") + ")\\b"), a]),
            c.push(["pln", /^\s+/, a, " \r\n	 "]),
            e = "^.[^\\s\\w.$@'\"`/\\\\]*",
            b.regexLiterals && (e += "(?!s*/)"),
            d.push(["lit", /^@[$_a-z][\w$@]*/i, a], ["typ", /^(?:[@_]?[A-Z]+[a-z][\w$@]*|\w+_t\b)/, a], ["pln", /^[$_a-z][\w$@]*/i, a], ["lit", /^(?:0x[\da-f]+|(?:\d(?:_\d+)*\d*(?:\.\d*)?|\.\d\+)(?:e[+-]?\d+)?)[a-z]*/i, a, "0123456789"], ["pln", /^\\[\S\s]?/, a], ["pun", RegExp(e), a]),
            f(c, d)
        }
        function h(a, b, c) {
            function d(a) {
        ...
        function j(a, b) {
            return a && x.hasOwnProperty(a) || (a = /^\s*</.test(b) ? "default-markup" : "default-code"),
            x[a]
        }
        function k(a) {
            var b = a.h;
            try {
                ...
                for (n = p,
                q = p = 0; n > q; ) {
                    for (var r = m[q], s = m[q + 1], t = q + 2; n >= t + 2 && m[t + 1] === s; )
                        t += 2;
                    m[p++] = r,
                    m[p++] = s,
                    q = t
                ...
                try {
                    for (; k > e; ) {
                        ...
                        if (1 !== z.nodeType && (w = g.substring(d, t))) {
                            ...
                            C.replaceChild(B, z),
                            B.appendChild(z),
                            x > d && (i[e + 1] = z = A.createTextNode(g.substring(t, x)),
        ...
        var l = window
          ...
          , n = [[m, "auto,case,char,const,default,double,enum,extern,float,goto,inline,int,long,register,short,signed,sizeof,static,struct,switch,typedef,union,unsigned,void,volatile"], "catch,class,delete,false,import,new,operator,private,protected,public,this,throw,true,try,typeof"]
          , o = [n, "alignof,align_union,asm,axiom,bool,concept,concept_map,const_cast,constexpr,decltype,delegate,dynamic_cast,explicit,export,friend,generic,late_check,mutable,namespace,nullptr,property,reinterpret_cast,static_assert,static_cast,template,typeid,typename,using,virtual,where"]
          , p = [n, "abstract,assert,boolean,byte,extends,final,finally,implements,import,instanceof,interface,null,native,package,strictfp,super,synchronized,throws,transient"]
          , q = [p, "as,base,by,checked,decimal,delegate,descending,dynamic,event,fixed,foreach,from,group,implicit,in,internal,into,is,let,lock,object,out,override,orderby,params,partial,readonly,ref,sbyte,sealed,stackalloc,string,select,uint,ulong,unchecked,unsafe,ushort,var,virtual,where"]
          , n = [n, "debugger,eval,export,function,get,null,set,undefined,var,with,Infinity,NaN"]
          , r = [m, "and,as,assert,class,def,del,elif,except,exec,finally,from,global,import,in,is,lambda,nonlocal,not,or,pass,print,raise,try,with,yield,False,True,None"]
          ...
          , t = [m, "as,assert,const,copy,drop,enum,extern,fail,false,fn,impl,let,log,loop,match,mod,move,mut,priv,pub,pure,ref,self,static,struct,true,trait,type,unsafe,use"]
          , m = [m, "case,done,elif,esac,eval,fi,function,in,local,set,then,until"]
          , u = /^(DIR|FILE|vector|(de|priority_)?queue|list|stack|(const_)?iterator|(multi)?(set|map)|bitset|u?(int|float)\d*)\b/
          , v = /\S/
          , w = g({
          ...
          , x = {};
        i(w, ["default-code"]),
        i(f([], [["pln", /^[^<?]+/], ["dec", /^<!\w[^>]*(?:>|$)/], ["com", /^<\!--[\S\s]*?(?:--\>|$)/], ["lang-", /^<\?([\S\s]+?)(?:\?>|$)/], ["lang-", /^<%([\S\s]+?)(?:%>|$)/], ["pun", /^(?:<[%?]|[%?]>)/], ["lang-", /^<xmp\b[^>]*>([\S\s]+?)<\/xmp\b[^>]*>/i], ["lang-js", /^<script\b[^>]*>([\S\s]*?)(<\/script\b[^>]*>)/i], ["lang-css", /^<style\b[^>]*>([\S\s]*?)(<\/style\b[^>]*>)/i], ["lang-in.tag", /^(<\/?[a-z][^<>]*>)/i]]), ["default-markup", "htm", "html", "mxml", "xhtml", "xml", "xsl"]),
        ...
        var y = l.PR = {
            ...
            prettyPrint: l.prettyPrint = function(b, c) {
                function d() {
                    for (var c = l.PR_SHOULD_USE_CONTINUATION ? o.now() + 250 : 1 / 0; q < i.length && o.now() < c; q++) {
                        for (var f = i[q], j = x, m = f; m = m.previousSibling; ) {
                            ...
                            if (y ? !/^\??prettify\b/.test(y) : 3 !== n || /\S/.test(m.nodeValue))
                                break;
                            if (y) {
                                j = {},
                        ...
                        if (m = f.className,
                        (j !== x || s.test(m)) && !t.test(m)) {
                            for (n = !1,
                            y = f.parentNode; y; y = y.parentNode)
                                if (w.test(y.tagName) && y.className && s.test(y.className)) {
                                    n = !0;
                                    break
                                }
                            if (!n) {
                                if (f.className += " prettyprinted",
                                n = j.lang,
                                !n) {
                                    var z, n = m.match(r);
                                    !n && (z = e(f)) && v.test(z.tagName) && (n = z.className.match(r)),
                                    n && (n = n[1])
                                }
                                if (u.test(f.tagName))
                                    y = 1;
                                    ...
                                    var y = f.currentStyle
                                      , A = g.defaultView
                                      , y = (y = y ? y.whiteSpace : A && A.getComputedStyle ? A.getComputedStyle(f, a).getPropertyValue("white-space") : 0) && "pre" === y.substring(0, 3);
                                A = j.linenums,
                                (A = "true" === A || +A) || (A = (A = m.match(/\blinenums\b(?::(\d+))?/)) ? A[1] && A[1].length ? +A[1] : !0 : !1),
                                A && h(f, A, y),
                                p = {
                                    h: n,
                                    c: f,
                ...
                for (var f = c || document.body, g = f.ownerDocument || document, f = [f.getElementsByTagName("pre"), f.getElementsByTagName("code"), f.getElementsByTagName("xmp")], i = [], j = 0; j < f.length; ++j)
                    for (var m = 0, n = f[j].length; n > m; ++m)
                        i.push(f[j][m]);
                var f = a
                  , o = Date;
                o.now || (o = {
...
var Namespace = function(a) {
    var b = window;
    if ("" !== a)
        for (var c = a.split(Namespace.separator), d = 0, e = c.length; e > d; d++)
            b[c[d]] || (b[c[d]] = {}),
            b = b[c[d]];
    return b
};
...
com.zybuluo.indexedDB = function() {
    var a = "zybuluoIndexedDB"
      , b = 1
      , c = "localNoteActions"
      , d = ["local_note_id", "version_id", "author", "tags", "action", "title", "details", "public", "anchor_list", "created_by", "created_date", "last_updated_by", "last_updated_date"]
      , e = "loginUser"
      , f = ["name", "user_tier"]
      , g = null
      , h = function(d) {
        if (!window.indexedDB)
            return d(),
            window.alert("您的浏览器不支持 IndexedDB 离线存储技术，将影响部分离线功能。您可以升级当前浏览器，或者使用最新版的 Chrome 浏览器，或者下载使用 Cmd Markdown 的客户端版本。"),
            !1;
        if (null !== g)
            return window.alert("database has been opened."),
            console.error("database has been opened."),
            !1;
        ...
        f.onerror = function(a) {
            console.error("openDatabase ERROR:", a.target.errorCode),
            d()
        }
        ,
        f.onupgradeneeded = function(a) {
            ...
            var b = a.target.result
              , d = b.createObjectStore(c, {
                keyPath: "local_note_id"
            });
            d.createIndex("author", "author", {
                unique: !1
            });
            b.createObjectStore(e, {
                keyPath: "name"
            })
        }
        ,
...
com.zybuluo.common.pushState = function(a) {
    ...
    window.history.pushState ? (window.history.pushState(null, "", a),
    window.location.hash = b) : (null === a.match(/#.*?$/) && (a += b),
    window.location = a)
}
,
...
com.zybuluo.common.getCurrentScreenType = function() {
    var a = {
      ...
      , b = $(window).width();
    return 767 >= b && b > 0 ? a.isMobile = !0 : b > 767 && 979 >= b ? a.isTablet = !0 : a.isDesktop = !0,
    a
}
,
com.zybuluo.common.popupConfirm = function() {
    ...
    c.click(function() {
        ...
        a ? ($(this).removeData("operation"),
        a()) : (b.modal("hide"),
        window.location.reload())
    }),
    d.click(function() {
        var a = $(this).data("cancelOperation");
        a && ($(this).removeData("cancelOperation"),
        a())
    });
    var g = !1;
    return {
...
com.zybuluo.common.bindResendConfirmation = function(a, b) {
    $("a#email-request-verification").click(function(c) {
        c.preventDefault(),
        $.post($("a#email-request-verification").attr("href"), null, function(c) {
    ...
    var a = com.zybuluo.indexedDB
      ...
      , d = function(c, d) {
        e(function() {
            ...
            f.oncomplete = function() {
                console.log("SUCCESS: write to login user!"),
                d && d(c)
            }
            ,
            f.onerror = function() {
                console.error("ERROR: write to login user!"),
                d && d(c)
            }
            ;
      ...
      , e = function(c) {
        ...
        g.onsuccess = function() {
            console.log("SUCCESS: clear the login user!"),
            c && c(null)
        }
        ,
        g.onerror = function() {
            console.error("ERROR: clear the login user!"),
            c && c(null)
        }
    };
    return {
...
$(function() {
    var a = $("#global-prompt-alert")
      , b = $("#close-global-prompt-alert")
      , c = $("#global-prompt-message")
      , d = com.zybuluo.base.initData;
