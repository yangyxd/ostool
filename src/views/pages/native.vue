  ...
  <div class="container native">
    <el-row>
      <el-col>
        ...
        <el-row class="mt8" style="line-height: 2.5; display: inline-block; width: 100%;">
          <el-button type="primary" @click="_encode()">↓ 编码</el-button>
          <el-button type="success" @click="_decode()">↑ 解码</el-button>
          <el-select
            v-model="mode"
            placeholder="请选择"
            style="width: 160px; margin-left: 12px; margin-top: -2px"
            :change="onModeChange()"
          >
          ...
          <div style="text-align: right; float: right;">
            <el-button
              @click="srcText = '', result = ''">清空</el-button
            >
          </div>
        </el-row>
        <div class="mt8">
    ...
    _encode() {
      ...
      try {
        ...
        if (this.mode === 'Native / UTF-8') {
          ...
          this.result = this.srcText.replace(/[^\u0000-\u00FF]/g, function ($0) {
