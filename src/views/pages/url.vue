<template>
    <div class="container url">
        <el-row>
            <el-col>
                <div>
                    <el-input type="textarea" :autosize="{ minRows: 9, maxRows: 20 }" clearable placeholder="在此输入源文本"
                        v-model="srcText">
                    </el-input>
                </div>
                <el-row class="mt8" style="line-height: 36px; display: inline-block; width: 100%;">
                    <el-button type="primary" @click="_encode()" >↓ 编码</el-button>
                    <el-button type="success" @click="_decode()" >↑ 解码</el-button>
                    <el-select v-model="mode" placeholder="请选择"
                        style="width: 110px; margin-left: 12px; margin-top: -2px;">
                        <el-option v-for="item in options" :key="item" :label="item" :value="item">
                        </el-option>
                    </el-select>
                    <el-select v-model="modeFunc" placeholder="请选择"
                        style="width: 200px; margin-left: 12px; margin-top: -2px;">
                        <el-option v-for="item in optionsFunc" :key="item" :label="item" :value="item">
                        </el-option>
                    </el-select>
                ...
                <div class="mt8">
                    <el-input type="textarea" :autosize="{ minRows: 9, maxRows: 25 }" placeholder="在此输入编码后的文本"
                        v-model="result">
                    </el-input>
                </div>
            </el-col>
        ...
        <div class="rightpl">
            <div class="title"><svg style="width: 24px; height: 24px; margin: 4px 0 0 0" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-v-029747aa=""><path fill="currentColor" d="M512 64a448 448 0 1 1 0 896 448 448 0 0 1 0-896zm0 192a58.432 58.432 0 0 0-58.24 63.744l23.36 256.384a35.072 35.072 0 0 0 69.76 0l23.296-256.384A58.432 58.432 0 0 0 512 256zm0 512a51.2 51.2 0 1 0 0-102.4 51.2 51.2 0 0 0 0 102.4z"></path></svg> 小知识</div>
            <div>
