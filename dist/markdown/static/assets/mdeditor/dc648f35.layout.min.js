...
com.zybuluo.mdeditor.common.applyPreviewElementTheme = function(a) {
    ...
    $prettifyStyle.attr("href", b + "prettify-cmd.css"),
    c(".in-page-button > span", "rgba(44, 62, 80, 0.65)", "rgba(102, 128, 153, 0.45)"),
    $(".wmd-preview blockquote").removeClass().addClass("white-blockquote")) : ($("#wmd-preview table").each(function() {
    ...
    $prettifyStyle.attr("href", b + "desert-cmd.css"),
    ...
    drak = $("body").hasClass("theme-black");
