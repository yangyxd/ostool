...
function confirmArea(e) {
    $("#confirmAreaModal").modal("hide"),
    $("body").off("click", "#confirmAreaModal .sure"),
    $("body").off("click", "#confirmAreaModal .cancle"),
    e.con ? e.con : "";
    var t = e.title ? e.title : "请输入"
      , n = e.btnTitle ? e.btnTitle : ["取消", "确定"]
      , i = e.value ? e.value : ""
      , o = e.placeholder ? e.placeholder.toString() : "请输入..."
      , r = '<div class="modal fade" id="confirmAreaModal">\n<div class="modal-dialog modal-sm">\n<div class="modal-content">\n<div class="modal-header bg-primary">\n<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">关闭</span></button>\n<h4 class="modal-title" style="font-weight:normal">' + t + "</h4>\n" + "</div>\n" + '<div class="modal-body">\n' + '<div class="input-control">\n' + '<textarea placeholder="' + o + '" value="' + i + '" rows="8"></textarea>\n' + "</div>\n" + "</div>\n" + '<div class="modal-footer" style="border-top:0">\n' + '<button type="button" class="btn btn-default cancle">' + n[0] + "</button>\n" + '<button type="button" class="btn btn-primary sure">' + n[1] + "</button>\n" + "</div>\n" + "</div>\n" + "</div>\n" + "</div>";
    $("body").prepend(r),
    $("#confirmAreaModal").modal({
        keyboard: !1,
        show: !0,
        position: "fit",
        backdrop: "static"
...
function parseParam(e, t) {
    var n = "";
    if ("string" == typeof e || "number" == typeof e || "boolean" == typeof e || null === e || void 0 === e)
        n += "&" + t + "=" + e;
...
function recordRecentUse(e, t) {
    ...
    if ($.zui ? n = $.zui.store.get("recent_arr") : (n = localStorage.getItem("recent_arr"),
    n = JSON.parse(n)),
    n && n.length) {
...
function recentUseList() {
    ...
    if (e && e.length)
        for (var t = 0; t < e.length; t++)
            $("#recentUse").append('<a class="btn btn-sm" href="' + e[t].url + '">' + e[t].name + "</a>")
}
function goTop() {
    var e = "#goTop";
    if (document.getElementById("goTop")) {
        ...
        t > 178 && n > i ? n + 178 - $("body").scrollTop() > i ? ($(".md-toc").addClass("md-toc-fixed"),
        $(".md-toc").css("top", "")) : ($(".md-toc").removeClass("md-toc-fixed"),
        n > i && $(".md-toc").css("top", n - i - 33 > 0 ? n - i - 33 + "px" : "")) : $(".md-toc").removeClass("md-toc-fixed"),
        window.onscroll = function() {
            var t = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop;
            t > 100 ? $(e).fadeIn(200) : $(e).fadeOut(200),
            t > 178 && n > i ? n + 178 - t > i ? ($(".md-toc").addClass("md-toc-fixed"),
            $(".md-toc").css("top", "")) : ($(".md-toc").removeClass("md-toc-fixed"),
            n > i && $(".md-toc").css("top", n - i - 33 > 0 ? n - i - 33 + "px" : "")) : $(".md-toc").removeClass("md-toc-fixed")
        }
        ,
...
function clearActiveAfter() {
    ...
    $(".custom-tab li").each(function(n, i) {
        $(i).attr("data-target") || (e += $(i).outerWidth(),
        t = n)
    }),
    1160 >= e ? $(".custom-tab li").eq(t).find("a").eq(0).addClass("clear-after") : (e = 0,
    $(".custom-tab li").each(function(t, n) {
        e += $(n).outerWidth(),
        !$(n).attr("data-target") && e > 1080 && ($(".custom-tab .dropdown").show(),
...
function isEmail(e) {
    var t = e.find("input").eq(0).val()
      , n = /^(\w-*\.*)+@(\w-?)+(\.\w{2,})+$/;
    return t ? n.test(t) ? (e.addClass("has-success"),
    !0) : (e.addClass("has-error"),
    !1) : (e.addClass("has-error"),
    !1)
}
function isNickname(e) {
    var t = e.find("input").eq(0).val();
    return t ? (e.addClass("has-success"),
    !0) : (e.addClass("has-error"),
    !1)
}
function isNumber(e) {
...
function convertBase64UrlToBlob(e) {
    for (var t = e.split(";base64,"), n = t[0].split(":")[1], i = window.atob(t[1]), o = i.length, r = new Uint8Array(o), a = 0; o > a; a++)
        r[a] = i.charCodeAt(a);
    return new Blob([r],{
        type: n
    })
...
function yasuo(e) {
    ...
    (2 === e || 3 === e) && (t = t.replace(/\\/g, "\\\\").replace(/\"/g, '\\"')),
    4 === e && (t = t.replace(/\\\\/g, "\\").replace(/\\\"/g, '"')),
    editor.setValue(t)
}
function indexFormat() {
    var e, t = editor.getValue();
    t = t.trim(),
    (t.startWith("'{") && t.endWith("}'") || t.startWith("'\\[") && t.endWith("]'") || t.startWith('"\\[') && t.endWith(']"') || t.startWith('"{') && t.endWith('}"')) && (e = window.confirm("您发的JSON是一个字符串,而不是对象,您需要转成JSON对象么?"),
    1 == e && (t = t.substr(1, t.length - 2),
    ...
    try {
        ...
        document.getElementById("jsonlintResult").innerHTML = o,
...
function convert_formated_hex_to_bytes(e) {
    ...
    if ("" == e.trim())
        return [];
    if (/[^0-9a-fA-F\s]/.test(e))
        return !1;
    for (t = e.split(/([0-9a-fA-F]+)/g),
    n = t.length,
    i = 0; n > i; ++i)
        "" != t[i].trim() && (r[o++] = parseInt(t[i], 16));
    return r
}
...
function getAndShowPictures() {
    ...
    this.add = function(t) {
        ...
        if (1 == $(t)[0].files.length) {
            if (r[0].size > 2097152)
                return msgError("图片的大小不能大于2M"),
                void 0;
            var a = "<div class='imageDiv' > <img id='img" + r[0].name + "replay" + "' /> <div class='cover' data-id='" + ++this.imgCount + "'><i class='delbtn'>删除</i></div></div>";
            o.prepend(a);
            ...
            if (r && r[0])
                ...
                ,
                -1 == e.indexOf("MSIE"))
                    s.src = window.URL.createObjectURL(i.files[0]);
                else if (-1 != i.value.indexOf(",")) {
                    var l = i.value.split(",");
                    s.src = l[0]
                } else
                    s.src = i.value;
            this.uploadImgArr.push(i.files[0]),
            5 === this.imgCount && (msgError("最多只能上传5张图片"),
            n.parents("form").find(".addImages").hide())
        } else
            for (var c = 0; c < $(t)[0].files.length; c++)
                if (i.files[c].size > 2097152)
                    msgError("图片的大小不能大于2M");
                else {
                    var a = "<div class='imageDiv' > <img id='img" + r[c].name + "replay" + "' /> <div class='cover' data-id='" + ++this.imgCount + "'><i class='delbtn'>删除</i></div></div>";
                    o.prepend(a);
                    ...
                    if (r && r[c])
                        ...
                        -1 == e.indexOf("MSIE"))
                            s.src = window.URL.createObjectURL(i.files[c]);
                        else if (-1 != i.value.indexOf(",")) {
                            var l = i.value.split(",");
                            s.src = l[c]
                        } else
                            s.src = i.value;
                    if (this.uploadImgArr.push(i.files[c]),
                    5 === this.imgCount) {
                        msgError("最多只能上传5张图片"),
                        n.parents("form").find(".addImages").hide();
                        break
    ...
    this.cancel = function(e) {
        ...
        this.uploadImgArr.splice(o - 1, 1),
        n.parents(".imageDiv").remove(),
        i.find(".imageDiv .cover").each(function(e, n) {
            $(n).attr("data-id", t - e)
        })
    }
}
function resizeCodemirror(e, t, n, i) {
    ...
    $(e).each(function(e, r) {
        $(r) && $(r).draggable({
            ...
            drag: function(e) {
                $(t).each(function(t, r) {
                    $(r) && (i ? $(r + " " + i).height(e.offset.y + o > n ? e.offset.y + o : n) : $(r + " .CodeMirror").height(e.offset.y + o > n ? e.offset.y + o : n))
                })
            },
            finish: function() {}
        })
...
function gen() {
    try {
        $("#jsonBeanCon").html(""),
        $("#downloadJavaBean").hide();
        var e = jsonlint.parse(editor.getValue());
        e && ($("#jsonlintResult").html("正确的JSON!"),
        $("#jsonlintBox").addClass("alert-success alert").removeClass("alert-warning alert-danger"),
        $("#jsonlintIcon").addClass("icon-ok-sign").removeClass("icon-info-sign icon-remove-sign"));
        var t = $("#className").val()
          , n = $("#packageName").val()
        ...
        if (i) {
            ...
            $.each(r, function(e, t) {
                var i = toBeanText(t, n)
                  , o = "";
                0 != e && (o = "small-text"),
                i = i.replace("<int>", "<Integer>").replace("<long>", "<Long>");
...
function chechJavaWords() {
    ...
    for (var t = javawordsStr.split(","), n = 0; n < t.length; n++) {
        var i = t[n]
          , o = '"' + i + '":'
          , r = "'" + i + "':";
        if (-1 != e.indexOf(o) || -1 != e.indexOf(r))
            return alertError({
...
function genJson(e) {
    return "" == editor.getValue().trim() ? (msgError("请填写JSON"),
    !1) : (e.button("loading"),
    doPost(bejsonHost + "Bejson/Api/JsonToJavapojo/", {
        json: editor.getValue(),
        "package": $("#package").val(),
        fillEnable: document.getElementById("fillEnableChk").checked ? "1" : "0"
    }, function(t) {
        200 === t.code || "200" === t.code ? ($("#resData").html(t.data),
        $("#myModal").modal("show", "fit")) : alertError({
            con: t.msg
        }),
        e.button("reset")
    }, function(t) {
...
function testCase() {
    document.getElementById("jsonlintBox") && ($("#jsonlintResult").html("正确的JSON!"),
    $("#jsonlintBox").addClass("alert-success alert").removeClass("alert-warning alert-danger"),
    $("#jsonlintIcon").addClass("icon-ok-sign").removeClass("icon-info-sign icon-remove-sign")),
...
function downloadZip2(e, t, n) {
    var i = e
      , o = t
      , r = $("#resData").html();
    $("#package") && $("#package").val() && (i = $("#package").val()),
    $("#saveName") && $("#saveName").val() && (o = $("#saveName").val());
    var a = new JSZip
...
function downloadZip3(e, t, n) {
    ...
    if (null != i) {
        i && -1 === i.indexOf(".") ? i += e : (i = n,
        i.split(".").pop().toLowerCase() === t || (i = i.split(".")[0] + e));
...
function downloadZip4(e, t, n, i, o) {
    var r;
    if (r = o ? o : window.prompt("文件另存为"),
    null != r) {
        r && -1 === r.indexOf(".") ? r += e : (r = n,
        r.split(".").pop().toLowerCase() === t || (r = r.split(".")[0] + e));
        var a = new Blob([i],{
            type: ""
        });
        saveAs(a, r)
    ...
    if (e)
        try {
            ...
            if (t) {
                ...
                $("#jsonlintBox").removeClass("alert-success alert alert-warning alert-danger")
            }
        } catch (i) {
            document.getElementById("jsonlintResult").innerHTML = i,
            $("#jsonlintBox").addClass("alert-danger alert").removeClass("alert-warning alert-success"),
            $("#jsonlintIcon").addClass("icon-remove-sign").removeClass("icon-info-sign icon-ok-sign")
        }
}
...
function aesdesEncrypt() {
    var e = editor.getValue();
    if (!e)
        return msgError("请输入要加密的内容"),
        void 0;
    var t = $("#pwd").val();
    switch ($("#enctype").val()) {
    case "aes":
        $("#ctype").val(CryptoJS.AES.encrypt(e, t)),
        editor2.setValue($("#ctype").val());
        break;
    case "des":
        $("#ctype").val(CryptoJS.DES.encrypt(e, t)),
        editor2.setValue($("#ctype").val());
        break;
    case "rabbit":
        $("#ctype").val(CryptoJS.Rabbit.encrypt(e, t)),
        editor2.setValue($("#ctype").val());
        break;
    case "rc4":
        $("#ctype").val(CryptoJS.RC4.encrypt(e, t)),
        editor2.setValue($("#ctype").val());
        break;
    case "tripledes":
        $("#ctype").val(CryptoJS.TripleDES.encrypt(e, t)),
        editor2.setValue($("#ctype").val())
    }
}
...
function rsaConvert() {
    ...
    case "buildRSAEncryptByPrivateKey":
        o = bejsonHost + "Bejson/Api/Rsa/prvDecrypt",
        r = {
            privateKey: n,
            decSign: i,
            etype: t
...
function shaHash(e) {
    ...
    case "sha1":
        $("#shaPbkdfBox").hide(),
        $("#shapwdBox").addClass("display-none"),
        $("#shaValueExchange").val(CryptoJS.SHA1(editor.getValue())),
        editor2.setValue($("#shaValueExchange").val());
        break;
    case "sha3":
        $("#shaPbkdfBox").hide(),
        $("#shapwdBox").addClass("display-none"),
        $("#shaValueExchange").val(CryptoJS.SHA3(editor.getValue())),
        editor2.setValue($("#shaValueExchange").val());
        break;
    case "sha224":
        $("#shaPbkdfBox").hide(),
        $("#shapwdBox").addClass("display-none"),
        $("#shaValueExchange").val(CryptoJS.SHA224(editor.getValue())),
        editor2.setValue($("#shaValueExchange").val());
        break;
    case "sha256":
        $("#shaPbkdfBox").hide(),
        $("#shapwdBox").addClass("display-none"),
        $("#shaValueExchange").val(CryptoJS.SHA256(editor.getValue())),
        editor2.setValue($("#shaValueExchange").val());
        break;
    case "sha384":
        $("#shaPbkdfBox").hide(),
        $("#shapwdBox").addClass("display-none"),
        $("#shaValueExchange").val(CryptoJS.SHA384(editor.getValue())),
        editor2.setValue($("#shaValueExchange").val());
        break;
    case "sha512":
        $("#shaPbkdfBox").hide(),
        $("#shapwdBox").addClass("display-none"),
        $("#shaValueExchange").val(CryptoJS.SHA512(editor.getValue())),
        editor2.setValue($("#shaValueExchange").val());
        break;
    case "md5":
        $("#shaPbkdfBox").hide(),
        $("#shapwdBox").addClass("display-none"),
        $("#shaValueExchange").val(CryptoJS.MD5(editor.getValue())),
        editor2.setValue($("#shaValueExchange").val());
        break;
    case "hmacsha1":
        $("#shaPbkdfBox").hide(),
        $("#shapwdBox").removeClass("display-none"),
        $("#shaValueExchange").val(CryptoJS.HmacSHA1(editor.getValue(), $("#shapwd").val())),
        editor2.setValue($("#shaValueExchange").val());
        break;
    case "hmacsha3":
        $("#shaPbkdfBox").hide(),
        $("#shapwdBox").removeClass("display-none"),
        $("#shaValueExchange").val(CryptoJS.HmacSHA3(editor.getValue(), $("#shapwd").val())),
        editor2.setValue($("#shaValueExchange").val());
        break;
    case "hmacsha224":
        $("#shaPbkdfBox").hide(),
        $("#shapwdBox").removeClass("display-none"),
        $("#shaValueExchange").val(CryptoJS.HmacSHA224(editor.getValue(), $("#shapwd").val())),
        editor2.setValue($("#shaValueExchange").val());
        break;
    case "hmacsha256":
        $("#shaPbkdfBox").hide(),
        $("#shapwdBox").removeClass("display-none"),
        $("#shaValueExchange").val(CryptoJS.HmacSHA256(editor.getValue(), $("#shapwd").val())),
        editor2.setValue($("#shaValueExchange").val());
        break;
    case "hmacsha384":
        $("#shaPbkdfBox").hide(),
        $("#shapwdBox").removeClass("display-none"),
        $("#shaValueExchange").val(CryptoJS.HmacSHA384(editor.getValue(), $("#shapwd").val())),
        editor2.setValue($("#shaValueExchange").val());
        break;
    case "hmacsha512":
        $("#shaPbkdfBox").hide(),
        $("#shapwdBox").removeClass("display-none"),
        $("#shaValueExchange").val(CryptoJS.HmacSHA512(editor.getValue(), $("#shapwd").val())),
        editor2.setValue($("#shaValueExchange").val());
        break;
    case "hmacmd5":
        $("#shaPbkdfBox").hide(),
        $("#shapwdBox").removeClass("display-none"),
        $("#shaValueExchange").val(CryptoJS.HmacMD5(editor.getValue(), $("#shapwd").val())),
        editor2.setValue($("#shaValueExchange").val());
        break;
    case "pbkdf2":
        $("#shaPbkdfBox").show(),
...
function evalEncode() {
    ...
    if (e) {
        ...
        editor2.setValue($("#evalHidden").val())
    }
}
function evalNum(e) {
...
function goFormat() {
    $.zui.store.set("evalpackageCon", editor.getValue()),
    window.location.href = "/jshtml_format/"
}
function onMatch() {
    if (!isValidFields())
        return !1;
    ...
    if (document.getElementById("optionGlobal").checked) {
        ...
        $("#cBox").text("匹配位置：" + e.lastIndex + "\r\n匹配结果：" + n[0]),
        prettyPrint();
    return !0
}
function buildRegex() {
    var e = "";
    return document.getElementById("optionGlobal").checked && (e = "g"),
    document.getElementById("optionIgnoreCase").checked && (e += "i"),
    new RegExp(document.getElementById("textPattern").value,e)
}
function isValidFields() {
    var e = editor.getValue();
    if (null == e || "" == e)
        return msgError("请输入待匹配文本"),
        !1;
    var t = $("#textPattern").val();
    return null == t || "" == t ? ($("#textPattern").focus(),
    msgError("请输入正则表达式"),
    !1) : !0
}
function onReplace() {
    ...
    var e = editor.getValue()
      , t = buildRegex()
      , n = $("#replaceText").val();
    $("#cBox2").removeClass("prettyprinted").text(e.replace(t, n)),
    prettyPrint()
}
function xpathOnMatch() {
    var e = $("#textPattern").val()
      , t = editor.getValue();
    if (!t)
        return msgError("编辑器内容不能为空"),
        void 0;
    if (!e)
        return msgError("正则表达式内容不能为空"),
        void 0;
    try {
        var n = new DOMParser;
        ...
        if (null !== i)
            for (var o = i.iterateNext(); o; )
                $("#cBox").removeClass("prettyprinted").text(o.innerHTML),
                prettyPrint(),
                o = i.iterateNext()
    } catch (r) {
        throw msgError("该浏览器不支持此转换，请切换浏览器"),
        new Error(r)
    }
}
...
function find(e) {
    ...
    $(t).find(n).each(function() {
        switch (e) {
        case 1:
            $("#showImg").is(":checked") && $("#findImgRes").append("<img src='" + $(this).attr("src") + "' style='margin-left:2px'> "),
            i += $(this).attr("src") + "\r\n\r\n";
            break;
        case 2:
            i += $(this).html() + "\r\n\r\n";
...
function removeDuplicate() {
    var e, t, n = [], i = editor.getValue().split("\n");
    for (var o in i) {
        e = i[o],
        t = !1;
        for (var r in n)
...
function getCaptcha() {
    doPost(bejsonHost + "Utils/Captcha/gen", {}, function(e) {
        200 === e.code || "200" === e.code ? ($("#captcha").prop("src", e.data.img),
        createLognCaptcha = e.data.captcha) : alertError({
            con: e.msg
        })
    }, function() {
        msgError("获取验证码失败")
...
function createlogoQiniuUploader(e, t) {
    doPost(bejsonHost + "Bejson/Api/ImageHandle/upToken", {}, function(n) {
        if (200 === n.code || "200" === n.code) {
            ...
            i.putFile(r, e, {
                before: function() {
                    $(t).attr("data-status", "uploading"),
                    $(t + " .actions .file-status").attr("data-original-title", "正在上传")
                },
                progress: function(e) {
                    $(t + " .file-progress-bar").css("width", e.toFixed(2) + "%"),
                    $(t + " .actions .file-status .text").html(e.toFixed(2) + "%")
                }
            }, function(e) {
                if (e)
                    $("#uploadLogoBtn").button("reset"),
                    $("#createLogo").button("reset"),
                    $(t).attr("data-status", "failed"),
                    $(t + " .actions .file-status").attr("data-original-title", "失败"),
                    $(t + " .actions .file-status .text").html("失败"),
                    msgError("上传失败，请稍候重试"),
                    getCaptcha();
                else {
                    var n = "/Bejson/Api/ImageHandle/imgZip?logo=/" + r + "&vercode=" + $("#logoCaptcha").val() + "&captcha=" + encodeURIComponent(createLognCaptcha);
                    createLogo(n),
                    getCaptcha(),
                    $("#uploadLogoBtn").button("reset"),
                    $("#createLogo").button("reset"),
                    $(t).attr("data-status", "sucess"),
                    $(t + " .actions .file-status").attr("data-original-title", "成功"),
                    $(t + " .actions .file-status .text").html("成功")
                }
            })
        } else
            alertError({
...
function ocrQiniuUploader(e, t, n) {
    doPost(bejsonHost + "Bejson/Api/ImageHandle/upToken", {}, function(i) {
        if (200 === i.code || "200" === i.code) {
            ...
            window.img2SvgFilename = t.name,
            o.putFile(a, t, {
                before: function(e, t) {
                    window.img2SvgKeystr = t,
                    $(n).attr("data-status", "uploading"),
                    $(n + " .actions .file-status").attr("data-original-title", "正在上传")
                },
                progress: function(e) {
                    $(n + " .file-progress-bar").css("width", e.toFixed(2) + "%"),
                    $(n + " .actions .file-status .text").html(e.toFixed(2) + "%")
                }
            }, function(o) {
                if (o)
                    e.button("reset"),
                    $(n).attr("data-status", "failed"),
                    $(n + " .actions .file-status").attr("data-original-title", "失败"),
                    $(n + " .actions .file-status .text").html("失败"),
                    msgError("转换失败，请稍候重试");
                else {
                    $(n).attr("data-status", "sucess"),
                    $(n + " .actions .file-status").attr("data-original-title", "成功"),
                    $(n + " .actions .file-status .text").html("成功");
...
function htmlJsConvert() {
    var e = "";
    e = 1 == htmlJsType ? htmlJsHtml2js(editor.getValue()) : htmlJsJs2html(editor.getValue()),
    editor2.setValue(e)
}
function deserializeDeser(e) {
    ...
    doPost(bejsonHost + "Bejson/Api/Deserialize/deserialization", {
        ...
        if (200 === n.code || "200" === n.code) {
            if ("false" === n.data.json)
                return msgError("输入代码格式有误"),
                e.button("reset"),
                void 0;
            if (!n.data.php)
                return msgError("输入代码格式有误"),
                e.button("reset"),
                void 0;
            editor2.setValue(n.data.json),
            editor5.setValue("array(" + JSON.stringify(n.data.php).match(t)[1] + ")")
        } else
            alertError({
                con: n.msg
            });
...
function ox2strCheckInput() {
    var e = editor.getValue();
    return $("#charlength").text(e.length),
    e.length > 10240 ? (msgError("数据不可以超过10M，否则会被屏蔽使用", function() {}),
    !1) : !0
}
function ox2strHexandchar(e, t) {
    var n = editor.getValue();
    if (n.length > 10240)
        return msgError("数据不可以超过10M，否则会被屏蔽使用", function() {}),
        void 0;
    if (n = n.replace(/[\\|%]\S/gi, "").replace(/\s/g, ""),
    "" == n)
        return msgError("内容不能为空"),
        void 0;
    t.button("loading");
    var i = bejsonHost + "Bejson/Api/HexToString/toWord";
    "d" === e && (i = bejsonHost + "Bejson/Api/hexToString/toHexadecimal"),
    doPost(i, {
        input: n
    }, function(e) {
        if (t.button("reset"),
        200 === e.code || "200" === e.code) {
            var n = Util.charset
...
function decodeJsEncodeWithHex() {
    var txt1 = editor.getValue()
      , pre = ""
      , other = "";
    if (txt1 = txt1.replace('window["\\x65\\x76\\x61\\x6c"]', "eval"),
    "(" != txt1.substring(0, 1)) {
        var index1 = txt1.indexOf("(");
        pre = txt1.substring(0, index1),
        txt1 = txt1.substring(index1, txt1.length)
    }
...
function GiveRGB(Hex) {
    return Value = "A" == Hex ? 10 : "B" == Hex ? 11 : "C" == Hex ? 12 : "D" == Hex ? 13 : "E" == Hex ? 14 : "F" == Hex ? 15 : eval(Hex)
}
function GiveHex(e) {
    return Value = 10 == e ? "A" : 11 == e ? "B" : 12 == e ? "C" : 13 == e ? "D" : 14 == e ? "E" : 15 == e ? "F" : "" + e
}
function HexToRGB(t) {
    return t = t.toUpperCase(),
    a = GiveRGB(t.substring(0, 1)),
    b = GiveRGB(t.substring(1, 2)),
    c = GiveRGB(t.substring(2, 3)),
    d = GiveRGB(t.substring(3, 4)),
    e = GiveRGB(t.substring(4, 5)),
    f = GiveRGB(t.substring(5, 6)),
    x = 16 * a + b,
    y = 16 * c + d,
    z = 16 * e + f,
    (x ? x + "," : "") + (y ? y + "," : "") + (z ? z : "")
...
function renderLogo(e, t, n) {
    ...
    ,
    i.src = t,
    void 0) : (o.fillStyle = "rgb(255, 255, 255)",
    o.fillRect(0, 0, r, r),
    void 0)
}
...
function htm2ubb(e) {
    ...
    e = e.replace(/<p[^>\/]*\/>/gi, "\n"),
    e = e.replace(/\son[\w]{3,16}\s?=\s*([\'\"]).+?\1/gi, ""),
    e = e.replace(/<hr[^>]*>/gi, "[hr]"),
    e = e.replace(/<(sub|sup|u|strike|b|i|pre)>/gi, "[$1]"),
    e = e.replace(/<\/(sub|sup|u|strike|b|i|pre)>/gi, "[/$1]"),
    e = e.replace(/<(\/)?strong>/gi, "[$1b]"),
    e = e.replace(/<(\/)?em>/gi, "[$1i]"),
    e = e.replace(/<(\/)?blockquote([^>]*)>/gi, "[$1blockquote]"),
    e = e.replace(/<img[^>]*smile=\"(\d+)\"[^>]*>/gi, "[s:$1]"),
    e = e.replace(/<img[^>]*src=[\'\"\s]*([^\s\'\"]+)[^>]*>/gi, "[img]$1[/img]"),
    e = e.replace(/<a[^>]*href=[\'\"\s]*([^\s\'\"]*)[^>]*>(.+?)<\/a>/gi, "[url=$1]$2[/url]"),
    e = e.replace(/<[^>]*?>/gi, ""),
    e = e.replace(/&amp;/gi, "&"),
    e = e.replace(/&lt;/gi, "<"),
    e = e.replace(/&gt;/gi, ">"),
...
function ubb2html(e) {
    ...
    e = e.replace(/>/gi, "&gt;"),
    e = e.replace(/\n/gi, "<br />"),
    e = e.replace(/\[code\](.+?)\[\/code\]/gi, function(e, t) {
        return phpcode(t)
    }),
    e = e.replace(/\[hr\]/gi, "<hr />"),
    e = e.replace(/\[\/(size|color|font|backcolor)\]/gi, "</font>"),
    e = e.replace(/\[(sub|sup|u|i|strike|b|blockquote|li)\]/gi, "<$1>"),
    e = e.replace(/\[\/(sub|sup|u|i|strike|b|blockquote|li)\]/gi, "</$1>"),
    e = e.replace(/\[\/align\]/gi, "</p>"),
    e = e.replace(/\[(\/)?h([1-6])\]/gi, "<$1h$2>"),
    e = e.replace(/\[align=(left|center|right|justify)\]/gi, '<p align="$1">'),
    e = e.replace(/\[size=(\d+?)\]/gi, '<font size="$1">'),
    e = e.replace(/\[color=([^\[\<]+?)\]/gi, '<font color="$1">'),
    e = e.replace(/\[backcolor=([^\[\<]+?)\]/gi, '<font style="background-color:$1">'),
    e = e.replace(/\[font=([^\[\<]+?)\]/gi, '<font face="$1">'),
    e = e.replace(/\[list=(a|A|1)\](.+?)\[\/list\]/gi, '<ol type="$1">$2</ol>'),
    e = e.replace(/\[(\/)?list\]/gi, "<$1ul>"),
    e = e.replace(/\[s:(\d+)\]/gi, function(e, t) {
        return smilepath(t)
    }),
    e = e.replace(/\[img\]([^\[]*)\[\/img\]/gi, '<img src="$1" border="0" />'),
    e = e.replace(/\[url=([^\]]+)\]([^\[]+)\[\/url\]/gi, '<a href="http://www.bejson.com/$1">$2</a>'),
    e = e.replace(/\[url\]([^\[]+)\[\/url\]/gi, '<a href="http://www.bejson.com/$1">$1</a>')
}
function htmltoubb() {
    ...
    doPost(bejsonHost + "Bejson/Api/ImageHandle/upToken", {}, function(i) {
        if (200 === i.code || "200" === i.code) {
            var o = qiniu.bucket(i.data.domain, {
              ...
              , r = 1e17 * Math.random()
              , a = "upload/" + r + "." + extname(t.name);
            window.imghandlerFilename = t.name,
            o.putFile(a, t, {
                before: function() {
                    $(n).attr("data-status", "uploading"),
                    $(n + " .actions .file-status").attr("data-original-title", "正在上传")
    ...
    doPost(bejsonHost + "Bejson/Api/ImageHandle/upToken", {}, function(n) {
        if (200 === n.code || "200" === n.code) {
            ...
            i.putFile(r, e, {
                ...
                if (i)
                    $("#uploadIconBtn").button("reset"),
                    $("#createFavicon").button("reset"),
                    $(t).attr("data-status", "failed"),
                    $(t + " .actions .file-status").attr("data-original-title", "失败"),
                    $(t + " .actions .file-status .text").html("失败"),
                    msgError("上传失败，请稍候重试");
...
function img2base64Reset() {
    ...
    for (var n = 0; colCount > n; n++)
        e[n] = 0;
    $(".waterfall li").each(function() {
        for (var n = e[0], i = 0, o = 0; colCount > o; o++)
            e[o] < n && (n = e[o],
            i = o);
        $(this).css({
            left: i * t,
...
function shorturlChange() {
    ...
    $("#shorturlContent").val($("#shorturlResult").val()),
    $("#shorturlResult").val(e)
}
...
function v10toX(e, t) {
    if (t = String(t).replace(/ /gi, ""),
    "" == t)
        return "";
    if (parseInt(t) != t)
        return jinzhiM("请输入整数！"),
        "";
...
function vXto10(n, m) {
    if (m = String(m).replace(/ /gi, ""),
    "" == m)
        return "";
    var a = jinzhiSs.substr(0, n);
    if ("" != eval("m.replace(/[" + a + "]/gi,'')"))
        return jinzhiM("请输入" + n + "进制数！"),
        "";
    for (var t = 0, c = 1, x = m.length - 1; x > -1; x--)
        t += c * a.indexOf(m.charAt(x)),
        c *= n;
    return t
}
function vXtoY(e, t, n) {
    return a = vXto10(1 * e, t),
    "" == a ? "" : a = v10toX(n, a)
}
function jinzhiM(e) {
    0 == alert_msg_count && (msgError(e),
    alert_msg_count++)
}
    ...
    doPost(bejsonHost + "Bejson/Api/ImageHandle/upToken", {}, function(i) {
        if (200 === i.code || "200" === i.code) {
            ...
            o.putFile(a, t, {
                ...
                $(n + " .actions .file-status").attr("data-original-title", "成功"),
                $(n + " .actions .file-status .text").html("成功"),
                file2PdfCheckStatus(o.persistentId, o.name, e, t))
            })
        } else
            alertError({
                con: i.msg
        ...
        $.getJSON("http://www.bejson.com/api/qiniuajax.php?id=" + e, function(e) {
            if (0 == e.code) {
                ...
                var t = i.name.lastIndexOf(".")
                  ...
                  , a = "<li><p>" + r + '</p><a class="btn btn-primary" href="http://7xkmrw.com1.z0.glb.clouddn.com/" target="_blank">预览</a><a class="btn btn-success" href="http://7xkmrw.com1.z0.glb.clouddn.com/?attname=.pdf" download target="_blank">下载</a></li>';
...
function num2hzChange(e) {
    ...
    if (e) {
        ...
        $("#num2hzEstr").val(i),
        $("#num2hzRmb").show(),
        $("#num2hzEstr2").val(changeNumMoneyToChinese(t))
    } else {
...
function changeNumMoneyToChinese(e) {
    var t, n, i, o = new Array("零","壹","贰","叁","肆","伍","陆","柒","捌","玖"), r = new Array("","拾","佰","仟"), a = new Array("","万","亿","兆"), s = new Array("角","分","毫","厘"), l = "整", c = "圆", d = 1e15, u = "";
    if ("" == e)
        return "";
    if (e = parseFloat(e),
    e >= d)
        return msgError("超出最大处理数字"),
        "";
    if (0 == e)
        return u = o[0] + c + l;
    if (e = e.toString(),
...
function native2ascii() {
    for (var e = editor.getValue().split(""), t = "", n = 0; n < e.length; n++) {
        ...
        if (!document.getElementById("ignoreLetter").checked || i > 127) {
            var o = i.toString(16);
            o = new String("0000").substring(o.length, 4) + o,
            t += "\\u" + o
        } else
            t += e[n]
    }
...
function ascii2native() {
    for (var e = editor2.getValue().split("\\u"), t = e[0], n = 1; n < e.length; n++) {
        var i = e[n];
        t += String.fromCharCode(parseInt("0x" + i.substring(0, 4))),
        i.length > 4 && (t += i.substring(4, i.length))
    }
    editor.setValue(t)
}
...
function J2Fconvert(e) {
    0 == e ? editor2.setValue(jtgo(editor.getValue())) : 2 == e ? editor2.setValue(qqgo(editor.getValue())) : editor2.setValue(ftgo(editor.getValue()))
}
function softParse(e) {
    for (var n = "", i = 0; i < e.length; i++) {
        ...
        var o = "";
        if ("" != t[0]) {
            for (var r = 0; r < t[2].length; r++)
                o += softRooturl + t[2][r] + ",";
            for (var a = "", r = 0; r < t[1].length; r++) {
                var s = t[1][r]
                  , l = "" == s.name ? "下载" : s.name
                  , c = -1 != s.url.indexOf("http://") || -1 != s.url.indexOf("https://") ? s.url : softRooturl + s.url;
                a += '<a class="btn-success btn btn-sm l-big-margin" href="' + c + "\" shotimg='" + o + "' class='downa' target='_blank'>" + l + "</a>"
            }
    ...
    if (a) {
        ...
        $.each(s, function(e, t) {
            var n = toBeanText(t, r)
              , i = "";
            0 != e && (i = "small-text"),
            n = n.replace("<int>", "<Integer>").replace("<long>", "<Long>"),
            l += n
        }),
        editor2.setValue(l)
    }
...
function sql2pojoChechJavaWords(e) {
    ...
    for (var n = javawordsStr.split(","), i = 0; i < n.length; i++) {
        var o = n[i]
          , r = '"' + o + '":'
          , a = "'" + o + "':";
        if (-1 != t.indexOf(r) || -1 != t.indexOf(a))
            return alertError("转换失败"),
            !1
    }
    return !0
}
function sql2pojo() {
    return editor.getValue() ? ($("#sql2pojoSubmit").button("loading"),
    doPost(bejsonHost + "Bejson/Api/SqlToC/getSqlToC", {
        ...
        200 === e.code || "200" === e.code ? sql2pojoChechJavaWords(e.data) && sql2pojoGen(e.data, $("#pojoType").val(), $("#pojoLowcasedv").val(), $("#pojoPackage").val()) : alertError({
            con: e.msg
        }),
    ...
    void 0) : (msgError("请输入sql语句"),
    void 0)
}
function sql2pojoOgetType(e) {
    return e = e.toLowerCase(),
    -1 != e.indexOf("varchar") ? "String" : -1 != e.indexOf("number") || -1 != e.indexOf("int") ? "int" : -1 != e.indexOf("blob") ? "InputStream" : -1 != e.indexOf("long") ? "long" : -1 != e.indexOf("decimal") || -1 != e.indexOf("numeric") ? "double" : e
}
function sql2pojoOchange() {
    var e = editor.getValue();
    sql = e.replace(/\n/gi, ""),
    sql = sql.replace(/create table ([^\\(]+)+\((.*)\)/gi, "$1##$2"),
    sql = sql.split("##"),
    sql[0].trim(),
    sql = sql[1];
    var t = sql.split(",");
    ...
    $(t).each(function() {
        if ("" != this.toString().trim()) {
            ...
            field = e[0],
            type = e[1],
            n += "private " + sql2pojoOgetType(type) + " " + field + ";\r\n"
        }
    }),
    editor2.setValue(n)
}
function sqlviewConvert() {
    return editor.getValue() ? ($("#sqlviewVtable").html(""),
    doPost(bejsonHost + "Bejson/Api/SqlView/formatSql", {
        formatSql: editor.getValue()
    }, function(e) {
        if (200 === e.code || "200" === e.code) {
            var t = e.data;
            for (var n in t)
                $("#sqlviewVtable").append("<tr><td>" + n + "</td><td>" + t[n] + "</td></tr>")
        } else
            alertError({
                con: e.msg
            });
...
function getIpinfo() {
    doPost(bejsonHost + "Bejson/Api/Ip/getIp", {
        ...
        if (200 === e.code || "200" === e.code) {
            ...
            $("#country_id").text(t.country_id),
            $("#area").text(t.location),
            $("#area_id").text(t.area_id),
            $("#region").text(t.region),
            $("#region_id").text(t.region_id),
            $("#city").text(t.city),
            $("#city_id").text(t.city_id),
            $("#county").text(t.county),
            $("#county_id").text(t.county_id),
            $("#isp").text(t.isp),
            $("#isp_id").text(t.isp_id)
        } else
            msgError(e.msg);
        $("#checkIp").button("reset"),
        $("#queryipBox").removeClass("loading")
    }, function() {
        msgError("获取失败，请稍候再试"),
        $("#checkIp").button("reset"),
        $("#queryipBox").removeClass("loading")
...
function userAgentParseHtml(e, t) {
    for (var n = "", i = 0; i < t.length; i++) {
        var o = t[i];
        n += "<tr>",
        n += "<td>" + o[0] + '</td><td class="copy-agent-con">' + o[1] + '<td><button type="button" class="btn copy-agent">复制</button></td></td>',
        n += "</tr>"
    }
    $("#" + e).append(n)
}
function ip2int() {
    var e = $("#ip2intStr").val()
      , t = /^[1-9]([0-9\.]+\d)?$/;
    return e ? t.test(e) ? (e = e.split("."),
    4 !== e.length ? (msgError("IP格式错误"),
    void 0) : (num = 256 * 256 * 256 * Number(e[0]) + 256 * 256 * Number(e[1]) + 256 * Number(e[2]) + Number(e[3]),
    num >>>= 0,
    document.getElementById("ip2intRstr").value = num,
    void 0)) : (msgError("IP格式错误"),
    void 0) : (msgError("请输入IP"),
    void 0)
}
function int2ip() {
    var e = $("#ip2intStr").val()
      , t = /^\+?[1-9][0-9]*$/;
    if (!e)
        return msgError("请输入数字"),
        void 0;
    if (!t.test(e))
        return msgError("请输入正整数"),
        void 0;
    var n = new Array;
    n[0] = e >>> 24 >>> 0,
    n[1] = e << 8 >>> 24 >>> 0,
    n[2] = e << 16 >>> 24,
    n[3] = e << 24 >>> 24,
    str = String(n[0]) + "." + String(n[1]) + "." + String(n[2]) + "." + String(n[3]),
    document.getElementById("ip2intRstr").value = str
}
function doJsBeautify() {
    var e = editor.getValue().replace(/^\s+/, "");
    if (!e)
        return msgError("格式化的代码不能为空"),
        void 0;
    var t = document.getElementById("tabsize").value
      , n = " ";
    return 1 == t && (n = "	"),
    e && "<" === e.charAt(0) ? editor.setValue(style_html(e, t, n, 80)) : editor.setValue(js_beautify(e, t, n)),
    !1
}
function jshtmlFormatPackJs(e) {
    var t = editor.getValue().replace(/^\s+|\s+$/g, "");
    if ("" == t)
        return msgError("请输入需要压缩的内容!"),
        void 0;
    var n = new Packer;
    if (e)
        var i = n.pack(t, 1, 0);
...
function jshtmlFormatChange() {
    jshtmlFormatIschange ? jshtmlFormatRechange() : jshtmlFormatChangeIt(),
    jshtmlFormatIschange = !jshtmlFormatIschange
}
function doJsCssBeautify() {
    ...
    return 1 == t && (n = "	"),
    e && "<" === e.charAt(0) ? editor.setValue(style_html(e, t, n, 80)) : editor.setValue(js_beautify(e, t, n)),
    document.getElementById("cssBeautify").disabled = !1,
    !1
}
function cssPackJs(e) {
    var t = editor.getValue().replace(/^\s+|\s+$/g, "");
    if ("" == t)
        return alert("请输入需要压缩的内容!"),
        void 0;
    var n = new Packer;
    if (e)
        var i = n.pack(t, 1, 0);
...
!function(e, t) {
    function n(e) {
        var t = e.length
          , n = dt.type(e);
        return dt.isWindow(e) ? !1 : 1 === e.nodeType && t ? !0 : "array" === n || "function" !== n && (0 === t || "number" == typeof t && t > 0 && t - 1 in e)
    }
    function i(e) {
        var t = kt[e] = {};
    ...
    function o(e, n, i, o) {
        if (dt.acceptData(e)) {
            var r, a, s = dt.expando, l = e.nodeType, c = l ? dt.cache : e, d = l ? e[s] : e[s] && s;
            if (d && c[d] && (o || c[d].data) || i !== t || "string" != typeof n)
                return d || (d = l ? e[s] = tt.pop() || dt.guid++ : s),
                c[d] || (c[d] = l ? {} : {
                    toJSON: dt.noop
                }),
                ("object" == typeof n || "function" == typeof n) && (o ? c[d] = dt.extend(c[d], n) : c[d].data = dt.extend(c[d].data, n)),
                a = c[d],
                o || (a.data || (a.data = {}),
                a = a.data),
                i !== t && (a[dt.camelCase(n)] = i),
                "string" == typeof n ? (r = a[n],
                null == r && (r = a[dt.camelCase(n)])) : r = a,
                r
        }
    }
    function r(e, t, n) {
        if (dt.acceptData(e)) {
            var i, o, r = e.nodeType, a = r ? dt.cache : e, l = r ? e[dt.expando] : dt.expando;
            if (a[l]) {
                if (t && (i = n ? a[l] : a[l].data)) {
                    dt.isArray(t) ? t = t.concat(dt.map(t, dt.camelCase)) : t in i ? t = [t] : (t = dt.camelCase(t),
                    t = t in i ? [t] : t.split(" ")),
                    o = t.length;
                    for (; o--; )
                        delete i[t[o]];
                    if (n ? !s(i) : !dt.isEmptyObject(i))
                        return
                }
                (n || (delete a[l].data,
                s(a[l]))) && (r ? dt.cleanData([e], !0) : dt.support.deleteExpando || a != a.window ? delete a[l] : a[l] = null)
            }
        }
    }
    function a(e, n, i) {
        if (i === t && 1 === e.nodeType) {
            ...
            "string" == typeof i) {
                try {
                    i = "true" === i ? !0 : "false" === i ? !1 : "null" === i ? null : +i + "" === i ? +i : Et.test(i) ? dt.parseJSON(i) : i
                } catch (r) {}
                dt.data(e, n, i)
            } else
                i = t
    ...
    function s(e) {
        var t;
        for (t in e)
            if (("data" !== t || !dt.isEmptyObject(e[t])) && "toJSON" !== t)
                return !1;
        return !0
    }
    function l() {
    ...
    function g(e) {
        return e.type = (null !== dt.find.attr(e, "type")) + "/" + e.type,
        e
    }
    function m(e) {
    ...
    function v(e, t) {
        for (var n, i = 0; null != (n = e[i]); i++)
            dt._data(n, "globalEval", !t || dt._data(t[i], "globalEval"))
    }
    function y(e, t) {
        if (1 === t.nodeType && dt.hasData(e)) {
            var n, i, o, r = dt._data(e), a = dt._data(t, r), s = r.events;
            if (s) {
                delete a.handle,
                a.events = {};
                for (n in s)
    ...
    function b(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            !dt.support.noCloneEvent && t[dt.expando]) {
                o = dt._data(t);
                for (i in o.events)
                    dt.removeEvent(t, i, o.handle);
                t.removeAttribute(dt.expando)
            }
            "script" === n && t.text !== e.text ? (g(t).text = e.text,
            m(t)) : "object" === n ? (t.parentNode && (t.outerHTML = e.outerHTML),
            dt.support.html5Clone && e.innerHTML && !dt.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && tn.test(e.type) ? (t.defaultChecked = t.checked = e.checked,
            t.value !== e.value && (t.value = e.value)) : "option" === n ? t.defaultSelected = t.selected = e.defaultSelected : ("input" === n || "textarea" === n) && (t.defaultValue = e.defaultValue)
        }
    }
    function x(e, n) {
        var i, o, r = 0, a = typeof e.getElementsByTagName !== G ? e.getElementsByTagName(n || "*") : typeof e.querySelectorAll !== G ? e.querySelectorAll(n || "*") : t;
        if (!a)
            for (a = [],
            i = e.childNodes || e; null != (o = i[r]); r++)
                !n || dt.nodeName(o, n) ? a.push(o) : dt.merge(a, x(o, n));
    ...
    function _(e, t) {
        return e = t || e,
        "none" === dt.css(e, "display") || !dt.contains(e.ownerDocument, e)
    }
    function C(e, t) {
        for (var n, i, o, r = [], a = 0, s = e.length; s > a; a++)
            i = e[a],
            i.style && (r[a] = dt._data(i, "olddisplay"),
            n = i.style.display,
            t ? (r[a] || "none" !== n || (i.style.display = ""),
            "" === i.style.display && _(i) && (r[a] = dt._data(i, "olddisplay", S(i.nodeName)))) : r[a] || (o = _(i),
            (n && "none" !== n || !o) && dt._data(i, "olddisplay", o ? n : dt.css(i, "display"))));
        for (a = 0; s > a; a++)
            i = e[a],
    ...
    function E(e, t, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > r; r += 2)
            "margin" === n && (a += dt.css(e, n + Cn[r], !0, o)),
            i ? ("content" === n && (a -= dt.css(e, "padding" + Cn[r], !0, o)),
            "margin" !== n && (a -= dt.css(e, "border" + Cn[r] + "Width", !0, o))) : (a += dt.css(e, "padding" + Cn[r], !0, o),
            "padding" !== n && (a += dt.css(e, "border" + Cn[r] + "Width", !0, o)));
        return a
    }
    function T(e, t, n) {
        var i = !0
        ...
        if (0 >= o || null == o) {
            ...
            bn.test(o))
                return o;
            i = a && (dt.support.boxSizingReliable || o === e.style[t]),
            o = parseFloat(o) || 0
        }
    ...
    function S(e) {
        var t = X
          , n = $n[e];
        return n || (n = j(e, t),
        "none" !== n && n || (dn = (dn || dt("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement),
        t = (dn[0].contentWindow || dn[0].contentDocument).document,
    ...
    function M(e) {
        return function(t, n) {
            "string" != typeof t && (n = t,
            t = "*");
            var i, o = 0, r = t.toLowerCase().match(pt) || [];
            if (dt.isFunction(n))
                for (; i = r[o++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
    ...
    function I(e, n, i, o) {
        function r(l) {
            var c;
            return a[l] = !0,
            dt.each(e[l] || [], function(e, l) {
                var d = l(n, i, o);
                return "string" != typeof d || s || a[d] ? s ? !(c = d) : t : (n.dataTypes.unshift(d),
                r(d),
                !1)
            }),
            c
    ...
    function N(e, n) {
        ...
        return i && dt.extend(!0, e, i),
        e
    }
    function D(e, n, i) {
        for (var o, r, a, s, l = e.contents, c = e.dataTypes; "*" === c[0]; )
            c.shift(),
    ...
    function V(e, t, n) {
        var i, o, r = 0, a = oi.length, s = dt.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (o)
                return !1;
            for (var t = Zn || H(), n = Math.max(0, c.startTime + c.duration - t), i = n / c.duration || 0, r = 1 - i, a = 0, l = c.tweens.length; l > a; a++)
                c.tweens[a].run(r);
        ...
        for (z(d, c.opts.specialEasing); a > r; r++)
            if (i = oi[r].call(c, e, d, c.opts))
                return i;
        return dt.map(d, O, c),
        dt.isFunction(c.opts.start) && c.opts.start.call(e, c),
    ...
    function F(e, t, n) {
        var i, o, r, a, s, l, c = this, d = {}, u = e.style, p = e.nodeType && _(e), h = dt._data(e, "fxshow");
        n.queue || (s = dt._queueHooks(e, "fx"),
        ...
        c.always(function() {
            c.always(function() {
                s.unqueued--,
                dt.queue(e, "fx").length || s.empty.fire()
            })
        })),
        1 === e.nodeType && ("height"in t || "width"in t) && (n.overflow = [u.overflow, u.overflowX, u.overflowY],
        "inline" === dt.css(e, "display") && "none" === dt.css(e, "float") && (dt.support.inlineBlockNeedsLayout && "inline" !== S(e.nodeName) ? u.zoom = 1 : u.display = "inline-block")),
        n.overflow && (u.overflow = "hidden",
        dt.support.shrinkWrapBlocks || c.always(function() {
        ...
        if (!dt.isEmptyObject(d)) {
            h ? "hidden"in h && (p = h.hidden) : h = dt._data(e, "fxshow", {}),
            r && (h.hidden = !p),
    ...
    var U, J, G = typeof t, Q = e.location, X = e.document, K = X.documentElement, Y = e.jQuery, Z = e.$, et = {}, tt = [], nt = "1.10.2", it = tt.concat, ot = tt.push, rt = tt.slice, at = tt.indexOf, st = et.toString, lt = et.hasOwnProperty, ct = nt.trim, dt = function(e, t) {
        return new dt.fn.init(e,t,J)
    }, ut = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, pt = /\S+/g, ht = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ft = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, gt = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, mt = /^[\],:{}\s]*$/, vt = /(?:^|:|,)(?:\s*\[)+/g, yt = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, bt = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, xt = /^-ms-/, $t = /-([\da-z])/gi, wt = function(e, t) {
        return t.toUpperCase()
    }, _t = function(e) {
        (X.addEventListener || "load" === e.type || "complete" === X.readyState) && (Ct(),
        dt.ready())
    }, Ct = function() {
        X.addEventListener ? (X.removeEventListener("DOMContentLoaded", _t, !1),
        e.removeEventListener("load", _t, !1)) : (X.detachEvent("onreadystatechange", _t),
        e.detachEvent("onload", _t))
    };
    dt.fn = dt.prototype = {
        jquery: nt,
        constructor: dt,
        init: function(e, n, i) {
            ...
            if (!e)
                return this;
            if ("string" == typeof e) {
                if (o = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : ft.exec(e),
                !o || !o[1] && n)
                    return !n || n.jquery ? (n || i).find(e) : this.constructor(n).find(e);
                if (o[1]) {
                    if (n = n instanceof dt ? n[0] : n,
                    dt.merge(this, dt.parseHTML(o[1], n && n.nodeType ? n.ownerDocument || n : X, !0)),
                    gt.test(o[1]) && dt.isPlainObject(n))
                        for (o in n)
                            dt.isFunction(this[o]) ? this[o](n[o]) : this.attr(o, n[o]);
                    return this
                }
                if (r = X.getElementById(o[2]),
                r && r.parentNode) {
                    if (r.id !== o[2])
                        return i.find(e);
                    this.length = 1,
            ...
            this.length = 1,
            this) : dt.isFunction(e) ? i.ready(e) : (e.selector !== t && (this.selector = e.selector,
        ...
        ready: function(e) {
            return dt.ready.promise().done(e),
            this
        },
        slice: function() {
    ...
    dt.extend = dt.fn.extend = function() {
        var e, n, i, o, r, a, s = arguments[0] || {}, l = 1, c = arguments.length, d = !1;
        ...
        --l); c > l; l++)
            if (null != (r = arguments[l]))
                for (o in r)
                    e = s[o],
                    i = r[o],
                    s !== i && (d && i && (dt.isPlainObject(i) || (n = dt.isArray(i))) ? (n ? (n = !1,
                    a = e && dt.isArray(e) ? e : []) : a = e && dt.isPlainObject(e) ? e : {},
                    s[o] = dt.extend(d, a, i)) : i !== t && (s[o] = i));
        return s
    }
    ,
    dt.extend({
        ...
        ready: function(e) {
            if (e === !0 ? !--dt.readyWait : !dt.isReady) {
                ...
                dt.isReady = !0,
                e !== !0 && --dt.readyWait > 0 || (U.resolveWith(X, [dt]),
                dt.fn.trigger && dt(X).trigger("ready").off("ready"))
            }
        },
        ...
        isPlainObject: function(e) {
            var n;
            if (!e || "object" !== dt.type(e) || e.nodeType || dt.isWindow(e))
                return !1;
            try {
        ...
        parseHTML: function(e, t, n) {
            ...
            var i = gt.exec(e)
              , o = !n && [];
            return i ? [t.createElement(i[1])] : (i = dt.buildFragment([e], t, o),
            o && dt(o).remove(),
            dt.merge([], i.childNodes))
        },
        parseJSON: function(n) {
            return e.JSON && e.JSON.parse ? e.JSON.parse(n) : null === n ? n : "string" == typeof n && (n = dt.trim(n),
            n && mt.test(n.replace(yt, "@").replace(bt, "]").replace(vt, ""))) ? Function("return " + n)() : (dt.error("Invalid JSON: " + n),
            t)
        },
        parseXML: function(n) {
            var i, o;
            ...
            return i && i.documentElement && !i.getElementsByTagName("parsererror").length || dt.error("Invalid XML: " + n),
            i
        },
        noop: function() {},
        ...
        proxy: function(e, n) {
            ...
            n = e,
            e = r),
            dt.isFunction(e) ? (i = rt.call(arguments, 2),
            o = function() {
                return e.apply(n || this, i.concat(rt.call(arguments)))
            }
            ,
            o.guid = e.guid = e.guid || dt.guid++,
            o) : t
        },
        access: function(e, n, i, o, r, a, s) {
            ...
            n))
                for (; c > l; l++)
                    n(e[l], i, s ? o : o.call(e[l], l, n(e[l], i)));
    ...
    dt.ready.promise = function(t) {
        if (!U)
            ...
            "complete" === X.readyState)
                ...
                X.addEventListener("DOMContentLoaded", _t, !1),
                e.addEventListener("load", _t, !1);
            else {
                X.attachEvent("onreadystatechange", _t),
                e.attachEvent("onload", _t);
                var n = !1;
                try {
    ...
    function(e, t) {
        function n(e, t, n, i) {
            ...
            if ((t ? t.ownerDocument || t : V) !== I && M(t),
            t = t || I,
            n = n || [],
            !e || "string" != typeof e)
                return n;
            ...
            if (D && !i) {
                    ...
                    if (a = o[1]) {
                        if (9 === s) {
                            ...
                            if (r.id === a)
                                return n.push(r),
                                n
                        } else if (t.ownerDocument && (r = t.ownerDocument.getElementById(a)) && H(t, r) && r.id === a)
                            return n.push(r),
                            n
                    } else {
                        if (o[2])
                ...
                if (_.qsa && (!B || !B.test(e))) {
                    ...
                    1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (c = p(e),
                        (d = t.getAttribute("id")) ? u = d.replace(wt, "\\$&") : t.setAttribute("id", u),
                        u = "[id='" + u + "'] ",
                        l = c.length; l--; )
                            c[l] = u + h(c[l]);
                        f = ht.test(e) && t.parentNode || t,
                        g = c.join(",")
                    }
                    if (g)
                        try {
                            return et.apply(n, f.querySelectorAll(g)),
                            n
                        } catch (m) {} finally {
        ...
        function p(e, t) {
            ...
            l = [],
            c = k.preFilter; s; ) {
                (!i || (o = ut.exec(s))) && (o && (s = s.slice(o[0].length) || s),
                l.push(r = [])),
                i = !1,
                (o = pt.exec(s)) && (i = o.shift(),
                r.push({
                    value: i,
                    type: o[0].replace(ct, " ")
                }),
                s = s.slice(i.length));
                for (a in k.filter)
                    !(o = vt[a].exec(s)) || c[a] && !(o = c[a](o)) || (i = o.shift(),
                    r.push({
                        value: i,
                        type: a,
                        matches: o
        ...
        function v(e, t, n, i, r, a) {
            ...
            r && !r[O] && (r = v(r, a)),
            o(function(o, a, s, l) {
                var c, d, u, p = [], h = [], f = a.length, g = o || x(t || "*", s.nodeType ? [s] : s, []), v = !e || !o && t ? g : m(g, p, e, s, l), y = n ? r || (o ? e : f || i) ? [] : a : v;
                if (n && n(v, y, s, l),
                i)
                    for (c = m(y, h),
                    i(c, [], s, l),
                ...
                if (o) {
                    if (r || e) {
                        ...
                        for (d = y.length; d--; )
                            (u = y[d]) && (c = r ? nt.call(o, u) : p[d]) > -1 && (o[c] = !(a[c] = u))
                    }
                } else
                    y = m(y === a ? y.splice(f, y.length) : y),
                    r ? r(null, a, y, l) : et.apply(a, y)
            })
        }
        function y(e) {
        ...
        function b(e, t) {
            var i = 0
              ...
              , s = function(o, s, l, c, d) {
                var u, p, h, f = [], g = 0, v = "0", y = o && [], b = null != d, x = j, $ = o || a && k.find.TAG("*", d && s.parentNode || s), w = z += null == x ? 1 : Math.random() || .1;
                for (b && (j = s !== I && s,
                C = i); null != (u = $[v]); v++) {
                    if (a && u) {
                        for (p = 0; h = e[p++]; )
                ...
                r && v !== g) {
                    ...
                    if (o) {
                        if (g > 0)
                            for (; v--; )
                                y[v] || f[v] || (f[v] = Y.call(c));
                        f = m(f)
                    }
                    et.apply(c, f),
                    b && !o && f.length > 0 && g + t.length > 1 && n.uniqueSort(c)
                }
                return b && (z = w,
                j = x),
                y
        ...
        function $(e, t, n, i) {
            ...
            if (!i && 1 === c.length) {
                ...
                r.length > 2 && "ID" === (a = r[0]).type && _.getById && 9 === t.nodeType && D && k.relative[r[1].type]) {
                    if (t = (k.find.ID(a.matches[0].replace(_t, Ct), t) || [])[0],
                    !t)
                        return n;
                    e = e.slice(r.shift().value.length)
                }
                for (o = vt.needsContext.test(e) ? 0 : r.length; o-- && (a = r[o],
                !k.relative[s = a.type]); )
                    if ((l = k.find[s]) && (i = l(a.matches[0].replace(_t, Ct), ht.test(r[0].type) && t.parentNode || t))) {
                        if (r.splice(o, 1),
                        e = i.length && h(r),
                        !e)
                            return et.apply(n, i),
            ...
            return S(e, c)(i, t, !D, n, ht.test(e)),
            n
        }
        var w, _, C, k, E, T, S, j, A, M, I, N, D, B, L, P, H, O = "sizzle" + -new Date, V = e.document, z = 0, F = 0, R = i(), q = i(), W = i(), U = !1, J = function(e, t) {
            return e === t ? (U = !0,
            0) : 0
        }, G = typeof t, Q = 1 << 31, X = {}.hasOwnProperty, K = [], Y = K.pop, Z = K.push, et = K.push, tt = K.slice, nt = K.indexOf || function(e) {
            for (var t = 0, n = this.length; n > t; t++)
                if (this[t] === e)
                    return t;
            return -1
        }
        , it = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ot = "[\\x20\\t\\r\\n\\f]", rt = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", at = rt.replace("w", "w#"), st = "\\[" + ot + "*(" + rt + ")" + ot + "*(?:([*^$|!~]?=)" + ot + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + at + ")|)|)" + ot + "*\\]", lt = ":(" + rt + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + st.replace(3, 8) + ")*)|.*)\\)|)", ct = RegExp("^" + ot + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ot + "+$", "g"), ut = RegExp("^" + ot + "*," + ot + "*"), pt = RegExp("^" + ot + "*([>+~]|" + ot + ")" + ot + "*"), ht = RegExp(ot + "*[+~]"), ft = RegExp("=" + ot + "*([^\\]'\"]*)" + ot + "*\\]", "g"), gt = RegExp(lt), mt = RegExp("^" + at + "$"), vt = {
            ID: RegExp("^#(" + rt + ")"),
            CLASS: RegExp("^\\.(" + rt + ")"),
        ...
        }, yt = /^[^{]+\{\s*\[native \w/, bt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, xt = /^(?:input|select|textarea|button)$/i, $t = /^h\d$/i, wt = /'|\\/g, _t = RegExp("\\\\([\\da-f]{1,6}" + ot + "?|(" + ot + ")|.)", "ig"), Ct = function(e, t, n) {
            var i = "0x" + t - 65536;
            return i !== i || n ? t : 0 > i ? String.fromCharCode(i + 65536) : String.fromCharCode(55296 | i >> 10, 56320 | 1023 & i)
        };
        try {
            et.apply(K = tt.call(V.childNodes), V.childNodes),
            K[V.childNodes.length].nodeType
        } catch (kt) {
            et = {
        ...
        M = n.setDocument = function(e) {
            ...
            L = [],
            B = [],
            (_.qsa = yt.test(n.querySelectorAll)) && (r(function(e) {
                e.innerHTML = "<select><option selected=''></option></select>",
                e.querySelectorAll("[selected]").length || B.push("\\[" + ot + "*(?:value|" + it + ")"),
            ...
            r(function(e) {
                ...
                e.querySelectorAll("[t^='']").length && B.push("[*^$]=" + ot + "*(?:''|\"\")"),
                e.querySelectorAll(":enabled").length || B.push(":enabled", ":disabled"),
                e.querySelectorAll("*,:x"),
                B.push(",.*:")
            })),
            (_.matchesSelector = yt.test(P = N.webkitMatchesSelector || N.mozMatchesSelector || N.oMatchesSelector || N.msMatchesSelector)) && r(function(e) {
            ...
            H = yt.test(N.contains) || N.compareDocumentPosition ? function(e, t) {
            ...
            J = N.compareDocumentPosition ? function(e, t) {
                ...
                return i ? 1 & i || !_.sortDetached && t.compareDocumentPosition(e) === i ? e === n || H(V, e) ? -1 : t === n || H(V, t) ? 1 : A ? nt.call(A, e) - nt.call(A, t) : 0 : 4 & i ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
            }
            : function(e, t) {
                ...
                if (e === t)
                    ...
                    0;
                if (!r || !a)
                    return e === n ? -1 : t === n ? 1 : r ? -1 : a ? 1 : A ? nt.call(A, e) - nt.call(A, t) : 0;
                if (r === a)
                    return s(e, t);
        ...
        n.matchesSelector = function(e, t) {
            ...
            t = t.replace(ft, "='$1']"),
            !(!_.matchesSelector || !D || L && L.test(t) || B && B.test(t)))
                try {
                    var i = P.call(e, t);
        ...
        n.attr = function(e, n) {
            ...
            return o === t ? _.attributes || !D ? e.getAttribute(n) : (o = e.getAttributeNode(n)) && o.specified ? o.value : null : o
        }
        ,
        n.error = function(e) {
        ...
        k = n.selectors = {
            ...
            preFilter: {
                ATTR: function(e) {
                    return e[1] = e[1].replace(_t, Ct),
                    e[3] = (e[4] || e[5] || "").replace(_t, Ct),
                    "~=" === e[2] && (e[3] = " " + e[3] + " "),
                    e.slice(0, 4)
                },
                CHILD: function(e) {
            ...
            filter: {
                ...
                ATTR: function(e, t, i) {
                    return function(o) {
                        var r = n.attr(o, e);
                        return null == r ? "!=" === t : t ? (r += "",
                        "=" === t ? r === i : "!=" === t ? r !== i : "^=" === t ? i && 0 === r.indexOf(i) : "*=" === t ? i && r.indexOf(i) > -1 : "$=" === t ? i && r.slice(-i.length) === i : "~=" === t ? (" " + r + " ").indexOf(i) > -1 : "|=" === t ? r === i || r.slice(0, i.length + 1) === i + "-" : !1) : !0
                    }
                },
                CHILD: function(e, t, n, i, o) {
                    ...
                    : function(t, n, l) {
                        var c, d, u, p, h, f, g = r !== a ? "nextSibling" : "previousSibling", m = t.parentNode, v = s && t.nodeName.toLowerCase(), y = !l && !s;
                        if (m) {
                            if (r) {
                                for (; g; ) {
                                    for (u = t; u = u[g]; )
                            ...
                            a && y) {
                                ...
                                h = c[0] === z && c[1],
                                p = c[0] === z && c[2],
                                u = h && m.childNodes[h]; u = ++h && u && u[g] || (p = h = 0) || f.pop(); )
                                    if (1 === u.nodeType && ++p && u === t) {
                                        d[e] = [z, h, p];
                                        break
                                    }
                            } else if (y && (c = (t[O] || (t[O] = {}))[e]) && c[0] === z)
                                p = c[1];
                            else
                                for (; (u = ++h && u && u[g] || (p = h = 0) || f.pop()) && ((s ? u.nodeName.toLowerCase() !== v : 1 !== u.nodeType) || !++p || (y && ((u[O] || (u[O] = {}))[e] = [z, p]),
                                u !== t)); )
                                    ;
                            return p -= o,
                            p === i || 0 === p % i && p / i >= 0
                ...
                PSEUDO: function(e, t) {
                    ...
                    return r[O] ? r(t) : r.length > 1 ? (i = [e, e, "", t],
                    k.setFilters.hasOwnProperty(e.toLowerCase()) ? o(function(e, n) {
        ...
        ,
        _.sortStable = O.split("").sort(J).join("") === O,
        ...
        dt.unique = n.uniqueSort,
        dt.text = n.getText,
        dt.isXMLDoc = n.isXML,
        dt.contains = n.contains
    }(e);
    var kt = {};
    dt.Callbacks = function(e) {
        e = "string" == typeof e ? kt[e] || i(e) : dt.extend({}, e);
        var n, o, r, a, s, l, c = [], d = !e.once && [], u = function(t) {
            for (o = e.memory && t,
            r = !0,
            s = l || 0,
            l = 0,
            ...
            remove: function() {
                return c && dt.each(arguments, function(e, t) {
                    for (var i; (i = dt.inArray(t, c, i)) > -1; )
                        c.splice(i, 1),
                        n && (a >= i && a--,
                        s >= i && s--)
                }),
    ...
    dt.extend({
        Deferred: function(e) {
            var t = [["resolve", "done", dt.Callbacks("once memory"), "resolved"], ["reject", "fail", dt.Callbacks("once memory"), "rejected"], ["notify", "progress", dt.Callbacks("memory")]]
              , n = "pending"
              , i = {
                state: function() {
                    return n
                    ...
                    return dt.Deferred(function(n) {
                        dt.each(t, function(t, r) {
                            ...
                            o[r[1]](function() {
                                ...
                                e && dt.isFunction(e.promise) ? e.promise().done(n.resolve).fail(n.reject).progress(n.notify) : n[a + "With"](this === i ? n.promise() : this, s ? [e] : arguments)
                            })
                        }),
                        e = null
                    }).promise()
        ...
        when: function(e) {
            var t, n, i, o = 0, r = rt.call(arguments), a = r.length, s = 1 !== a || e && dt.isFunction(e.promise) ? a : 0, l = 1 === s ? e : dt.Deferred(), c = function(e, n, i) {
                return function(o) {
                    n[e] = this,
            ...
            if (a > 1)
                ...
                n = Array(a),
                i = Array(a); a > o; o++)
                    r[o] && dt.isFunction(r[o].promise) ? r[o].promise().done(c(o, i, r)).fail(l.reject).progress(c(o, n, t)) : --s;
    ...
    dt.support = function(t) {
        ...
        s = r.appendChild(X.createElement("option")),
        ...
        t.html5Clone = "<:nav></:nav>" !== X.createElement("nav").cloneNode(!0).outerHTML,
        ...
        for (d in dt(t))
            break;
        return t.ownLast = "0" !== d,
        dt(function() {
            var n, i, o, r = "padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;", a = X.getElementsByTagName("body")[0];
            a && (n = X.createElement("div"),
            n.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px",
            a.appendChild(n).appendChild(u),
            ...
            i = u.appendChild(X.createElement("div")),
    ...
    dt.extend({
        ...
        hasData: function(e) {
            return e = e.nodeType ? dt.cache[e[dt.expando]] : e[dt.expando],
            !!e && !s(e)
        },
        data: function(e, t, n) {
            return o(e, t, n)
    ...
    dt.fn.extend({
        data: function(e, n) {
            var i, o, r = null, s = 0, l = this[0];
            if (e === t) {
                if (this.length && (r = dt.data(l),
                1 === l.nodeType && !dt._data(l, "parsedAttrs"))) {
                    for (i = l.attributes; i.length > s; s++)
                        o = i[s].name,
                        0 === o.indexOf("data-") && (o = dt.camelCase(o.slice(5)),
                        a(l, o, r[o]));
    ...
    dt.extend({
        queue: function(e, n, i) {
            ...
            o = dt._data(e, n),
            i && (!o || dt.isArray(i) ? o = dt._data(e, n, dt.makeArray(i)) : o.push(i)),
            o || []) : t
        },
    ...
    dt.fn.extend({
        queue: function(e, n) {
            ...
            e = "fx",
            i--),
            i > arguments.length ? dt.queue(this[0], e) : n === t ? this : this.each(function() {
        ...
        promise: function(e, n) {
            var i, o = 1, r = dt.Deferred(), a = this, s = this.length, l = function() {
                --o || r.resolveWith(a, [a])
            };
            for ("string" != typeof e && (n = e,
            e = t),
            e = e || "fx"; s--; )
                i = dt._data(a[s], e + "queueHooks"),
                i && i.empty && (o++,
                i.empty.add(l));
            return l(),
            r.promise(n)
    ...
    var St, jt, At = /[\t\r\n\f]/g, Mt = /\r/g, It = /^(?:input|select|textarea|button|object)$/i, Nt = /^(?:a|area)$/i, Dt = /^(?:checked|selected)$/i, Bt = dt.support.getSetAttribute, Lt = dt.support.input;
    dt.fn.extend({
        attr: function(e, t) {
        ...
        toggleClass: function(e, t) {
            var n = typeof e;
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : dt.isFunction(e) ? this.each(function(n) {
                dt(this).toggleClass(e.call(this, n, this.className, t), t)
            }) : this.each(function() {
                if ("string" === n)
                    for (var t, i = 0, o = dt(this), r = e.match(pt) || []; t = r[i++]; )
                        o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                else
                    (n === G || "boolean" === n) && (this.className && dt._data(this, "__className__", this.className),
                    this.className = this.className || e === !1 ? "" : dt._data(this, "__className__") || "")
            })
        },
        hasClass: function(e) {
        ...
        val: function(e) {
            var n, i, o, r = this[0];
            return arguments.length ? (o = dt.isFunction(e),
            this.each(function(n) {
                var r;
                1 === this.nodeType && (r = o ? e.call(this, n, dt(this).val()) : e,
                null == r ? r = "" : "number" == typeof r ? r += "" : dt.isArray(r) && (r = dt.map(r, function(e) {
                    return null == e ? "" : e + ""
                })),
                i = dt.valHooks[this.type] || dt.valHooks[this.nodeName.toLowerCase()],
                i && "set"in i && i.set(this, r, "value") !== t || (this.value = r))
            })) : r ? (i = dt.valHooks[r.type] || dt.valHooks[r.nodeName.toLowerCase()],
            i && "get"in i && (n = i.get(r, "value")) !== t ? n : (n = r.value,
            "string" == typeof n ? n.replace(Mt, "") : null == n ? "" : n)) : void 0
        }
    }),
    dt.extend({
        valHooks: {
            ...
            select: {
                get: function(e) {
                    for (var t, n, i = e.options, o = e.selectedIndex, r = "select-one" === e.type || 0 > o, a = r ? null : [], s = r ? o + 1 : i.length, l = 0 > o ? s : r ? o : 0; s > l; l++)
                        if (n = i[l],
                        !(!n.selected && l !== o || (dt.support.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && dt.nodeName(n.parentNode, "optgroup"))) {
                            if (t = dt(n).val(),
                            r)
                                return t;
                            a.push(t)
                ...
                set: function(e, t) {
                    for (var n, i, o = e.options, r = dt.makeArray(t), a = o.length; a--; )
                        i = o[a],
                        (i.selected = dt.inArray(dt(i).val(), r) >= 0) && (n = !0);
        ...
        attr: function(e, n, i) {
            ...
            return e && 3 !== a && 8 !== a && 2 !== a ? typeof e.getAttribute === G ? dt.prop(e, n, i) : (1 === a && dt.isXMLDoc(e) || (n = n.toLowerCase(),
            o = dt.attrHooks[n] || (dt.expr.match.bool.test(n) ? jt : St)),
            i === t ? o && "get"in o && null !== (r = o.get(e, n)) ? r : (r = dt.find.attr(e, n),
            null == r ? t : r) : null !== i ? o && "set"in o && (r = o.set(e, i, n)) !== t ? r : (e.setAttribute(n, i + ""),
            i) : (dt.removeAttr(e, n),
            t)) : void 0
        },
        removeAttr: function(e, t) {
            var n, i, o = 0, r = t && t.match(pt);
            if (r && 1 === e.nodeType)
                for (; n = r[o++]; )
                    i = dt.propFix[n] || n,
                    dt.expr.match.bool.test(n) ? Lt && Bt || !Dt.test(n) ? e[i] = !1 : e[dt.camelCase("default-" + n)] = e[i] = !1 : dt.attr(e, n, ""),
        ...
        prop: function(e, n, i) {
            ...
            return e && 3 !== s && 8 !== s && 2 !== s ? (a = 1 !== s || !dt.isXMLDoc(e),
            a && (n = dt.propFix[n] || n,
            r = dt.propHooks[n]),
            i !== t ? r && "set"in r && (o = r.set(e, i, n)) !== t ? o : e[n] = i : r && "get"in r && null !== (o = r.get(e, n)) ? o : e[n]) : void 0
        },
        propHooks: {
            tabIndex: {
                get: function(e) {
    ...
    jt = {
        set: function(e, t, n) {
            return t === !1 ? dt.removeAttr(e, n) : Lt && Bt || !Dt.test(n) ? e.setAttribute(!Bt && dt.propFix[n] || n, n) : e[dt.camelCase("default-" + n)] = e[n] = !0,
            n
        }
    },
    dt.each(dt.expr.match.bool.source.match(/\w+/g), function(e, n) {
        var i = dt.expr.attrHandle[n] || dt.find.attr;
        dt.expr.attrHandle[n] = Lt && Bt || !Dt.test(n) ? function(e, n, o) {
            var r = dt.expr.attrHandle[n]
              , a = o ? t : (dt.expr.attrHandle[n] = t) != i(e, n, o) ? n.toLowerCase() : null;
            return dt.expr.attrHandle[n] = r,
            a
        }
        : function(e, n, i) {
    ...
    Lt && Bt || (dt.attrHooks.value = {
        set: function(e, n, i) {
            return dt.nodeName(e, "input") ? (e.defaultValue = n,
            t) : St && St.set(e, n, i)
        }
    }),
    Bt || (St = {
    ...
    dt.event = {
        ...
        add: function(e, n, i, o, r) {
            ...
            if (v) {
                ...
                (u = v.handle) || (u = v.handle = function(e) {
                    return typeof dt === G || e && dt.event.triggered === e.type ? t : dt.event.dispatch.apply(u.elem, arguments)
                }
                ,
                u.elem = e),
                n = (n || "").match(pt) || [""],
                l = n.length; l--; )
                    ...
                    (h = s[f]) || (h = s[f] = [],
                    h.delegateCount = 0,
                    d.setup && d.setup.call(e, o, g, u) !== !1 || (e.addEventListener ? e.addEventListener(f, u, !1) : e.attachEvent && e.attachEvent("on" + f, u))),
                    d.add && (d.add.call(e, p),
                    p.handler.guid || (p.handler.guid = i.guid)),
                    r ? h.splice(h.delegateCount++, 0, p) : h.push(p),
                    dt.event.global[f] = !0);
                e = null
            }
        },
            ...
            if (m && (d = m.events)) {
                ...
                c = t.length; c--; )
                    ...
                    h) {
                        ...
                        l && !p.length && (u.teardown && u.teardown.call(e, f, m.handle) !== !1 || dt.removeEvent(e, h, m.handle),
                        delete d[h])
                    } else
                        for (h in d)
                            dt.event.remove(e, h + t[c], n, i, !0);
                dt.isEmptyObject(d) && (delete m.handle,
                dt._removeData(e, "events"))
            }
        },
        trigger: function(n, i, o, r) {
            var a, s, l, c, d, u, p, h = [o || X], f = lt.call(n, "type") ? n.type : n, g = lt.call(n, "namespace") ? n.namespace.split(".") : [];
            if (l = u = o = o || X,
            3 !== o.nodeType && 8 !== o.nodeType && !Vt.test(f + dt.event.triggered) && (f.indexOf(".") >= 0 && (g = f.split("."),
            f = g.shift(),
            g.sort()),
            s = 0 > f.indexOf(":") && "on" + f,
            n = n[dt.expando] ? n : new dt.Event(f,"object" == typeof n && n),
            n.isTrigger = r ? 2 : 3,
            n.namespace = g.join("."),
            n.namespace_re = n.namespace ? RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null,
            n.result = t,
            n.target || (n.target = o),
            i = null == i ? [n] : dt.makeArray(i, [n]),
            d = dt.event.special[f] || {},
            r || !d.trigger || d.trigger.apply(o, i) !== !1)) {
                if (!r && !d.noBubble && !dt.isWindow(o)) {
                    for (c = d.delegateType || f,
                    Vt.test(c + f) || (l = l.parentNode); l; l = l.parentNode)
                        h.push(l),
                        u = l;
                    u === (o.ownerDocument || X) && h.push(u.defaultView || u.parentWindow || e)
                }
                for (p = 0; (l = h[p++]) && !n.isPropagationStopped(); )
                    n.type = p > 1 ? c : d.bindType || f,
                    a = (dt._data(l, "events") || {})[n.type] && dt._data(l, "handle"),
                    a && a.apply(l, i),
                    a = s && l[s],
                    a && dt.acceptData(l) && a.apply && a.apply(l, i) === !1 && n.preventDefault();
                if (n.type = f,
                !r && !n.isDefaultPrevented() && (!d._default || d._default.apply(h.pop(), i) === !1) && dt.acceptData(o) && s && o[f] && !dt.isWindow(o)) {
                    u = o[s],
                    u && (o[s] = null),
        ...
        dispatch: function(e) {
            e = dt.event.fix(e);
            var n, i, o, r, a, s = [], l = rt.call(arguments), c = (dt._data(this, "events") || {})[e.type] || [], d = dt.event.special[e.type] || {};
            if (l[0] = e,
            e.delegateTarget = this,
            !d.preDispatch || d.preDispatch.call(this, e) !== !1) {
                for (s = dt.event.handlers.call(this, e, c),
                n = 0; (r = s[n++]) && !e.isPropagationStopped(); )
                    for (e.currentTarget = r.elem,
                    a = 0; (o = r.handlers[a++]) && !e.isImmediatePropagationStopped(); )
                        (!e.namespace_re || e.namespace_re.test(o.namespace)) && (e.handleObj = o,
                        e.data = o.data,
                        i = ((dt.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, l),
                ...
                for (; c != this; c = c.parentNode || this)
                    if (1 === c.nodeType && (c.disabled !== !0 || "click" !== e.type)) {
                        ...
                        a = 0; l > a; a++)
                            o = n[a],
                            i = o.selector + " ",
                            r[i] === t && (r[i] = o.needsContext ? dt(i, this).index(c) >= 0 : dt.find(i, this, null, [c]).length),
                            r[i] && r.push(o);
                        r.length && s.push({
                            elem: c,
                            handlers: r
        ...
        fix: function(e) {
            ...
            t = i.length; t--; )
                n = i[t],
                e[n] = r[n];
            return e.target || (e.target = r.srcElement || X),
        ...
        simulate: function(e, t, n, i) {
            ...
            i ? dt.event.trigger(o, null, t) : dt.event.dispatch.call(t, o),
    ...
    dt.each({
        ...
        dt.event.special[e] = {
            ...
            handle: function(e) {
                ...
                return (!o || o !== i && !dt.contains(i, o)) && (e.type = r.origType,
    ...
    dt.support.submitBubbles || (dt.event.special.submit = {
        setup: function() {
            return dt.nodeName(this, "form") ? !1 : (dt.event.add(this, "click._submit keypress._submit", function(e) {
                var n = e.target
                  , i = dt.nodeName(n, "input") || dt.nodeName(n, "button") ? n.form : t;
                i && !dt._data(i, "submitBubbles") && (dt.event.add(i, "submit._submit", function(e) {
                    e._submit_bubble = !0
                }),
        ...
        postDispatch: function(e) {
            ...
            this.parentNode && !e.isTrigger && dt.event.simulate("submit", this.parentNode, e, !0))
        },
        teardown: function() {
            return dt.nodeName(this, "form") ? !1 : (dt.event.remove(this, "._submit"),
            t)
        }
    }),
    dt.support.changeBubbles || (dt.event.special.change = {
        setup: function() {
            return Pt.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (dt.event.add(this, "propertychange._change", function(e) {
                "checked" === e.originalEvent.propertyName && (this._just_changed = !0)
            }),
            dt.event.add(this, "click._change", function(e) {
                this._just_changed && !e.isTrigger && (this._just_changed = !1),
                dt.event.simulate("change", this, e, !0)
            })),
            !1) : (dt.event.add(this, "beforeactivate._change", function(e) {
                var t = e.target;
                Pt.test(t.nodeName) && !dt._data(t, "changeBubbles") && (dt.event.add(t, "change._change", function(e) {
    ...
    dt.fn.extend({
        ...
        off: function(e, n, i) {
            ...
            if (e && e.preventDefault && e.handleObj)
                ...
                dt(e.delegateTarget).off(o.namespace ? o.origType + "." + o.namespace : o.origType, o.selector, o.handler),
                this;
            if ("object" == typeof e) {
                for (r in e)
                    this.off(r, n, e[r]);
    ...
    dt.fn.extend({
        find: function(e) {
            ...
            if ("string" != typeof e)
                return this.pushStack(dt(e).filter(function() {
                    for (t = 0; o > t; t++)
                        if (dt.contains(i[t], this))
                            return !0
                }));
            for (t = 0; o > t; t++)
                dt.find(e, i[t], n);
        ...
        has: function(e) {
            var t, n = dt(e, this), i = n.length;
            return this.filter(function() {
                for (t = 0; i > t; t++)
                    if (dt.contains(this, n[t]))
                        return !0
            })
        },
        not: function(e) {
        ...
        closest: function(e, t) {
            for (var n, i = 0, o = this.length, r = [], a = qt.test(e) || "string" != typeof e ? dt(e, t || this.context) : 0; o > i; i++)
                for (n = this[i]; n && n !== t; n = n.parentNode)
                    if (11 > n.nodeType && (a ? a.index(n) > -1 : 1 === n.nodeType && dt.find.matchesSelector(n, e))) {
                        n = r.push(n);
                        break
                    }
    ...
    dt.each({
        ...
        dt.fn[e] = function(n, i) {
            ...
            this.length > 1 && (Wt[e] || (o = dt.unique(o)),
            Rt.test(e) && (o = o.reverse())),
            this.pushStack(o)
        }
    }),
    dt.extend({
        filter: function(e, t, n) {
            var i = t[0];
            return n && (e = ":not(" + e + ")"),
            1 === t.length && 1 === i.nodeType ? dt.find.matchesSelector(i, e) ? [i] : [] : dt.find.matches(e, dt.grep(t, function(e) {
                return 1 === e.nodeType
            }))
        },
        dir: function(e, n, i) {
    ...
    dt.fn.extend({
        ...
        remove: function(e, t) {
            for (var n, i = e ? dt.filter(e, this) : this, o = 0; null != (n = i[o]); o++)
                t || 1 !== n.nodeType || dt.cleanData(x(n)),
                n.parentNode && (t && dt.contains(n.ownerDocument, n) && v(x(n, "script")),
                n.parentNode.removeChild(n));
            return this
        },
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++) {
                for (1 === e.nodeType && dt.cleanData(x(e, !1)); e.firstChild; )
        ...
        html: function(e) {
            return dt.access(this, function(e) {
                var n = this[0] || {}
                  ...
                  , o = this.length;
                if (e === t)
                    return 1 === n.nodeType ? n.innerHTML.replace(Jt, "") : t;
                if (!("string" != typeof e || en.test(e) || !dt.support.htmlSerialize && Gt.test(e) || !dt.support.leadingWhitespace && Qt.test(e) || sn[(Kt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Xt, "<$1></$2>");
                    try {
                        for (; o > i; i++)
                            n = this[i] || {},
                            1 === n.nodeType && (dt.cleanData(x(n, !1)),
                            n.innerHTML = e);
                        n = 0
                    } catch (r) {}
                }
        ...
        replaceWith: function() {
            ...
            return this.domManip(arguments, function(n) {
                var i = e[t++]
                  , o = e[t++];
                o && (i && i.parentNode !== o && (i = this.nextSibling),
                dt(this).remove(),
                o.insertBefore(n, i))
            }, !0),
            t ? this : this.remove()
        ...
        domManip: function(e, t, n) {
            e = it.apply([], e);
            var i, o, r, a, s, l, c = 0, d = this.length, u = this, p = d - 1, h = e[0], f = dt.isFunction(h);
            if (f || !(1 >= d || "string" != typeof h || dt.support.checkClone) && nn.test(h))
                return this.each(function(i) {
                    var o = u.eq(i);
                    f && (e[0] = h.call(this, i, o.html())),
                    o.domManip(e, t, n)
                });
            if (d && (l = dt.buildFragment(e, this[0].ownerDocument, !1, !n && this),
            i = l.firstChild,
            1 === l.childNodes.length && (l = i),
            i)) {
                for (a = dt.map(x(l, "script"), g),
                r = a.length; d > c; c++)
                    o = l,
                    c !== p && (o = dt.clone(o, !0, !0),
                    r && dt.merge(a, x(o, "script"))),
                    t.call(this[c], o, c);
                if (r)
                    ...
                    c = 0; r > c; c++)
                        o = a[c],
                        on.test(o.type || "") && !dt._data(o, "globalEval") && dt.contains(s, o) && (o.src ? dt._evalUrl(o.src) : dt.globalEval((o.text || o.textContent || o.innerHTML || "").replace(an, "")));
                l = i = null
            }
            return this
        }
    ...
    dt.each({
        ...
        dt.fn[e] = function(e) {
            for (var n, i = 0, o = [], r = dt(e), a = r.length - 1; a >= i; i++)
    ...
    dt.extend({
        clone: function(e, t, n) {
            ...
            if (dt.support.html5Clone || dt.isXMLDoc(e) || !Gt.test("<" + e.nodeName + ">") ? r = e.cloneNode(!0) : (cn.innerHTML = e.outerHTML,
            cn.removeChild(r = cn.firstChild)),
            !(dt.support.noCloneEvent && dt.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || dt.isXMLDoc(e)))
                for (i = x(r),
                s = x(e),
                a = 0; null != (o = s[a]); ++a)
                    i[a] && b(o, i[a]);
        ...
        buildFragment: function(e, t, n, i) {
            for (var o, r, a, s, l, c, d, u = e.length, p = h(t), f = [], g = 0; u > g; g++)
                ...
                r || 0 === r)
                    if ("object" === dt.type(r))
                        ...
                        l = (Kt.exec(r) || ["", ""])[1].toLowerCase(),
                        d = sn[l] || sn._default,
                        s.innerHTML = d[1] + r.replace(Xt, "<$1></$2>") + d[2],
                        o = d[0]; o--; )
                            s = s.lastChild;
            ...
            dt.support.appendChecked || dt.grep(x(f, "input"), $),
            g = 0; r = f[g++]; )
                if ((!i || -1 === dt.inArray(r, i)) && (a = dt.contains(r.ownerDocument, r),
                s = x(p.appendChild(r), "script"),
                a && v(s),
                n))
                    for (o = 0; r = s[o++]; )
                        on.test(r.type || "") && n.push(r);
            return s = null,
            p
        },
        cleanData: function(e, t) {
            for (var n, i, o, r, a = 0, s = dt.expando, l = dt.cache, c = dt.support.deleteExpando, d = dt.event.special; null != (n = e[a]); a++)
                if ((t || dt.acceptData(n)) && (o = n[s],
                r = o && l[o])) {
                    if (r.events)
                        for (i in r.events)
                            d[i] ? dt.event.remove(n, i) : dt.removeEvent(n, i, r.handle);
                    l[o] && (delete l[o],
                    c ? delete n[s] : typeof n.removeAttribute !== G ? n.removeAttribute(s) : n[s] = null,
                    tt.push(o))
                }
        },
        _evalUrl: function(e) {
    ...
    var dn, un, pn, hn = /alpha\([^)]*\)/i, fn = /opacity\s*=\s*([^)]*)/, gn = /^(top|right|bottom|left)$/, mn = /^(none|table(?!-c[ea]).+)/, vn = /^margin/, yn = RegExp("^(" + ut + ")(.*)$", "i"), bn = RegExp("^(" + ut + ")(?!px)[a-z%]+$", "i"), xn = RegExp("^([+-])=(" + ut + ")", "i"), $n = {
        BODY: "block"
    }, wn = {
        position: "absolute",
        visibility: "hidden",
    ...
    dt.extend({
        ...
        style: function(e, n, i, o) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, a, s, l = dt.camelCase(n), c = e.style;
                if (n = dt.cssProps[l] || (dt.cssProps[l] = w(c, l)),
                s = dt.cssHooks[n] || dt.cssHooks[l],
                i === t)
                    return s && "get"in s && (r = s.get(e, !1, o)) !== t ? r : c[n];
                if (a = typeof i,
                "string" === a && (r = xn.exec(i)) && (i = (r[1] + 1) * r[2] + parseFloat(dt.css(e, n)),
                a = "number"),
                !(null == i || "number" === a && isNaN(i) || ("number" !== a || dt.cssNumber[l] || (i += "px"),
                dt.support.clearCloneStyle || "" !== i || 0 !== n.indexOf("background") || (c[n] = "inherit"),
                s && "set"in s && (i = s.set(e, i, o)) === t)))
                    try {
                        c[n] = i
                    } catch (d) {}
            }
        ...
        css: function(e, n, i, o) {
            ...
            return n = dt.cssProps[l] || (dt.cssProps[l] = w(e.style, l)),
            s = dt.cssHooks[n] || dt.cssHooks[l],
            s && "get"in s && (a = s.get(e, !0, i)),
            a === t && (a = pn(e, n, o)),
            "normal" === a && n in _n && (a = _n[n]),
            "" === i || i ? (r = parseFloat(a),
            i === !0 || dt.isNumeric(r) ? r || 0 : a) : a
        }
    }),
    ...
    ,
    pn = function(e, n, i) {
        var o, r, a, s = i || un(e), l = s ? s.getPropertyValue(n) || s[n] : t, c = e.style;
        return s && ("" !== l || dt.contains(e.ownerDocument, e) || (l = dt.style(e, n)),
        bn.test(l) && vn.test(n) && (o = c.width,
        r = c.minWidth,
        a = c.maxWidth,
    ...
    ,
    pn = function(e, n, i) {
        var o, r, a, s = i || un(e), l = s ? s[n] : t, c = e.style;
        return null == l && c && c[n] && (l = c[n]),
        bn.test(l) && !gn.test(n) && (o = c.left,
        r = e.runtimeStyle,
        a = r && r.left,
    ...
    dt.each(["height", "width"], function(e, n) {
        dt.cssHooks[n] = {
            get: function(e, i, o) {
                return i ? 0 === e.offsetWidth && mn.test(dt.css(e, "display")) ? dt.swap(e, wn, function() {
                    return T(e, n, o)
                }) : T(e, n, o) : t
            },
            set: function(e, t, i) {
                var o = i && un(e);
                return k(e, t, i ? E(e, n, i, dt.support.boxSizing && "border-box" === dt.css(e, "boxSizing", !1, o), o) : 0)
            }
        }
    }),
    dt.support.opacity || (dt.cssHooks.opacity = {
        ...
        set: function(e, t) {
            ...
            n.zoom = 1,
            (t >= 1 || "" === t) && "" === dt.trim(r.replace(hn, "")) && n.removeAttribute && (n.removeAttribute("filter"),
            "" === t || i && !i.filter) || (n.filter = hn.test(r) ? r.replace(hn, o) : r + " " + o)
        }
    }),
    dt(function() {
        ...
        !dt.support.pixelPosition && dt.fn.position && dt.each(["top", "left"], function(e, n) {
            dt.cssHooks[n] = {
                get: function(e, i) {
                    return i ? (i = pn(e, n),
                    bn.test(i) ? dt(e).position()[n] + "px" : i) : t
                }
            }
        })
    }),
    dt.expr && dt.expr.filters && (dt.expr.filters.hidden = function(e) {
        return 0 >= e.offsetWidth && 0 >= e.offsetHeight || !dt.support.reliableHiddenOffsets && "none" === (e.style && e.style.display || dt.css(e, "display"))
    }
    ,
    ...
    dt.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !dt(this).is(":disabled") && An.test(this.nodeName) && !jn.test(e) && (this.checked || !tn.test(e))
            }).map(function(e, t) {
                var n = dt(this).val();
    ...
    dt.param = function(e, n) {
        var i, o = [], r = function(e, t) {
            t = dt.isFunction(t) ? t() : null == t ? "" : t,
            o[o.length] = encodeURIComponent(e) + "=" + encodeURIComponent(t)
        };
        if (n === t && (n = dt.ajaxSettings && dt.ajaxSettings.traditional),
        dt.isArray(e) || e.jquery && !dt.isPlainObject(e))
            dt.each(e, function() {
    ...
    var Mn, In, Nn = dt.now(), Dn = /\?/, Bn = /#.*$/, Ln = /([?&])_=[^&]*/, Pn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Hn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, On = /^(?:GET|HEAD)$/, Vn = /^\/\//, zn = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, Fn = dt.fn.load, Rn = {}, qn = {}, Wn = "*/".concat("*");
    try {
        In = Q.href
    } catch (Un) {
        In = X.createElement("a"),
        In.href = "",
        In = In.href
    }
    Mn = zn.exec(In.toLowerCase()) || [],
    dt.fn.load = function(e, n, i) {
        ...
        s.length > 0 && dt.ajax({
            ...
            r = arguments,
            s.html(o ? dt("<div>").append(dt.parseHTML(e)).find(o) : e)
    ...
    dt.extend({
        ...
        ajax: function(e, n) {
            function i(e, n, i, o) {
                ...
                i && (b = D(p, w, i)),
                b = B(p, b, w, r),
                r ? (p.ifModified && ($ = w.getResponseHeader("Last-Modified"),
                $ && (dt.lastModified[a] = $),
                $ = w.getResponseHeader("etag"),
                $ && (dt.etag[a] = $)),
                204 === e || "HEAD" === p.type ? _ = "nocontent" : 304 === e ? _ = "notmodified" : (_ = b.state,
                u = b.data,
                y = b.error,
                r = !y)) : (y = _,
                (e || !_) && (_ = "error",
                ...
                w.status = e,
                w.statusText = (n || _) + "",
                r ? g.resolveWith(h, [u, _, w]) : g.rejectWith(h, [w, _, y]),
                w.statusCode(v),
                v = t,
                c && f.trigger(r ? "ajaxSuccess" : "ajaxError", [w, p, r ? u : y]),
                m.fireWith(h, [w, _]),
                c && (f.trigger("ajaxComplete", [w, p]),
                --dt.active || dt.event.trigger("ajaxStop")))
            }
            "object" == typeof e && (n = e,
            e = t),
            n = n || {};
            var o, r, a, s, l, c, d, u, p = dt.ajaxSetup({}, n), h = p.context || p, f = p.context && (h.nodeType || h.jquery) ? dt(h) : dt.event, g = dt.Deferred(), m = dt.Callbacks("once memory"), v = p.statusCode || {}, y = {}, b = {}, x = 0, $ = "canceled", w = {
                readyState: 0,
            ...
            w.success = w.done,
            w.error = w.fail,
            p.url = ((e || p.url || In) + "").replace(Bn, "").replace(Vn, Mn[1] + "//"),
            p.type = n.method || n.type || p.method || p.type,
            p.dataTypes = dt.trim(p.dataType || "*").toLowerCase().match(pt) || [""],
            null == p.crossDomain && (o = zn.exec(p.url.toLowerCase()),
            p.crossDomain = !(!o || o[1] === Mn[1] && o[2] === Mn[2] && (o[3] || ("http:" === o[1] ? "80" : "443")) === (Mn[3] || ("http:" === Mn[1] ? "80" : "443")))),
            p.data && p.processData && "string" != typeof p.data && (p.data = dt.param(p.data, p.traditional)),
            I(Rn, p, n, w),
            2 === x)
                return w;
            c = p.global,
            ...
            a = p.url,
            p.hasContent || (p.data && (a = p.url += (Dn.test(a) ? "&" : "?") + p.data,
            delete p.data),
            p.cache === !1 && (p.url = Ln.test(a) ? a.replace(Ln, "$1_=" + Nn++) : a + (Dn.test(a) ? "&" : "?") + "_=" + Nn++)),
            p.ifModified && (dt.lastModified[a] && w.setRequestHeader("If-Modified-Since", dt.lastModified[a]),
            dt.etag[a] && w.setRequestHeader("If-None-Match", dt.etag[a])),
    ...
    dt.ajaxPrefilter("json jsonp", function(n, i, o) {
        ...
        return l || "jsonp" === n.dataTypes[0] ? (r = n.jsonpCallback = dt.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback,
        l ? n[l] = n[l].replace(Gn, "$1" + r) : n.jsonp !== !1 && (n.url += (Dn.test(n.url) ? "&" : "?") + n.jsonp + "=" + r),
        ...
        o.always(function() {
            ...
            Jn.push(r)),
            s && dt.isFunction(a) && a(s[0]),
            s = a = t
        }),
        "script") : t
    });
    var Qn, Xn, Kn = 0, Yn = e.ActiveXObject && function() {
        var e;
        for (e in Qn)
            Qn[e](t, !0)
    }
    ...
    : L,
    Xn = dt.ajaxSettings.xhr(),
    dt.support.cors = !!Xn && "withCredentials"in Xn,
    Xn = dt.support.ajax = !!Xn,
    Xn && dt.ajaxTransport(function(n) {
        if (!n.crossDomain || dt.support.cors) {
            ...
            return {
                send: function(o, r) {
                    ...
                    ,
                    n.async ? 4 === l.readyState ? setTimeout(i) : (a = ++Kn,
                    Yn && (Qn || (Qn = {},
                    dt(e).unload(Yn)),
                    Qn[a] = i),
    ...
    var Zn, ei, ti = /^(?:toggle|show|hide)$/, ni = RegExp("^(?:([+-])=|)(" + ut + ")([a-z%]*)$", "i"), ii = /queueHooks$/, oi = [F], ri = {
        "*": [function(e, t) {
    ...
    R.prototype = {
        ...
        run: function(e) {
            ...
            return this.pos = t = this.options.duration ? dt.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e,
    ...
    R.propHooks = {
        _default: {
            get: function(e) {
                var t;
                return null == e.elem[e.prop] || e.elem.style && null != e.elem.style[e.prop] ? (t = dt.css(e.elem, e.prop, ""),
    ...
    dt.fn.extend({
        ...
        finish: function(e) {
            return e !== !1 && (e = e || "fx"),
            this.each(function() {
                var t, n = dt._data(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = dt.timers, a = i ? i.length : 0;
                for (n.finish = !0,
                dt.queue(this, e, []),
    ...
    dt.fx.tick = function() {
        var e, n = dt.timers, i = 0;
        for (Zn = dt.now(); n.length > i; i++)
            e = n[i],
    ...
    dt.fn.offset = function(e) {
        ...
        dt.contains(n, r) ? (typeof r.getBoundingClientRect !== G && (o = r.getBoundingClientRect()),
        i = W(a),
        {
    ...
    dt.offset = {
        setOffset: function(e, t, n) {
            ...
            var o, r, a = dt(e), s = a.offset(), l = dt.css(e, "top"), c = dt.css(e, "left"), d = ("absolute" === i || "fixed" === i) && dt.inArray("auto", [l, c]) > -1, u = {}, p = {};
            d ? (p = a.position(),
            o = p.top,
            r = p.left) : (o = parseFloat(l) || 0,
            r = parseFloat(c) || 0),
            dt.isFunction(t) && (t = t.call(e, n, s)),
    ...
    dt.fn.extend({
        position: function() {
            if (this[0]) {
                ...
                t = this.offset(),
                dt.nodeName(e[0], "html") || (n = e.offset()),
                n.top += dt.css(e[0], "borderTopWidth", !0),
                n.left += dt.css(e[0], "borderLeftWidth", !0)),
                {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || K; e && !dt.nodeName(e, "html") && "static" === dt.css(e, "position"); )
                    e = e.offsetParent;
                return e || K
            })
        }
    ...
    dt.each({
        ...
        dt.fn[e] = function(o) {
            return dt.access(this, function(e, o, r) {
                var a = W(e);
                return r === t ? a ? n in a ? a[n] : a.document.documentElement[o] : e[o] : (a ? a.scrollTo(i ? dt(a).scrollLeft() : r, i ? r : dt(a).scrollTop()) : e[o] = r,
                t)
        ...
        dt.each({
            ...
            dt.fn[o] = function(o, r) {
                ...
                return dt.access(this, function(n, i, o) {
                    var r;
                    return dt.isWindow(n) ? n.document.documentElement["client" + e] : 9 === n.nodeType ? (r = n.documentElement,
                    Math.max(n.body["scroll" + e], r["scroll" + e], n.body["offset" + e], r["offset" + e], r["client" + e])) : o === t ? dt.css(n, i, s) : dt.style(n, i, o, s)
                }, n, a ? o : t, a, null)
            }
        })
    }),
    ...
    "object" == typeof module && module && "object" == typeof module.exports ? module.exports = dt : (e.jQuery = e.$ = dt,
...
function(e, t, n) {
    ...
    e.zui({
        ...
        clientLang: function() {
            var n, i = t.config;
            if ("undefined" != typeof i && i.clientLang && (n = i.clientLang),
            !n) {
    ...
    e.fn.callEvent = function(t, i, o) {
        var r = e(this)
          ...
          , l = e.Event(s, i);
        if (o === n && a > 0 && (o = r.data(t.substring(a + 1))),
        o && o.options) {
            var c = o.options[s];
    ...
    e.fn.button = function(n) {
        return this.each(function() {
            var i = e(this)
              , o = i.data("zui.button")
              , r = "object" == typeof n && n;
            o || i.data("zui.button", o = new t(this,r)),
...
+function(e) {
    ...
    i.prototype.close = function(t) {
        ...
        a.trigger(t = e.Event("close." + n)),
        t.isDefaultPrevented() || (a.removeClass("in"),
        e.support.transition && a.hasClass("fade") ? a.one(e.support.transition.end, i).emulateTransitionEnd(150) : i())
    }
    ;
    var o = e.fn.alert;
    e.fn.alert = function(t) {
        return this.each(function() {
            var o = e(this)
              , r = o.data(n);
            r || o.data(n, r = new i(this)),
            "string" == typeof t && r[t].call(o)
        })
    }
    ,
...
function(e, t) {
    ...
    var n = "zui.pager"
      ...
      , r = function(t, i) {
        ...
        a.name = n,
        a.$ = e(t),
        i = a.options = e.extend({}, r.DEFAULTS, this.$.data(), i);
        var s = i.lang || e.zui.clientLang();
        a.lang = e.isPlainObject(s) ? e.extend(!0, {}, o[s.lang || e.zui.clientLang()], s) : o[s],
        a.state = {},
        a.set(i.page, i.recTotal, i.recPerPage, !0),
        a.$.on("click", ".pager-goto-btn", function() {
    ...
    r.prototype.set = function(t, n, o, r) {
        var a = this;
        "object" == typeof t && null !== t && (o = t.recPerPage,
        n = t.recTotal,
        t = t.page);
        var s = a.state;
        s || (s = e.extend({}, i));
        var l = e.extend({}, s);
        return "number" == typeof o && o > 0 && (s.recPerPage = o),
        "number" == typeof n && n >= 0 && (s.recTotal = n),
        "number" == typeof t && t >= 0 && (s.page = t),
        s.totalPage = s.recTotal && s.recPerPage ? Math.ceil(s.recTotal / s.recPerPage) : 1,
        s.page = Math.max(0, Math.min(s.page, s.totalPage)),
        s.pageRecCount = s.recTotal,
        s.page && s.recTotal && (s.page < s.totalPage ? s.pageRecCount = s.recPerPage : s.page > 1 && (s.pageRecCount = s.recTotal - s.recPerPage * (s.page - 1))),
        s.skip = s.page > 1 ? (s.page - 1) * s.recPerPage : 0,
        s.start = s.skip + 1,
        s.end = s.skip + s.pageRecCount,
        s.prev = s.page > 1 ? s.page - 1 : 0,
        s.next = s.page < s.totalPage ? s.page + 1 : 0,
        a.state = s,
        r || l.page === s.page && l.recTotal === s.recTotal && l.recPerPage === s.recPerPage || a.$.callComEvent(a, "onPageChange", [s, l]),
        a.render()
    }
    ,
    r.prototype.createLinkItem = function(n, i, o) {
        var r = this;
        i === t && (i = n);
        var a = e('<a title="' + r.lang.pageOfText.format(n) + '" class="pager-item" data-page="' + n + '"/>').attr("href", n ? r.createLink(n, r.state) : "###").html(i);
        return o || (a = e("<li />").append(a).toggleClass("active", n === r.state.page).toggleClass("disabled", !n || n === r.state.page)),
        a
    }
    ,
    r.prototype.createNavItems = function(e) {
        var n = this
          ...
          , s = function(e, o) {
            if (e === !1)
                return i.append(n.createLinkItem(0, o || n.options.navEllipsisItem)),
                void 0;
            o === t && (o = e);
            for (var r = e; o >= r; ++r)
                i.append(n.createLinkItem(r))
        };
        e === t && (e = n.options.maxNavCount || 10),
        s(1),
        r > 1 && (e >= r ? s(2, r) : e - 2 > a ? (s(2, e - 2),
        s(!1),
        s(r)) : a > r - e + 2 ? (s(!1),
        s(r - e + 2, r)) : (s(!1),
        s(a - Math.ceil((e - 4) / 2), a + Math.floor((e - 4) / 2)),
        s(!1),
        s(r)))
    }
    ,
    r.prototype.createGoto = function() {
        var t = this
          , n = this.state
          , i = e('<div class="input-group pager-goto" style="width: ' + (35 + 9 * (n.page + "").length + 25 + 12 * t.lang.goto.length) + 'px"><input value="' + n.page + '" type="number" min="1" max="' + n.totalPage + '" placeholder="' + n.page + '" class="form-control pager-goto-input"><span class="input-group-btn"><button class="btn pager-goto-btn" type="button">' + t.lang.goto + "</button></span></div>");
        return i
    }
    ,
    r.prototype.createSizeMenu = function() {
        ...
        return e('<div class="btn-group pager-size-menu"><button type="button" class="btn dropdown-toggle" data-toggle="dropdown">' + t.lang.pageSize.format(n) + ' <span class="caret"></span></button></div>').addClass(t.options.menuDirection).append(i)
    }
    ,
    ...
    r.prototype.render = function(t) {
        var n = this
          ...
          , r = e.isPlainObject(o);
        t = t || n.elements || n.options.elements,
        ...
        for (var a = 0; a < t.length; ++a) {
            var s = e.trim(t[a])
              , l = r ? o[s] || o : o
              , c = l.call(n, s, n.$, i);
            c === !1 && (c = n.createElement(s, n.$, i)),
            c instanceof e && ("LI" !== c[0].tagName && (c = e("<li/>").append(c)),
            n.$.append(c))
        }
        var d = null;
        return n.$.children("li").each(function() {
            ...
            d ? d.toggleClass("pager-item-right", !n) : n && t.addClass("pager-item-left"),
            d = n ? t : null
        }),
        d && d.addClass("pager-item-right"),
        n.$.callComEvent(n, "onRender", [i]),
        n
    }
    ,
    r.DEFAULTS = e.extend({
    ...
    e.fn.pager = function(t) {
        return this.each(function() {
            var i = e(this)
              , o = i.data(n)
              , a = "object" == typeof t && t;
            o || i.data(n, o = new r(this,a)),
            "string" == typeof t && o[t]()
        })
    }
    ,
    r.NAME = n,
    e.fn.pager.Constructor = r,
    e(function() {
...
+function(e) {
    ...
    n.prototype.show = function() {
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            !n.isDefaultPrevented()) {
                ...
                this.$element.one(e.support.transition.end, e.proxy(a, this)).emulateTransitionEnd(350)[r](this.$element[0][s])
            }
        }
    }
    ,
    n.prototype.hide = function() {
        if (!this.transitioning && this.$element.hasClass("in")) {
            ...
            !n.isDefaultPrevented()) {
                ...
                var o = function() {
                    this.transitioning = 0,
                    this.$element.trigger("hidden." + t).removeClass("collapsing").addClass("collapse")
                };
                return e.support.transition ? (this.$element[i](0).one(e.support.transition.end, e.proxy(o, this)).emulateTransitionEnd(350),
                void 0) : o.call(this)
            }
        }
    }
    ...
    e(document).on("click." + t + ".data-api", "[data-toggle=collapse]", function(n) {
        var i, o = e(this), r = o.attr("data-target") || n.preventDefault() || (i = o.attr("href")) && i.replace(/.*(?=#[^\s]+$)/, ""), a = e(r), s = a.data(t), l = s ? "toggle" : o.data(), c = o.attr("data-parent"), d = c && e(c);
        s && s.transitioning || (d && d.find('[data-toggle=collapse][data-parent="' + c + '"]').not(o).addClass("collapsed"),
...
function(e, t) {
    ...
    var n = 1200
      ...
      , a = function() {
        var e = r.width();
        t("html").toggleClass("screen-desktop", e >= i && n > e).toggleClass("screen-desktop-wide", e >= n).toggleClass("screen-tablet", e >= o && i > e).toggleClass("screen-phone", o > e).toggleClass("device-mobile", i > e).toggleClass("device-desktop", e >= i)
    }
      , s = ""
      , l = navigator.userAgent;
    l.match(/(iPad|iPhone|iPod)/i) ? s += " os-ios" : l.match(/android/i) ? s += " os-android" : l.match(/Win/i) ? s += " os-windows" : l.match(/Mac/i) ? s += " os-mac" : l.match(/Linux/i) ? s += " os-linux" : l.match(/X11/i) && (s += " os-unix"),
    "ontouchstart"in document.documentElement && (s += " is-touchable"),
    t("html").addClass(s),
    r.resize(a),
    a()
}(window, jQuery),
function(e) {
    ...
    n.prototype.cssHelper = function() {
        var t = this.ie
          , n = e("html");
        n.toggleClass("ie", t).removeClass("ie-6 ie-7 ie-8 ie-9 ie-10"),
        t && n.addClass("ie-" + t).toggleClass("gt-ie-7 gte-ie-8 support-ie", t >= 8).toggleClass("lte-ie-7 lt-ie-8 outdated-ie", 8 > t).toggleClass("gt-ie-8 gte-ie-9", t >= 9).toggleClass("lte-ie-8 lt-ie-9", 9 > t).toggleClass("gt-ie-9 gte-ie-10", t >= 10).toggleClass("lte-ie-9 lt-ie-10", 10 > t)
    }
    ,
    n.prototype.tip = function(n) {
        var i = e("#browseHappyTip");
        i.length || (i = e('<div id="browseHappyTip" class="alert alert-dismissable alert-danger-inverse alert-block" style="position: relative; z-index: 99999"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><div class="container"><div class="content text-center"></div></div></div>'),
        i.prependTo("body")),
        i.find(".content").html(n || this.browseHappyTip || t[e.zui.clientLang() || "zh_cn"])
    }
    ,
    ...
    e(function() {
        e("body").hasClass("disabled-browser-tip") || e.zui.browser.ie && e.zui.browser.ie < 8 && e.zui.browser.tip()
    })
}(jQuery),
function() {
    "use strict";
    ...
    Date.prototype.addMilliseconds || (Date.prototype.addMilliseconds = function(e) {
        return this.setTime(this.getTime() + e),
        this
    }
    ),
    Date.prototype.addDays || (Date.prototype.addDays = function(e) {
        return this.addMilliseconds(e * Date.ONEDAY_TICKS),
        this
    }
    ),
    Date.prototype.clone || (Date.prototype.clone = function() {
        var e = new Date;
        return e.setTime(this.getTime()),
        e
    }
    ),
    ...
    Date.prototype.getLastWeekday || (Date.prototype.getLastWeekday = function(e) {
        e = e || 1;
        for (var t = this.clone(); t.getDay() != e; )
            t.addDays(-1);
        return t.clearTime(),
        t
    }
    ...
    Date.create || (Date.create = function(e) {
        return e instanceof Date || ("number" == typeof e && 1e10 > e && (e *= 1e3),
        e = new Date(e)),
        e
    }
    ),
    Date.timestamp || (Date.timestamp = function(e) {
        return "number" == typeof e ? 1e10 > e && (e *= 1e3) : e = Date.create(e).getTime(),
        e
    }
    )
}(),
    ...
    String.prototype.format || (String.prototype.format = function(e) {
        ...
        if (arguments.length > 0) {
            ...
            if (arguments.length <= 2 && "object" == typeof e)
                for (var i in e)
                    void 0 !== e[i] && (n = new RegExp("(" + (arguments[1] ? arguments[1].replace("0", i) : "{" + i + "}") + ")","g"),
                    t = t.replace(n, e[i]));
            else
                for (var o = 0; o < arguments.length; o++)
                    void 0 !== arguments[o] && (n = new RegExp("({[" + o + "]})","g"),
...
function(e, t, n) {
    ...
    var o, r = e([]), a = e.resize = e.extend(e.resize, {}), s = "setTimeout", l = "resize", c = l + "-special-event", d = "delay", u = "throttleWindow";
    a[d] = 250,
    a[u] = !0,
    e.event.special[l] = {
        setup: function() {
...
+function(e) {
    ...
    function t(i, o) {
        ...
        this.$body = e("body"),
        this.$scrollElement = this.$element.on("scroll." + n + ".data-api", a),
        this.options = e.extend({}, t.DEFAULTS, o),
        this.selector || (this.selector = (this.options.target || (r = e(i).attr("href")) && r.replace(/.*(?=#[^\s]+$)/, "") || "") + " .nav li > a"),
        this.offsets = e([]),
        this.targets = e([]),
    ...
    t.prototype.refresh = function() {
        ...
        this.$body.find(this.selector).map(function() {
            var i = e(this)
              ...
              , r = /^#./.test(o) && e(o);
            return r && r.length && r.is(":visible") && [[r[t]().top + (!e.isWindow(n.$scrollElement.get(0)) && n.$scrollElement.scrollTop()), o]] || null
        }).sort(function(e, t) {
            return e[0] - t[0]
        }).each(function() {
    ...
    t.prototype.process = function() {
        ...
        if (t >= i)
            return a != (e = r.last()[0]) && this.activate(e);
        if (a && t <= o[0])
            return a != (e = r[0]) && this.activate(e);
        for (e = o.length; e--; )
            a != r[e] && t >= o[e] && (!o[e + 1] || t <= o[e + 1]) && this.activate(r[e])
    }
    ,
...
function(e, t) {
    "use strict";
    var n, i, o = "localStorage", r = "page_" + e.location.pathname + e.location.search, a = function() {
        this.slience = !0;
        try {
            o in e && e[o] && e[o].setItem && (this.enable = !0,
            n = e[o])
        } catch (a) {}
        this.enable || (i = {},
        n = {
        ...
        this.storage = n,
        this.page = this.get(r, {})
    };
    a.prototype.pageSave = function() {
        if (t.isEmptyObject(this.page))
            this.remove(r);
        else {
            var e, n = [];
            for (e in this.page) {
            ...
            for (e = n.length - 1; e >= 0; e--)
                delete this.page[n[e]];
            this.set(r, this.page)
        }
    }
    ,
    a.prototype.pageRemove = function(e) {
        "undefined" != typeof this.page[e] && (this.page[e] = null,
        this.pageSave())
    }
    ,
    ...
    a.prototype.pageSet = function(e, n) {
        t.isPlainObject(e) ? t.extend(!0, this.page, e) : this.page[this.serialize(e)] = n,
        this.pageSave()
    }
    ,
    ...
    a.prototype.set = function(e, t) {
        return void 0 === t ? this.remove(e) : (this.setItem(e, this.serialize(t)),
        this)
    }
    ,
...
function(e) {
    ...
    var t = "zui.searchBox"
      , n = function(t, i) {
        ...
        o.name = name,
        o.$ = e(t),
        o.options = i = e.extend({}, n.DEFAULTS, o.$.data(), i);
        var r = o.$.is(i.inputSelector) ? o.$ : o.$.find(i.inputSelector);
        if (r.length) {
            var a = function() {
                o.changeTimer && (clearTimeout(o.changeTimer),
                o.changeTimer = null)
            }
              , s = function() {
                a();
                ...
                if (e !== o.lastValue) {
                    var t = "" === e;
                    r.toggleClass("empty", t),
                    o.$.callComEvent(o, "onSearchChange", [e, t]),
                    o.lastValue = e
                }
            };
            o.$input = r = r.first(),
            r.on(i.listenEvent, function() {
                o.changeTimer = setTimeout(function() {
                    s()
                }, i.changeDelay)
            }).on("focus", function(e) {
                r.addClass("focus"),
                o.$.callComEvent(o, "onFocus", [e])
            }).on("blur", function(e) {
                r.removeClass("focus"),
                o.$.callComEvent(o, "onBlur", [e])
            }).on("keydown", function(e) {
                var t = 0
                  , n = e.which;
                27 === n && i.escToClear ? (this.setSearch("", !0),
                s(),
                t = 1) : 13 === n && i.onPressEnter && (s(),
                o.$.callComEvent(o, "onPressEnter", [e]));
...
function(e, t) {
    ...
    var n = "zui.draggable"
      ...
      , r = function(t, n) {
        ...
        r.$ = e(t),
        r.id = o++,
        r.options = e.extend({}, i, r.$.data(), n),
        r.init()
    };
    r.DEFAULTS = i,
    r.NAME = n,
    r.prototype.init = function() {
        var i, o, r, a, s, l = this, c = l.$, d = "before", u = "drag", p = "finish", h = "." + n + "." + l.id, f = "mousedown" + h, g = "mouseup" + h, m = "mousemove" + h, v = l.options, y = v.selector, b = v.handle, x = c, $ = e.isFunction(v.move), w = function(e) {
            var t = e.pageX
              , n = e.pageY;
            s = !0;
            var o = {
            ...
            x.removeClass("drag-ready").addClass("dragging"),
            v.move && ($ ? v.move(o, x) : x.css(o)),
            v[u] && v[u]({
                event: e,
                element: x,
                startOffset: r,
            ...
            a.x = t,
            a.y = n,
            v.stopPropagation && e.stopPropagation()
        }, _ = function(n) {
            if (e(t).off(h),
            !s)
                return x.removeClass("drag-ready"),
                void 0;
            var o = {
                left: n.pageX - r.x,
                top: n.pageY - r.y
            };
            x.removeClass("drag-ready dragging"),
            v.move && ($ ? v.move(o, x) : x.css(o)),
            v[p] && v[p]({
                event: n,
                element: x,
            ...
            n.preventDefault(),
            v.stopPropagation && n.stopPropagation()
        }, C = function(n) {
            var l = e.zui.getMouseButtonCode(v.mouseButton);
            if (!(l > -1 && n.button !== l)) {
                var c = e(this);
                if (y && (x = b ? c.closest(y) : c),
                v[d]) {
                    var u = v[d]({
                        event: n,
                        element: x
...
function(e, t, n) {
    ...
    a.prototype.init = function() {
        var o, r, a, s, l, c, d, u, p, h, f, g, m, v = this, y = v.$, b = v.options, x = b.deviation, $ = "." + i + "." + v.id, w = "mousedown" + $, _ = "mouseup" + $, C = "mousemove" + $, k = b.selector, E = b.handle, T = b.flex, S = b.container, j = b.canMoveHere, A = b.dropToClass, M = y, I = !1, N = S ? e(b.container).first() : k ? y : e("body"), D = function(t) {
            if (I && (f = {
                left: t.pageX,
                top: t.pageY
            },
            !(n.abs(f.left - u.left) < x && n.abs(f.top - u.top) < x))) {
                if (null === a) {
                    ...
                    "absolute" != i && "relative" != i && "fixed" != i && (c = i,
                ...
                if (o.each(function() {
                    ...
                    return f.left > r && f.top > a && f.left < r + i && f.top < a + o && ($ && $.removeClass(A),
                    $ = t,
                    !b.nested) ? !1 : void 0
                }),
                $) {
                    ...
                    var w = $.data("id");
                    M.data("id") != w && (l = !1),
                    (null === r || r.data("id") !== w && !l) && (y = !0),
                    r = $,
                    T && o.removeClass(A),
                    r.addClass(A)
                }
                T ? null !== r && r.length && (s = !0) : (M.toggleClass("drop-in", s),
                a.toggleClass("drop-in", s)),
                j && j(M, r) === !1 || v.trigger("drag", {
                    event: t,
                    isIn: s,
                    target: r,
                    element: M,
            ...
            I) {
                ...
                c && N.css("position", c),
                null === a)
                    return M.removeClass("drag-from"),
                    v.trigger("always", {
                        event: n,
                        cancel: !0
                    }),
                ...
                i = v.trigger("beforeDrop", y),
                i && s && v.trigger("drop", y),
                o.removeClass(A),
                M.removeClass("dragging").removeClass("drag-from"),
                a.remove(),
                a = null,
                v.trigger("finish", y),
                v.trigger("always", y),
            ...
            if (!(i > -1 && n.button !== i)) {
                var f = e(this);
                k && (M = E ? f.closest(k) : f),
                M.hasClass("drag-shadow") || b.before && b.before({
                    event: n,
                    element: M
                }) === !1 || (I = !0,
                o = e.isFunction(b.target) ? b.target(M, y) : N.find(b.target),
                r = null,
                a = null,
                s = !1,
                l = !0,
                ...
                d = M.offset(),
                p = N.offset(),
                p.top = p.top - N.scrollTop(),
                p.left = p.left - N.scrollLeft(),
                u = {
                    left: n.pageX,
                    top: n.pageY
                },
                ...
                M.addClass("drag-from"),
                e(t).on(C, D).on(_, B),
                m = setTimeout(function() {
                    e(t).on(w, B)
                }, 10),
                n.preventDefault(),
                b.stopPropagation && n.stopPropagation())
            }
        };
        E ? y.on(w, E, L) : k ? y.on(w, k, L) : y.on(w, L)
    }
    ,
...
+function(e, t) {
    ...
    function n(t, n, r) {
        return this.each(function() {
            ...
            s || a.data(i, s = new o(this,l)),
            "string" == typeof t ? s[t](n, r) : l.show && s.show(n, r)
        })
    }
    var i = "zui.modal"
      , o = function(n, o) {
        var r = this;
        r.options = o,
        r.$body = e(document.body),
        r.$element = e(n),
        r.$backdrop = r.isShown = null,
        r.scrollbarWidth = 0,
        o.moveable === t && (r.options.moveable = r.$element.hasClass("modal-moveable")),
        o.remote && r.$element.find(".modal-content").load(o.remote, function() {
    ...
    var r = function(t, n) {
        var i = e(window);
        n.left = Math.max(0, Math.min(n.left, i.width() - t.outerWidth())),
        n.top = Math.max(0, Math.min(n.top, i.height() - t.outerHeight())),
        t.css(n)
    };
    ...
    o.prototype.ajustPosition = function(n) {
        ...
        n !== t && null !== n) {
            ...
            if (a.scrollInside) {
                ...
                c.maxHeight = l - u,
                d.outerHeight() > c.maxHeight && (c.overflow = "auto")
            }
            d.css(c);
            ...
            s.hasClass("modal-moveable")) {
                var h = null
                  , f = a.rememberPos;
                f && (f === !0 ? h = o.$element.data("modal-pos") : e.zui.store && (h = e.zui.store.pageGet(i + ".rememberPos." + f))),
                n = e.extend(n, {
                    left: Math.max(0, (e(window).width() - s.outerWidth()) / 2)
                }, h),
                "inside" === a.moveable ? r(s, n) : s.css(n)
            } else
                s.css(n)
        }
    }
    ...
    o.prototype.setMoveale = function() {
        ...
        o.toggleClass("modal-moveable", !!n.moveable),
        t.$element.data("modal-moveable-setup") || o.draggable({
            container: t.$element,
            handle: ".modal-header",
            before: function() {
            ...
            finish: function(o) {
                var r = n.rememberPos;
                r && (t.$element.data("modal-pos", o.pos),
                e.zui.store && r !== !0 && e.zui.store.pageSet(i + ".rememberPos." + r, o.pos))
            },
    ...
    o.prototype.show = function(t, n) {
        ...
        r.$element.trigger(a),
        r.$element.toggleClass("modal-scroll-inside", !!r.options.scrollInside),
        r.isShown || a.isDefaultPrevented() || (r.isShown = !0,
        r.options.moveable && r.setMoveale(),
        r.checkScrollbar(),
        r.options.backdrop !== !1 && (r.$body.addClass("modal-open"),
        r.setScrollbar()),
        r.escape(),
        r.$element.on("click.dismiss." + i, '[data-dismiss="modal"]', function(e) {
            r.hide(),
            e.stopPropagation()
        }),
        r.backdrop(function() {
    ...
    o.prototype.hide = function(t) {
        ...
        t = e.Event("hide." + i),
        n.$element.trigger(t),
        n.isShown && !t.isDefaultPrevented() && (n.isShown = !1,
        n.options.backdrop !== !1 && (n.$body.removeClass("modal-open"),
        n.resetScrollbar()),
        n.escape(),
        e(document).off("focusin." + i),
        n.$element.removeClass("in").attr("aria-hidden", !0).off("click.dismiss." + i),
        e.support.transition && n.$element.hasClass("fade") ? n.$element.one("bsTransitionEnd", e.proxy(n.hideModal, n)).emulateTransitionEnd(o.TRANSITION_DURATION) : n.hideModal())
    }
    ,
    ...
    o.prototype.backdrop = function(t) {
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            if (this.$backdrop = e('<div class="modal-backdrop ' + r + '" />').appendTo(this.$body),
            this.$element.on("mousedown.dismiss." + i, e.proxy(function(e) {
...
function(e, t, n) {
    ...
    var i = "zui.modaltrigger"
      ...
      , a = "string"
      , s = function(t, n) {
        t = e.extend({}, s.DEFAULTS, e.ModalTriggerDefaults, n ? n.data() : null, t),
        this.isShown,
        this.$trigger = n,
        this.options = t,
        this.id = e.zui.uuid()
    ...
    s.prototype.init = function(n) {
        var s = this;
        if (n.url && (!n.type || n.type != o && "iframe" != n.type) && (n.type = o),
        n.remote)
            n.type = o,
            typeof n.remote === a && (n.url = n.remote);
        else if (n.iframe)
            n.type = "iframe",
            typeof n.iframe === a && (n.url = n.iframe);
        else if (n.custom && (n.type = "custom",
        typeof n.custom === a)) {
            var l;
            try {
                l = e(n.custom)
        ...
        var d = e("#" + n.name);
        d.length && (s.isShown || d.off(r),
        d.remove()),
        d = e('<div id="' + n.name + '" class="modal modal-trigger ' + (n.className || "") + '">' + ("string" == typeof n.loadingIcon && 0 === n.loadingIcon.indexOf("icon-") ? '<div class="icon icon-spin loader ' + n.loadingIcon + '"></div>' : n.loadingIcon) + '<div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button class="close" data-dismiss="modal">×</button><h4 class="modal-title"><i class="modal-icon"></i> <span class="modal-title-name"></span></h4></div><div class="modal-body"></div></div></div></div>').appendTo("body").data(i, s);
        var u = function(t, i) {
            var o = n[t];
        ...
        this.$modal = d,
        this.$dialog = d.find(".modal-dialog"),
        n.mergeOptions && (this.options = n)
    }
    ,
    s.prototype.show = function(n) {
        ...
        l.toggleClass("fade", r.fade).addClass(r.className).toggleClass("modal-loading", !this.isShown).toggleClass("modal-scroll-inside", !!r.scrollInside),
        c.toggleClass("modal-md", "md" === r.size).toggleClass("modal-sm", "sm" === r.size).toggleClass("modal-lg", "lg" === r.size).toggleClass("modal-fullscreen", "fullscreen" === r.size),
        p.toggle(r.showHeader),
        p.find(".modal-icon").attr("class", "modal-icon icon-" + r.icon),
        p.find(".modal-title-name").text(r.title || ""),
        r.size && "fullscreen" === r.size && (r.width = "",
        r.height = "");
        var f = function() {
          ...
          , g = function(e, t) {
            return "undefined" == typeof e && (e = r.delay),
            setTimeout(function() {
                c = l.find(".modal-dialog"),
                r.width && "auto" != r.width && c.css("width", r.width),
                r.height && "auto" != r.height && (c.css("height", r.height),
                "iframe" === r.type && u.css("height", c.height() - p.outerHeight())),
                s.ajustPosition(r.position),
                l.removeClass("modal-loading"),
                "iframe" != r.type && c.off("resize." + i).on("resize." + i, f),
                t && t()
            }, e)
        };
        if ("custom" === r.type && d)
            if (e.isFunction(d)) {
                ...
                d instanceof e ? (u.html(e("<div>").append(d.clone()).html()),
                g()) : (u.html(d),
                g());
        else if (r.url) {
            var v = function() {
            ...
            if (l.attr("ref", r.url),
            "iframe" === r.type) {
                l.addClass("modal-iframe"),
                this.firstLoad = !0;
                var y = "iframe-" + r.name;
                p.detach(),
                u.detach(),
                h.empty().append(p).append(u),
                u.css("padding", 0).html('<iframe id="' + y + '" name="' + y + '" src="' + r.url + '" frameborder="no"  allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"  allowtransparency="true" scrolling="auto" style="width: 100%; height: 100%; left: 0px;"></iframe>'),
                r.waittime > 0 && (s.waitTimeout = g(r.waittime, v));
                var b = document.getElementById(y);
                b.onload = b.onreadystatechange = function() {
                    var n = !!r.scrollInside;
                    if (s.firstLoad && l.addClass("modal-loading"),
                    !this.readyState || "complete" == this.readyState) {
                        s.firstLoad = !1,
                        r.waittime > 0 && clearTimeout(s.waitTimeout);
                        try {
                            l.attr("ref", b.contentWindow.location.href);
                            var o = t.frames[y].$;
                            if (o && "auto" === r.height && "fullscreen" != r.size) {
                                var a = o("body").addClass("body-modal").toggleClass("body-modal-scroll-inside", n);
                                r.iframeBodyClass && a.addClass(r.iframeBodyClass);
                                var c = []
                                  , d = function(i) {
                                    l.removeClass("fade");
                                    var o = a.outerHeight();
                                    if (i === !0 && r.onlyIncreaseHeight && (o = Math.max(o, u.data("minModalHeight") || 0),
                                    u.data("minModalHeight", o)),
                                    n) {
                                    ...
                                    for (c.length > 1 && o === c[0] && (o = Math.max(o, c[1])),
                                    c.push(o); c.length > 2; )
                                        c.shift();
                                    u.css("height", o),
                                    r.fade && l.addClass("fade"),
                                    g()
                                };
                                ...
                                setTimeout(d, 100),
                                a.off("resize." + i).on("resize." + i, d),
                                n && e(t).off("resize." + i).on("resize." + i, d)
                            } else
                                g()
                        } catch (h) {
                            g()
                ...
                e.ajax(e.extend({
                    ...
                    success: function(n) {
                        try {
                            var i = e(n);
                            i.filter(".modal-dialog").length ? c.replaceWith(i) : i.filter(".modal-content").length ? c.find(".modal-content").replaceWith(i) : u.wrapInner(i)
                        } catch (r) {
                            t.console && t.console.warn && console.warn("ZUI: Cannot recogernize remote content.", {
                                error: r,
                                data: n
                            }),
                            l.html(n)
    ...
    s.prototype.close = function(n, i) {
        ...
        (n || i) && o.$modal.on("hidden" + r, function() {
            e.isFunction(n) && n(),
            typeof i === a && i.length && !o.$modal.data("cancel-reload") && ("this" === i ? t.location.reload() : t.location = i)
        }),
        o.$modal.modal("hide")
    }
    ,
    ...
    s.prototype.ajustPosition = function(t) {
        t = t === n ? this.options.position : t,
        e.isFunction(t) && (t = t(this)),
        this.$modal.modal("ajustPosition", t)
    }
    ,
    e.zui({
        ModalTrigger: s,
    ...
    e.fn.modalTrigger = function(t, n) {
        return e(this).each(function() {
            ...
            r || o.data(i, r = new s(l,o)),
            typeof t == a ? r[t](n) : l.show && r.show(n),
            o.on((l.trigger || "click") + ".toggle." + i, function(t) {
                l = e.extend(l, {
    ...
    e.fn.modal.bs = l;
    var c = function(t) {
        return t = t ? e(t) : e(".modal.modal-trigger"),
      ...
      , d = function(n, o, r) {
        ...
        }) : e("body").hasClass("modal-open") || e(".modal.in").length || e("body").hasClass("body-modal") && t.parent.$.zui.closeModal(a, o, r)
    }
      , u = function(e, t) {
        t = c(t),
        t && t.length && t.modal("ajustPosition", e)
    };
    e.zui({
        closeModal: d,
...
+function(e) {
    ...
    t.prototype.enter = function(t) {
        var n = t instanceof this.constructor ? t : e(t.currentTarget)[this.type](this.getDelegateOptions()).data("zui." + this.type);
    ...
    t.prototype.show = function(t) {
        ...
        if ((t || this.hasContent()) && this.enabled) {
            var i = this;
            if (i.$element.trigger(n),
            n.isDefaultPrevented())
                return;
            var o = i.tip();
            i.setContent(t),
            i.options.animation && o.addClass("fade");
            ...
            i.options.container ? o.appendTo(i.options.container) : o.insertAfter(i.$element);
            var l = i.getPosition()
              , c = o[0].offsetWidth
              , d = o[0].offsetHeight;
            if (s) {
                ...
                r = "bottom" == r && l.top + l.height + d - h > g ? "top" : "top" == r && l.top - h - d < 0 ? "bottom" : "right" == r && l.right + c > f ? "left" : "left" == r && l.left - c < m ? "right" : r,
            ...
            var y = function() {
                var e = i.hoverState;
                i.$element.trigger("shown.zui." + i.type),
                i.hoverState = null,
                "out" == e && i.leave(i)
            };
            e.support.transition && i.$tip.hasClass("fade") ? o.one("bsTransitionEnd", y).emulateTransitionEnd(150) : y()
        }
    }
    ,
    ...
    t.prototype.setContent = function(e) {
        ...
        t.find(".tooltip-inner")[this.options.html ? "html" : "text"](n),
    ...
    e.fn.tooltip = function(n, i) {
        return this.each(function() {
            var o = e(this)
              ...
              , a = "object" == typeof n && n;
            r || o.data("zui.tooltip", r = new t(this,a)),
...
+function(e) {
    ...
    t.prototype.setContent = function() {
        var e = this.tip()
          , t = this.getTarget();
        if (t)
            return t.find(".arrow").length < 1 && e.addClass("no-arrow"),
            e.html(t.html()),
            void 0;
        var n = this.getTitle()
          , i = this.getContent();
        e.find(".popover-title")[this.options.html ? "html" : "text"](n),
    ...
    e.fn.popover = function(n) {
        return this.each(function() {
            var i = e(this)
              ...
              , r = "object" == typeof n && n;
            o || i.data("zui.popover", o = new t(this,r)),
            "string" == typeof n && o[n]()
        })
    }
    ,
...
+function(e) {
    ...
    function t() {
        ...
        e(a).each(function(t) {
            var n = i(e(this));
            n.hasClass("open") && (n.trigger(t = e.Event("hide." + o)),
            t.isDefaultPrevented() || n.removeClass("open").trigger("hidden." + o))
        })
    }
    function n() {
        e(r).remove(),
        e(a).each(function(t) {
            var n = i(e(this));
            n.hasClass("mouseopen") && (n.trigger(t = e.Event("hide." + o)),
            t.isDefaultPrevented() || n.removeClass("mouseopen").trigger("hidden." + o))
        })
    }
    function i(t) {
    ...
    s.prototype.toggle = function(r) {
        ...
        if (!a.is(".disabled, :disabled")) {
            var l = i(a)
              , c = l.hasClass("open");
            if ("click" === s ? (c = l.hasClass("open"),
            t()) : (c = "mouseenter" === s ? !1 : !0,
            n()),
            !c) {
                if ("ontouchstart"in document.documentElement && !l.closest(".navbar-nav").length && e('<div class="dropdown-backdrop"/>').insertAfter(e(this)).on("click", t),
                l.trigger(r = e.Event("show." + o)),
                r.isDefaultPrevented())
                    return;
                "click" === s ? l.toggleClass("open").trigger("shown." + o) : l.toggleClass("mouseopen").trigger("shown." + o),
                a.focus()
            }
            return !1
        }
    ...
    e.fn.dropdown = function(t) {
        return this.each(function() {
            var n = e(this)
              , i = n.data("dropdown");
            i || n.data("dropdown", i = new s(this)),
    ...
    e(document).on("click." + c, t).on("click." + c, ".dropdown form", function(e) {
        e.stopPropagation()
    }).on("click." + c, a, s.prototype.toggle).on("keydown." + c, a + ", [role=menu]", s.prototype.keydown).on("mouseenter", ".dropdown", s.prototype.toggle).on("mouseleave", ".dropdown", s.prototype.toggle)
}(window.jQuery),
function(e, t) {
    "use strict";
    var n = "zui.contextmenu"
      ...
      , d = function(t, n) {
        ...
        "seperator" === t.type || "divider" === t.type)
            return e('<li class="divider"></li>');
        var i = e("<a/>").attr({
            href: t.url || "###",
            "class": t.className,
            style: t.style
        }).data("item", t);
        return t.html ? i.html(t.html === !0 ? t.label || t.text : t.html) : i.text(t.label || t.text),
        t.onClick && i.on("click", t.onClick),
        e("<li />").toggleClass("disabled", t.disabled === !0).append(i)
    }
      , u = null
      , p = function(t, n) {
        ...
        if (i.length) {
            ...
            if (!t || o.id === t) {
                var s = function() {
                    i.hide(),
                    o.onHidden && o.onHidden(),
                    n && n()
                };
                o.onHide && o.onHide();
                var l = o.animation;
                i.removeClass("in"),
                l ? u = setTimeout(s, o.duration) : s()
            }
        }
        return r
    }
      , h = function(c, h, f) {
        e.isPlainObject(c) && (f = h,
        h = c,
        c = h.items),
        o = !0,
        h = e.extend({}, i, h);
        var g = h.x
          , m = h.y;
        g === t && (g = (h.event || h).clientX),
        g === t && (g = s),
        m === t && (m = (h.event || h).clientY),
        m === t && (m = l);
        var v = e("#" + a);
        v.length || (v = e('<div style="display: none; position: fixed; z-index: 2000;" class="contextmenu" id="' + a + '"><ul class="dropdown-menu contextmenu-menu"></ul></div>').appendTo("body"));
        ...
        var b = h.itemCreator || d
          , x = typeof c;
        "string" === x ? c = c.split(",") : "function" === x && (c = c(h)),
        ...
        var C = e(window);
        return g = Math.max(0, Math.min(g, C.width() - y.outerWidth())),
        m = Math.max(0, Math.min(m, C.height() - y.outerHeight())),
        v.css({
            left: g,
            top: m
        }),
        $ ? (v.addClass("open").addClass($).show(),
        u = setTimeout(function() {
            _(),
            o = !1
        }, h.duration)) : (v.addClass("open").show(),
        _(),
        u = setTimeout(function() {
            o = !1
        }, 200)),
    ...
    var f = function(t, i) {
        ...
        var s = function(e) {
            if ("mousedown" !== e.type || 2 === e.button) {
                ...
                return i.itemsCreator && (t.items = i.itemsCreator.call(this, e)),
                o.show(t),
                e.preventDefault(),
                e.returnValue = !1,
                !1
...
+function(e) {
        ...
        function t(t) {
            ...
            case "touchend":
                ...
                if (Math.abs(a) > Math.abs(s))
                    n(r, a),
                    Math.abs(a) > 10 && t.preventDefault();
                else {
                    var l = e(window);
                    e("body,html").animate({
    ...
    e.fn.carousel = function(n) {
        return this.each(function() {
            ...
            o || i.data("zui.carousel", o = new t(this,r)),
            "number" == typeof n ? o.to(n) : a ? o[a]() : r.interval && o.pause().cycle(),
            r.touchable && o.touchable()
        })
    }
    ,
    ...
    e(document).on("click.zui.carousel.data-api", "[data-slide], [data-slide-to]", function(t) {
        ...
        a && (r.interval = !1),
        o.carousel(r),
        (a = i.attr("data-slide-to")) && o.data("zui.carousel").to(a),
        t.preventDefault()
    }),
    e(window).on("load", function() {
    ...
    e.zui.imgReady = function() {
        ...
        return function(i, o, r, a) {
            ...
            p.onerror = function() {
                a && a.call(p),
                s.end = !0,
                p = p.onload = p.onerror = null
            }
            ,
            s = function() {
                d = p.width,
                u = p.height,
                (d !== l || u !== c || d * u > 1024) && (o.call(p),
                s.end = !0)
            }
            ,
            s(),
...
function(e, t, n) {
    ...
    i.prototype.getOptions = function(t) {
        var n = "image";
        return t = e.extend({}, i.DEFAULTS, this.$.data(), t),
        t[n] || (t[n] = this.$.attr("src") || this.$.attr("href") || this.$.find("img").attr("src"),
        this.$.data(n, t[n])),
        t
    }
    ,
    ...
    i.prototype.initGroups = function() {
        ...
        t || (t = e('[data-toggle="lightbox"][data-group="' + this.options.group + '"], [data-lightbox-group="' + this.options.group + '"]'),
        this.$.data("groups", t),
        t.each(function(t) {
    ...
    i.prototype.setImage = function(e, t) {
        void 0 !== e && (this.options.image = e),
        void 0 !== t && (this.options.caption = t)
    }
    ,
        ...
        return r.image ? (i.modalTrigger({
            ...
            custom: function(i) {
                ...
                e.zui.imgReady(r.image, function() {
                    ...
                    d < this.width + 30 && a.addClass("lightbox-full"),
                    i.ready(200)
                }),
                a.find(".prev").toggleClass("show", s.filter('[data-group-index="' + (l - 1) + '"]').length > 0),
                a.find(".next").toggleClass("show", s.filter('[data-group-index="' + (l + 1) + '"]').length > 0),
                a.find(".controller").click(function() {
                    var o = e(this)
                    ...
                    if (l.length) {
                        var u = l.data("image")
                          , p = l.data("caption");
                        a.addClass("modal-loading").data("group-index", r).toggleClass("lightbox-with-caption", "string" == typeof p).removeClass("lightbox-full"),
                        a.find(".lightbox-img").attr("src", u),
                        a.find(".caption > .content").text(p),
                        d = e(t).width(),
                        e.zui.imgReady(u, function() {
                            c.css({
                                width: n.min(d, this.width)
                            }),
                            d < this.width + 30 && a.addClass("lightbox-full"),
                    ...
                    return a.find(".prev").toggleClass("show", s.filter('[data-group-index="' + (r - 1) + '"]').length > 0),
                    a.find(".next").toggleClass("show", s.filter('[data-group-index="' + (r + 1) + '"]').length > 0),
                    !1
                })
            }
        }),
    ...
    e.fn.lightbox = function(t) {
        ...
        return this.each(function() {
            var o = e(this)
              , r = "object" == typeof t && t;
            "object" == typeof r && r.group ? o.attr("data-lightbox-group", r.group) : o.data("group") ? o.attr("data-lightbox-group", o.data("group")) : o.attr("data-lightbox-group", n),
            o.data("group", o.data("lightbox-group"));
            var a = o.data("zui.lightbox");
            a || o.data("zui.lightbox", a = new i(this,r)),
            "string" == typeof t && a[t]()
        })
    }
    ,
    e.fn.lightbox.Constructor = i,
    e(function() {
...
function(e, t, n) {
    ...
    var i = 0
      ...
      , a = {}
      , s = function(t, s) {
        e.isPlainObject(t) && (s = t,
        t = s.message);
        var l = this;
        s = l.options = e.extend({}, r, s),
        l.id = s.id || i++;
        var c = a[l.id];
        c && c.destroy(),
        a[l.id] = l,
        l.message = (s.icon ? '<i class="icon-' + s.icon + ' icon"></i> ' : "") + t,
        l.$ = e(o.format(s)).toggleClass("fade", s.fade).toggleClass("scale", s.scale).attr("id", "messager-" + l.id),
        s.cssClass && l.$.addClass(s.cssClass);
        var d = !1
          , u = l.$.find(".messager-actions")
          , p = function(t) {
            var i = e('<button type="button" class="action action-' + t.name + '"/>');
            "close" === t.name && i.addClass("close"),
            t.html !== n && i.html(t.html),
            t.icon !== n && i.append('<i class="action-icon icon-' + t.icon + '"/>'),
            t.text !== n && i.append('<span class="action-text">' + t.text + "</span>"),
            t.tooltip !== n && i.attr("title", t.tooltip).tooltip(),
            i.data("action", t),
            u.append(i)
        };
        ...
        l.$.on("click", ".action", function(t) {
            ...
            s.onAction && (n = s.onAction.call(this, i.name, i, l),
            n === !1) || e.isFunction(i.action) && (n = i.action.call(this, l),
            n === !1) || (l.hide(),
            t.stopPropagation())
        }),
        l.$.on("click", function() {
        ...
        s.contentClass && h.addClass(s.contentClass),
        l.$.data("zui.messager", l),
        s.show && l.message !== n && l.show()
    };
    s.prototype.update = function(t, n) {
        var i = this
          , o = i.options;
        i.$.removeClass("messager-" + o.type),
        n && (o = e.extend(o, n)),
        i.$.addClass("messager-" + o.type),
        t && (i.message = (o.icon ? '<i class="icon-' + o.icon + ' icon"></i> ' : "") + t,
        i.$.find(".messager-content").html(i.message))
    }
    ,
    s.prototype.show = function(i, o) {
        ...
        if (r.isShow)
            ...
            void 0;
        r.hiding && (clearTimeout(r.hiding),
        r.hiding = null),
        r.update(i);
        var l = a.placement
          , c = e(a.parent)
          , d = c.children(".messagers-holder." + l);
        if (d.length || (d = e("<div/>").attr("class", "messagers-holder " + l).appendTo(c)),
        d.append(r.$),
        "center" === l) {
            var u = e(t).height() - d.height();
            d.css("top", Math.max(-u, u / 2))
        }
        return r.$.show().addClass("in"),
        a.time && (r.hiding = setTimeout(function() {
            r.hide()
        }, a.time)),
        r.isShow = !0,
        o && o(),
...
function(e, t, n, i) {
    ...
    function o(e) {
        ...
        e && d.test(e)) {
            ...
            if (4 === e.length) {
                var n = "#";
                for (t = 1; 4 > t; t += 1)
                    n += e.slice(t, t + 1).concat(e.slice(t, t + 1));
                e = n
            }
            var i = [];
            for (t = 1; 7 > t; t += 2)
                i.push(b("0x" + e.slice(t, t + 2)));
            return {
                r: i[0],
                g: i[1],
                b: i[2],
    ...
    function a(e) {
        function t(e) {
            ...
            1 > 6 * e ? s + 6 * (a - s) * e : 1 > 2 * e ? a : 2 > 3 * e ? s + 6 * (a - s) * (2 / 3 - e) : s
        }
        var n = e.h
          , i = e.s
          , o = e.l
    ...
    $.prototype.spin = function(e) {
        var t = this.toHsl()
          , n = (t.h + e) % p;
        return t.h = 0 > n ? p + n : n,
        this.rgb(a(t))
    }
    ,
    $.prototype.toHsl = function() {
        var e, n, i = this, o = i.r / u, r = i.g / u, a = i.b / u, s = i.a, l = t.max(o, r, a), c = t.min(o, r, a), d = (l + c) / 2, h = l - c;
        if (l === c)
            e = n = 0;
        else {
            switch (n = d > .5 ? h / (2 - l - c) : h / (l + c),
            l) {
            case o:
                e = (r - a) / h + (a > r ? 6 : 0);
                break;
    ...
    $.prototype.luma = function() {
        var e = this.r / u
          , n = this.g / u
          , i = this.b / u;
        return e = .03928 >= e ? e / 12.92 : t.pow((e + .055) / 1.055, 2.4),
        n = .03928 >= n ? n / 12.92 : t.pow((n + .055) / 1.055, 2.4),
        i = .03928 >= i ? i / 12.92 : t.pow((i + .055) / 1.055, 2.4),
        .2126 * e + .7152 * n + .0722 * i
    }
    ,
    ...
    $.prototype.contrast = function(e, t, n) {
        if (t = v(t) ? new $(u,u,u,1) : new $(t),
        e = v(e) ? new $(0,0,0,1) : new $(e),
        e.luma() > t.luma()) {
            var i = t;
            t = e,
            e = i
        }
        return this.a < .5 ? e : (n = v(n) ? .43 : c(n),
        this.luma() < n ? t : e)
    }
    ,
    ...
    $.prototype.toCssStr = function() {
        var e = this;
        return e.a > 0 ? e.a < 1 ? "rgba(" + e.r + "," + e.g + "," + e.b + "," + e.a + ")" : e.hexStr() : "transparent"
    }
    ,
    $.isColor = r,
    $.names = m,
...
function(e) {
    ...
    function n(t, n, i) {
        return n = n || t.type,
        e(i || t.template).addClass("tree-action").attr(e.extend({
            "data-type": n,
            title: t.title || ""
    ...
    r.prototype.add = function(t, n, i, o, r) {
        var a, s = e(t), l = this.options;
        if (s.is("li") ? (a = s.children("ul"),
        a.length || (a = e("<ul/>"),
        s.append(a),
        this._initList(a, s))) : a = s,
        a) {
            var c = this;
            e.isArray(n) || (n = [n]),
            e.each(n, function(t, n) {
                ...
                var o = l.itemWrapper ? e(l.itemWrapper === !0 ? '<div class="tree-item-wrapper"/>' : l.itemWrapper).appendTo(i) : i;
                if (n.html)
                    o.html(n.html);
                ...
                c._initItem(i, n.idx || t, a, n),
                n.children && n.children.length && c.add(i, n.children)
            }),
            this._initList(a),
            i && !a.hasClass("tree") && c.expand(a.parent("li"), o, r)
        }
    }
    ,
    r.prototype.reload = function(t) {
        ...
        t && (n.$.empty(),
        n.add(n.$, t)),
        n.isPreserve && n.store.time && n.$.find("li:not(.tree-action-item)").each(function() {
            var t = e(this);
    ...
    r.prototype._initList = function(i, o, r, a) {
        var s = this;
        i.hasClass("tree") ? (r = 0,
        o = null) : (o = (o || i.closest("li")).addClass("has-list"),
        o.find(".list-toggle").length || o.prepend(this.options.toggleTemplate),
        r = r || o.data("idx")),
        i.removeClass("has-active-item");
        ...
        if (c) {
            if (c.add && c.add.templateInList !== !1) {
                ...
                d.length ? d.detach().appendTo(i) : e('<li class="tree-action-item"/>').append(n(c.add, "add", c.add.templateInList)).appendTo(i)
            }
    ...
    r.prototype._initItem = function(i, o, r, a) {
        ...
        if (r = r || i.closest("ul"),
        i.attr("data-idx", o).removeClass("tree-single-item"),
        !i.data("id")) {
            var l = o;
            r.hasClass("tree") || (l = r.parent("li").data("id") + "-" + l),
            i.attr("data-id", l)
        }
        ...
        if (c) {
            ...
            d.length || (d = e('<div class="tree-actions"/>').appendTo(this.options.itemWrapper ? i.find(".tree-item-wrapper") : i),
            e.each(c, function(e, t) {
                t && d.append(n(t, e))
            }))
        }
    ...
    r.prototype._init = function() {
        var n = this.options
          , r = this;
        this.actions = t(n.actions),
        this.$.addClass("tree"),
        n.animate && this.$.addClass("tree-animate"),
        this._initList(this.$);
        var a = n.initialState
          , s = e.zui && e.zui.store && e.zui.store.enable;
        s && (this.selector = i + "::" + (n.name || "") + "#" + (this.$.attr("id") || o++),
        this.store = e.zui.store[n.name ? "get" : "pageGet"](this.selector, {})),
        "preserve" === a && (s ? this.isPreserve = !0 : this.options.initialState = a = "normal"),
        this.reload(n.data),
        s && (this.isPreserve = !0),
        "expand" === a ? this.expand() : "collapse" === a && this.collapse(),
        this.$.on("click", '.list-toggle,a[href="#"],.tree-toggle', function(t) {
            var n = e(this)
              , i = n.parent("li");
            r.callEvent("hit", {
                target: i,
    ...
    r.prototype.preserve = function(t, n, i) {
        if (this.isPreserve)
            if (t)
                n = n || t.data("id"),
                i = void 0 === i ? t.hasClass("open") : !1,
                i ? this.store[n] = i : delete this.store[n],
                this.store.time = (new Date).getTime(),
                e.zui.store[this.options.name ? "set" : "pageSet"](this.selector, this.store);
            else {
                var o = this;
                this.store = {},
    ...
    r.prototype.expand = function(e, t, n) {
        e ? (e.addClass("open"),
        !t && this.options.animate ? setTimeout(function() {
            e.addClass("in")
        }, 10) : e.addClass("in")) : e = this.$.find("li.has-list").addClass("open in"),
        n || this.preserve(e),
    ...
    r.prototype.collapse = function(e, t, n) {
        e ? !t && this.options.animate ? (e.removeClass("in"),
        setTimeout(function() {
            e.removeClass("open")
        }, 300)) : e.removeClass("open in") : e = this.$.find("li.has-list").removeClass("open in"),
        n || this.preserve(e),
        this.callEvent("collapse", e, this)
    }
    ,
    ...
    r.prototype.getOptions = function(t) {
        this.options = e.extend({}, r.DEFAULTS, this.$.data(), t),
    ...
    r.prototype.toData = function(t, n) {
        ...
        return t.children("li:not(.tree-action-item)").map(function() {
            ...
            var r = t.children("ul");
            return r.length && (o.children = i.toData(r)),
            e.isFunction(n) ? n(o, t) : o
        }).get()
    }
    ,
    r.prototype.callEvent = function(t, n) {
        var i;
        return e.isFunction(this.options[t]) && (i = this.options[t](n, this)),
        this.$.trigger(e.Event(t + "." + this.name, n)),
        i
    }
    ,
    e.fn.tree = function(t, n) {
        return this.each(function() {
            var o = e(this)
              , a = o.data(i)
              , s = "object" == typeof t && t;
            a || o.data(i, a = new r(this,s)),
            "string" == typeof t && a[t](n)
        })
    }
    ,
    e.fn.tree.Constructor = r,
    e(function() {
...
!function(e, t) {
    ...
    , function(e) {
        ...
        t.prototype = {
            ...
            emit: function(e) {
                for (var t = [].slice.call(arguments, 1), n = ((this.e || (this.e = {}))[e] || []).slice(), i = 0, o = n.length; o > i; i++)
...
function() {
    var e, t, n, i, o, r = {}.hasOwnProperty, a = function(e, t) {
        function n() {
            this.constructor = e
        }
        for (var i in t)
    ...
    i = function() {
        ...
        t.prototype.add_group = function(t) {
            ...
            r = a.length; r > o; o++)
                i = a[o],
                s.push(this.add_option(i, n, t.disabled));
            return s
        }
        ,
        t.prototype.add_option = function(t, n, i) {
            return "OPTION" === t.nodeName.toUpperCase() ? ("" !== t.text ? (null != n && (this.parsed[n].children += 1),
            this.parsed.push({
    ...
    t = function() {
        function t(n, i) {
            ...
            t.browser_is_supported() && (this.lang = s[this.options.lang || (e.zui.clientLang ? e.zui.clientLang() : "zh_cn")],
        ...
        return t.prototype.set_default_values = function() {
            ...
            this.compact_search = this.options.compact_search || !1,
            this.inherit_select_classes = this.options.inherit_select_classes || !1,
            this.display_selected_options = null == this.options.display_selected_options || this.options.display_selected_options;
            var t = this.options.max_drop_width;
            return "string" == typeof t && t.indexOf("px") === t.length - 2 && (t = parseInt(t.substring(0, t.length - 2))),
            this.max_drop_width = t,
        ...
        t.prototype.set_default_text = function() {
            ...
            this.results_none_found = this.form_field.getAttribute("data-no_results_text") || this.options.no_results_text || this.lang.no_results_text || t.default_no_result_text
        }
        ,
        ...
        t.prototype.results_option_build = function(e) {
            ...
            o = r.length; o > i; i++)
                n = r[i],
                t += n.group ? this.result_add_group(n) : this.result_add_option(n),
                (null != e ? e.first : void 0) && (n.selected && this.is_multiple ? this.choice_build(n) : n.selected && !this.is_multiple && this.single_set_selected_text(n.text));
            return t
        }
        ,
        t.prototype.result_add_option = function(e) {
            ...
            n.setAttribute("data-data", e.data),
        ...
        t.prototype.result_add_group = function(e) {
            ...
            t.className = "group-result",
            t.title = e.title,
            t.innerHTML = e.search_text,
            this.outerHTML(t)) : ""
        }
        ,
        ...
        t.prototype.winnow_results = function(e) {
            ...
            p = h.length; p > u; u++)
                ...
                n.active_options = 0),
                null != n.group_array_index && this.results_data[n.group_array_index] && (a = this.results_data[n.group_array_index],
                0 === a.active_options && a.search_match && (r += 1),
                a.active_options += 1),
                n.group && !this.group_search || (n.search_text = n.group ? n.label : n.html,
                n.search_keys_match = this.search_string_match(n.search_keys, i),
                n.search_text_match = this.search_string_match(n.search_text, i),
                n.search_match = n.search_text_match || n.search_keys_match,
                n.search_match && !n.group && (r += 1),
                n.search_match ? (n.search_text_match && n.search_text.length ? (l = n.search_text.search(d),
                c = n.search_text.substr(0, l + s.length) + "</em>" + n.search_text.substr(l + s.length),
                n.search_text = c.substr(0, l) + "<em>" + c.substr(l)) : n.search_keys_match && n.search_keys.length && (l = n.search_keys.search(d),
                c = n.search_keys.substr(0, l + s.length) + "</em>" + n.search_keys.substr(l + s.length),
                n.search_text += '&nbsp; <small style="opacity: 0.7">' + c.substr(0, l) + "<em>" + c.substr(l) + "</small>"),
                null != a && (a.group_match = !0)) : null != n.group_array_index && this.results_data[n.group_array_index].search_match && (n.search_match = !0)));
            return this.result_clear_highlight(),
            1 > r && s.length ? (this.update_results_content(""),
            this.no_results(s)) : (this.update_results_content(this.results_option_build()),
            this.winnow_results_set_highlight(e))
        }
        ,
        ...
        t.prototype.choices_count = function() {
            ...
            n = i.length; n > t; t++)
                e = i[t],
                e.selected && "" != e.value && (this.selected_option_count += 1);
            return this.selected_option_count
        }
        ,
        ...
        t.prototype.keyup_checker = function(e) {
            var t, n;
            switch (t = null != (n = e.which) ? n : e.keyCode,
    ...
    e.fn.extend({
        chosen: function(i) {
            return t.browser_is_supported() ? this.each(function() {
                ...
                t = e(this),
                o = t.data("chosen"),
                "destroy" === i && o ? o.destroy() : o || t.data("chosen", new n(this,i))
            }) : this
        }
    }),
    n = function(t) {
        ...
        n.prototype.set_up_html = function() {
            ...
            this.is_multiple ? this.container.html('<ul class="chosen-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chosen-drop"><ul class="chosen-results"></ul></div>') : (this.container.html('<a class="chosen-single chosen-default" tabindex="-1"><span>' + this.default_text + '</span><div><b></b></div><div class="chosen-search"><input type="text" autocomplete="off" /></div></a><div class="chosen-drop"><ul class="chosen-results"></ul></div>'),
            this.compact_search ? this.container.addClass("chosen-compact").find(".chosen-search").appendTo(this.container.find(".chosen-single")) : this.container.find(".chosen-search").prependTo(this.container.find(".chosen-drop")),
            this.options.highlight_selected !== !1 && this.container.addClass("chosen-highlight-selected")),
            ...
            this.max_drop_width && this.dropdown.addClass("chosen-auto-max-width"),
            this.results_build(),
            this.set_tab_index(),
        ...
        n.prototype.search_results_mousewheel = function(e) {
            var t;
            return e.originalEvent && (t = -e.originalEvent.wheelDelta || e.originalEvent.detail),
        ...
        n.prototype.test_active_click = function(t) {
            var n;
            return n = e(t.target).closest(".chosen-container"),
            n.length && this.container[0] === n[0] ? this.active_field = !0 : this.close_field()
        }
        ,
        n.prototype.results_build = function() {
            ...
            this.container.removeClass("chosen-with-search")) : (this.search_field[0].readOnly = !1,
        ...
        n.prototype.result_do_highlight = function(e, t) {
            var n, i, o, r, a, s, l = -1;
            e.length && (this.result_clear_highlight(),
            this.result_highlight = e,
            this.result_highlight.addClass("highlighted"),
            o = parseInt(this.search_results.css("maxHeight"), 10),
            s = this.result_highlight.outerHeight(),
            a = this.search_results.scrollTop(),
            r = o + a,
            i = this.result_highlight.position().top + this.search_results.scrollTop(),
            n = i + s,
            this.middle_highlight && (t || "always" === this.middle_highlight) ? l = Math.min(i - s, Math.max(0, i - (o - s) / 2)) : n >= r ? l = n - o > 0 ? n - o : 0 : a > i && (l = i),
            l > -1 ? this.search_results.scrollTop(l) : this.result_highlight.scrollIntoView && this.result_highlight.scrollIntoView())
        }
        ,
        ...
        n.prototype.results_show = function() {
            var t = this;
            if (t.is_multiple && t.max_selected_options <= t.choices_count())
                return t.form_field_jq.trigger("chosen:maxselected", {
                    chosen: this
                }),
                !1;
            t.results_showing = !0,
            t.search_field.focus(),
            t.search_field.val(t.search_field.val());
            var n = t.drop_direction;
            if (e.isFunction(n) && (n = n.call(this)),
            "auto" === n)
                if (t.drop_directionFixed)
                    n = t.drop_directionFixed;
                else {
                    var i = t.container.find(".chosen-drop")
                      , o = t.container.offset();
                    o.top + i.outerHeight() + 30 > e(window).height() + e(window).scrollTop() && (n = "up"),
                    t.drop_directionFixed = n
                }
            t.container.toggleClass("chosen-up", "up" === n).addClass("chosen-with-drop"),
            t.winnow_results(1);
            ...
            if (r) {
                ...
                i.css("width", Math.min(a + 2, r)),
                t.fixDropWidthTimer = setTimeout(function() {
                    t.fixDropWidthTimer = null,
                    i.addClass("in")
                }, 50)
            }
        ...
        n.prototype.results_hide = function() {
            var e = this;
            return e.fixDropWidthTimer && (clearTimeout(e.fixDropWidthTimer),
            e.fixDropWidthTimer = null),
            e.results_showing && (e.result_clear_highlight(),
            e.container.removeClass("chosen-with-drop"),
            e.form_field_jq.trigger("chosen:hiding_dropdown", {
                chosen: e
            }),
            e.drop_directionFixed = 0),
            e.results_showing = !1
        }
        ,
        ...
        n.prototype.set_label_behavior = function() {
            ...
            this.form_field_label.length > 0 ? this.form_field_label.bind("click.chosen", function(e) {
        ...
        n.prototype.search_results_mouseup = function(t) {
            var n;
            return n = e(t.target).hasClass("active-result") ? e(t.target) : e(t.target).parents(".active-result").first(),
            n.length ? (this.result_highlight = n,
        ...
        n.prototype.choice_build = function(t) {
            ...
            return n = e("<li />", {
                "class": "search-choice"
            }).html("<span title='" + t.html + "'>" + t.html + "</span>"),
        ...
        n.prototype.single_set_selected_text = function(e) {
            ...
            this.compact_search && this.search_field.attr("placeholder", e),
        ...
        n.prototype.winnow_results_set_highlight = function(e) {
            var t, n;
            return n = this.is_multiple ? [] : this.search_results.find(".result-selected.active-result"),
            t = n.length ? n.first() : this.search_results.find(".active-result").first(),
            null != t ? this.result_do_highlight(t, e) : void 0
        }
        ,
...
$("body").on("mouseenter", ".footer-nav-tabs li", function() {
    ...
    $(this).parents(".footer-nav").find(".footer-nav-con").each(function(t, n) {
        $(n).removeClass("active"),
        $(n).index() === e && $(n).addClass("active")
    })
}),
$("body").on("click", "#showMoreFeaturesInfo", function() {
    "收起" === $(this).text() ? ($(this).find("span").text("更多"),
    $(this).parents(".alert").css("height", "208px")) : ($(this).find("span").text("收起"),
...
$(document).ready(function() {
    ...
    var e = $(window).outerHeight()
      , t = $("body").outerHeight();
    e > t + 40 && document.getElementsByClassName("html-footer3").length && ($(".html-footer3").addClass("fixed bottom-0 left-0"),
    $(".html-footer3").css("position", "fixed"),
...
String.prototype.MD5PRO = function(e) {
    ...
    function d(e, i, o, r, s, l, c) {
        return e = n(e, n(n(a(i, o, r), s), c)),
        n(t(e, l), i)
    }
    function u(e) {
        for (var t, n = e.length, i = n + 8, o = (i - i % 64) / 64, r = 16 * (o + 1), a = Array(r - 1), s = 0, l = 0; n > l; )
            t = (l - l % 4) / 4,
            s = 8 * (l % 4),
    ...
    var h, f, g, m, v, y, b, x, $, w = this, _ = Array(), C = 7, k = 12, E = 17, T = 22, S = 5, j = 9, A = 14, M = 20, I = 4, N = 11, D = 16, B = 23, L = 6, P = 10, H = 15, O = 21;
    for (_ = u(w),
    y = 1732584193,
    b = 4023233417,
    x = 2562383102,
    ...
    h = 0; h < _.length; h += 16)
        ...
        m = x,
        v = $,
        y = s(y, b, x, $, _[h + 0], C, 3614090360),
        $ = s($, y, b, x, _[h + 1], k, 3905402710),
        x = s(x, $, y, b, _[h + 2], E, 606105819),
        b = s(b, x, $, y, _[h + 3], T, 3250441966),
        y = s(y, b, x, $, _[h + 4], C, 4118548399),
        $ = s($, y, b, x, _[h + 5], k, 1200080426),
        x = s(x, $, y, b, _[h + 6], E, 2821735955),
        b = s(b, x, $, y, _[h + 7], T, 4249261313),
        y = s(y, b, x, $, _[h + 8], C, 1770035416),
        $ = s($, y, b, x, _[h + 9], k, 2336552879),
        x = s(x, $, y, b, _[h + 10], E, 4294925233),
        b = s(b, x, $, y, _[h + 11], T, 2304563134),
        y = s(y, b, x, $, _[h + 12], C, 1804603682),
        $ = s($, y, b, x, _[h + 13], k, 4254626195),
        x = s(x, $, y, b, _[h + 14], E, 2792965006),
        b = s(b, x, $, y, _[h + 15], T, 1236535329),
        y = l(y, b, x, $, _[h + 1], S, 4129170786),
        $ = l($, y, b, x, _[h + 6], j, 3225465664),
        x = l(x, $, y, b, _[h + 11], A, 643717713),
        b = l(b, x, $, y, _[h + 0], M, 3921069994),
        y = l(y, b, x, $, _[h + 5], S, 3593408605),
        $ = l($, y, b, x, _[h + 10], j, 38016083),
        x = l(x, $, y, b, _[h + 15], A, 3634488961),
        b = l(b, x, $, y, _[h + 4], M, 3889429448),
        y = l(y, b, x, $, _[h + 9], S, 568446438),
        $ = l($, y, b, x, _[h + 14], j, 3275163606),
        x = l(x, $, y, b, _[h + 3], A, 4107603335),
        b = l(b, x, $, y, _[h + 8], M, 1163531501),
        y = l(y, b, x, $, _[h + 13], S, 2850285829),
        $ = l($, y, b, x, _[h + 2], j, 4243563512),
        x = l(x, $, y, b, _[h + 7], A, 1735328473),
        b = l(b, x, $, y, _[h + 12], M, 2368359562),
        y = c(y, b, x, $, _[h + 5], I, 4294588738),
        $ = c($, y, b, x, _[h + 8], N, 2272392833),
        x = c(x, $, y, b, _[h + 11], D, 1839030562),
        b = c(b, x, $, y, _[h + 14], B, 4259657740),
        y = c(y, b, x, $, _[h + 1], I, 2763975236),
        $ = c($, y, b, x, _[h + 4], N, 1272893353),
        x = c(x, $, y, b, _[h + 7], D, 4139469664),
        b = c(b, x, $, y, _[h + 10], B, 3200236656),
        y = c(y, b, x, $, _[h + 13], I, 681279174),
        $ = c($, y, b, x, _[h + 0], N, 3936430074),
        x = c(x, $, y, b, _[h + 3], D, 3572445317),
        b = c(b, x, $, y, _[h + 6], B, 76029189),
        y = c(y, b, x, $, _[h + 9], I, 3654602809),
        $ = c($, y, b, x, _[h + 12], N, 3873151461),
        x = c(x, $, y, b, _[h + 15], D, 530742520),
        b = c(b, x, $, y, _[h + 2], B, 3299628645),
        y = d(y, b, x, $, _[h + 0], L, 4096336452),
        $ = d($, y, b, x, _[h + 7], P, 1126891415),
        x = d(x, $, y, b, _[h + 14], H, 2878612391),
        b = d(b, x, $, y, _[h + 5], O, 4237533241),
        y = d(y, b, x, $, _[h + 12], L, 1700485571),
        $ = d($, y, b, x, _[h + 3], P, 2399980690),
        x = d(x, $, y, b, _[h + 10], H, 4293915773),
        b = d(b, x, $, y, _[h + 1], O, 2240044497),
        y = d(y, b, x, $, _[h + 8], L, 1873313359),
        $ = d($, y, b, x, _[h + 15], P, 4264355552),
        x = d(x, $, y, b, _[h + 6], H, 2734768916),
        b = d(b, x, $, y, _[h + 13], O, 1309151649),
        y = d(y, b, x, $, _[h + 4], L, 4149444226),
        $ = d($, y, b, x, _[h + 11], P, 3174756917),
        x = d(x, $, y, b, _[h + 2], H, 718787259),
        b = d(b, x, $, y, _[h + 9], O, 3951481745),
        y = n(y, f),
        b = n(b, g),
        x = n(x, m),
        $ = n($, v);
...
,
$(".uploader") && "IE" === myBrowser() && ($(".uploader").children("*").css("position", "relative").css("z-index", "99"),
$(".uploader").addClass("progress-0")),
$(window).ready(function() {
    var e = $(window).outerHeight();
    $(".md-toc").height(e - 300)
});
var ranChildNode = setInterval(function() {
    var e = getChildren(document.getElementsByClassName("container")[0]);
    if ("none" === e[0].style.display) {
        var t = getChildrens(document.getElementsByTagName("body")[0])
          , n = 2 * Math.random();
        n = Math.floor(n);
        var i = "uni-" + randomString(15);
        dynamicCss(i);
        for (var o = document.createElement(i), r = e[0].querySelectorAll("a"), a = 0; a < r.length; a++) {
            var s = "a" + randomString(10)
              , l = document.createElement(s);
            r[a].style.fontSize ? l.style.fontSize = r[a].style.fontSize : "",
            r[a].style.color ? l.style.color = r[a].style.color : "",
            l.innerHTML = r[a].innerText,
            l.dataset.href = r[a].href,
            l.onclick = function() {
                var e = window.open("about:blank");
                e.location.href = this.dataset.href
            }
            ,
            o.appendChild(l)
        }
        switch (n) {
        case 0:
            document.getElementsByTagName("body")[0].insertBefore(o, t);
            break;
        case 1:
            document.getElementsByTagName("body")[0].insertAfter(o, t);
            break;
        default:
            document.getElementsByTagName("body")[0].insertBefore(o, t)
        }
        clearInterval(ranChildNode)
    }
}, 1e3);
...
$("#validates").click(function() {
    indexFormat(),
    $(this).attr("data-html") && "index" === $(this).attr("data-html") && localStorage.setItem("lastJsonData", editor.getValue())
}),
...
$("body").on("click", "#saveData", function() {
    ...
    if (e) {
        var t;
        e = "object" == typeof e ? JSON.stringify(e) : e.toString(),
        confirmInput({
            title: "请为当前的数据命名",
            success: function(n) {
                n && ($("#daveDataList").removeClass("empty-list"),
                my_lzma || (my_lzma = new LZMA("/static/bejson/js/lzma_worker.js")),
                my_lzma.compress(e, 1, function(e) {
                    if (e === !1)
                        return msgError("An error occurred during LZMA compression."),
                        void 0;
                    ...
                    o && o.length ? o.unshift(i) : (o = [],
                    o.unshift(i)),
                    $.zui.store.set("saved_json", o);
                    var r = document.createDocumentFragment();
                    $(o).each(function(e, t) {
                        var n = document.createElement("li");
                        n.className = "border-bottom-d-color",
                        n.innerHTML = '<p class="line-h-2-4 display-block clear-both no-margin-b cursor-pointer">\n<span class="save-title float-left text-ellipsis">' + t.name + "</span>\n" + '<span class="text-info-9 float-right font-12">' + t.time + "</span>\n" + '<span class="display-none data">' + t.data + "</span>\n" + "</p>",
                        r.appendChild(n)
                    }),
                    $("#daveDataList").html(""),
                    document.getElementById("daveDataList").appendChild(r),
                    $("#confirmInputModal").modal("hide", "fit")
                }, function() {}))
            }
        })
    } else
...
$("body").on("click", "#removeData", function() {
    $("#daveDataList").addClass("empty-list"),
    $.zui.store.remove("saved_json"),
    $("#daveDataList").html("")
}),
$("body").on("click", "#daveDataList li", function() {
    ...
    return 0 == t ? (msgError("invalid compressed input"),
    !1) : (my_lzma.decompress(t, function(e) {
        return e === !1 ? (msgError("An error occurred during decompression."),
        void 0) : (editor.setValue(e),
        localStorage.setItem("lastJsonData", editor.getValue()),
        void 0)
    }, function() {}),
    void 0)
...
$("body").on("click", ".form-emoji-group li", function() {
    ...
    t ? t += e : t = e,
    $(this).parents("form").find("textarea").eq(0).val(t)
});
...
$("#commentSubmit").click(function() {
    ...
    if (!t)
        return msgError("请输入昵称"),
        void 0;
    if (!n)
        return msgError("请输入正确的邮箱"),
        void 0;
    if (e) {
        $("#commentsBox").toggleClass("loading");
        var i = $(this).parents("form")[0]
          , o = new FormData(i);
        o.append("img-files", submitGetAndShow.uploadImgArr),
        doPost("http://www.bejson.com", o, function() {}, function() {
            alertError({
                con: "提交失败，请稍候重试"
            }),
            $("#commentsBox").toggleClass("loading")
...
$("body").on("click", "#commentsList .replayBtn", function() {
    replayGetAndShow.imgCount = 0,
    replayGetAndShow.uploadImgArr = [],
    $("#commentsList .reply-form").remove(),
...
$("body").on("click", "#commentsList .replay-btn", function() {
    ...
    if (e) {
        ...
        var i = $(this).parents("form")[0]
          , o = new FormData(i);
        o.append("img-files", replayGetAndShow.uploadImgArr),
        doPost("http://www.bejson.com", o, function() {}, function() {
            alertError({
                con: "提交失败，请稍候重试"
            }),
...
new ClipboardJS("#copyJson",{
    text: function() {
        return editor.getValue() ? (msgSuccess("复制成功"),
        editor.getValue()) : !1
    }
}),
resizeCodemirror(["#resizePre"], ["#codeBox"], 168, "pre"),
resizeCodemirror(["#resizePre1"], ["#codeBox1"], 168, "pre"),
resizeCodemirror(["#resizePre2"], ["#codeBox2"], 168, "pre"),
resizeCodemirror(["#resizePre3"], ["#codeBox3"], 168, "pre"),
resizeCodemirror(["#resize"], ["#editor"], 360),
resizeCodemirror(["#resize1"], ["#editor1"], 360),
resizeCodemirror(["#resize2"], ["#editor2"], 360),
resizeCodemirror(["#resize3"], ["#editor3"], 360),
resizeCodemirror(["#resize4"], ["#editor4"], 200),
resizeCodemirror(["#resize5"], ["#editor5"], 130),
resizeCodemirror(["#resize6", "#resize7"], ["#editor6", "#editor7"], 200),
$("#eT").dblclick(function() {
    jsonVal = jsl.format.formatJson($("#eT").val()),
    $("#eT").val(jsonVal)
}),
...
$("#chSignToEn").click(function() {
    var e = editor.getValue();
    e = e.replace(/，/g, ",").replace(/。/gi, ".").replace(/“/gi, '"').replace(/；/gi, ";").replace(/”/gi, '"').replace(/【/gi, "[").replace(/】/gi, "]"),
...
$("#javaBeanOldEditor").keyup(function() {
    try {
        ...
        document.getElementById("jsonlintResult").innerHTML = t,
        $("#jsonlintBox").addClass("alert-danger alert").removeClass("alert-warning alert-success"),
        $("#jsonlintIcon").addClass("icon-remove-sign").removeClass("icon-info-sign icon-ok-sign")
    }
}),
...
new ClipboardJS("#copyJavaBean",{
    text: function() {
        return $("#resData").text() ? (msgSuccess("复制成功"),
        $("#resData").text()) : (msgError("复制失败"),
        !1)
    }
}),
...
$("#clearCode").click(function() {
    editor.setValue(""),
    document.getElementById("jsonlintBox") && $("#jsonlintBox").hide()
}),
...
$("#resizeFmt").draggable({
    ...
    drag: function(e) {
        $("#resultPre .Canvas").height(e.offset.y + resultPreHeight > 200 ? e.offset.y + resultPreHeight : 200)
    },
    finish: function() {}
}),
...
$("#json2xml").click(function(e) {
    try {
        ...
        if (result) {
            ...
            editor2.setValue(formatXml(xotree.writeXML(json))),
            $("#jsonlintResult").html("正确的JSON!"),
            $("#jsonlintBox").addClass("alert-success alert").removeClass("alert-warning alert-danger"),
            $("#jsonlintIcon").addClass("icon-ok-sign").removeClass("icon-info-sign icon-remove-sign")
        }
    } catch (e) {
...
$("#resetCode").click(function() {
    editor.setValue(""),
    editor2.setValue(""),
    document.getElementById("jsonlintBox") && $("#jsonlintBox").removeClass("alert-success alert alert-danger")
}),
$("#downloadEditor").click(function() {
    var e = $(this).attr("data-suffix");
    editor.getValue() ? e ? downloadZip4("." + e, e, e + "." + e, editor.getValue()) : downloadZip4(".json", "json", "json.json", editor.getValue()) : msgError("暂无数据可以保存")
}),
$("#downloadEditor2").click(function() {
    var e = $(this).attr("data-suffix");
    editor2.getValue() ? e ? downloadZip4("." + e, e, e + "." + e, editor2.getValue()) : downloadZip4(".xml", "xml", "xml.xml", editor2.getValue()) : msgError("暂无数据可以保存")
}),
$("#downloadPre").click(function() {
    var e = $(this).attr("data-suffix");
    $("#storeEncode").html() ? e ? downloadZip4("." + e, e, e + "." + e, $("#storeEncode").html()) : downloadZip4(".js", "js", "js.js", $("#storeEncode").html()) : msgError("暂无数据可以保存")
}),
$("#downloadTextarea").click(function() {
    var e = $(this).attr("data-suffix");
    $("#storeEncode").val() ? e ? downloadZip4("." + e, e, e + "." + e, $("#storeEncode").val()) : downloadZip4(".js", "js", "js.js", $("#storeEncode").val()) : msgError("暂无数据可以保存")
}),
...
new ClipboardJS("#copyEditor2",{
    text: function() {
        return editor2.getValue() ? (msgSuccess("复制成功"),
        editor2.getValue()) : !1
    }
}),
new ClipboardJS("#copyEditor3",{
    text: function() {
        return editor3.getValue() ? (msgSuccess("复制成功"),
        editor3.getValue()) : !1
    }
}),
new ClipboardJS("#copyPre",{
    text: function() {
        return $("#storeEncode").html() ? (msgSuccess("复制成功"),
        $("#storeEncode").html()) : !1
    }
}),
new ClipboardJS("#copyTextarea",{
    text: function() {
        return $("#storeEncode").val() ? (msgSuccess("复制成功"),
        $("#storeEncode").val()) : !1
    }
}),
...
$("#yamlEditor").keyup(function() {
    ...
    if (e)
        try {
            ...
            document.getElementById("jsonlintResult").innerHTML = n,
            $("#jsonlintBox").addClass("alert-danger alert").removeClass("alert-warning alert-success"),
            $("#jsonlintIcon").addClass("icon-remove-sign").removeClass("icon-info-sign icon-ok-sign")
        }
    else
        document.getElementById("jsonlintResult").innerHTML = "yamld代码不能为空",
        $("#jsonlintBox").addClass("alert-danger alert").removeClass("alert-warning alert-success"),
        $("#jsonlintIcon").addClass("icon-remove-sign").removeClass("icon-info-sign icon-ok-sign")
}),
$("#lockBase64").click(function() {
    var e = Util.charset
      ...
      , n = "";
    n = "utf-8" === t ? e.Base64.encode(editor.getValue(), "utf8") : "gbk" === t ? e.Base64.encode(editor.getValue(), "gbk") : e.Base64.encode(editor.getValue(), "utf8", !0),
    n ? editor2.setValue(n) : msgError("加密的文本有误，请检查后重试")
}),
$("#unlockBase64").click(function() {
    var e = Util.charset
      , t = $("#selectedCodeType").val()
      , n = "";
    n = "utf-8" === t ? e.Base64.decode(editor.getValue(), "utf8") : "gbk" === t ? e.Base64.decode(editor.getValue(), "gbk") : e.Base64.decode(editor.getValue(), "utf8", !0),
...
$("#md5Encryption").click(function() {
    ...
    if (e) {
        ...
        $(".md5-result input").each(function(e, i) {
            0 === e ? $(i).val(n.toUpperCase()) : 1 === e ? $(i).val(n.toLowerCase()) : 2 === e ? $(i).val(t.toUpperCase()) : $(i).val(t.toLowerCase())
        })
    } else
        msgError("要加密的内容能不能为空")
}),
$("#clearCodeMd5").click(function() {
    editor.setValue(""),
    $(".md5-result input").val("")
}),
...
$("#rsaCmd li").click(function() {
    ...
    case "buildRSADecryptByPrivateKey":
        $("#rsaCon1").html("请输入私钥"),
        $("#rsaCon2").html("请输入要解密的签名"),
        $("#rsaCreate").hide(),
        $("#rsaEncry").removeClass("height-0");
        break;
    case "buildRSAEncryptByPrivateKey":
        $("#rsaCon1").html("请输入私钥"),
        $("#rsaCon2").html("请输入要加密的字符串"),
        $("#rsaCreate").hide(),
        $("#rsaEncry").removeClass("height-0");
        break;
    case "buildRSAEncryptByPublicKey":
    ...
    case "0":
        $("#rsaCreate").show(),
        $("#rsaEncry").addClass("height-0")
    }
}),
new ClipboardJS("#rsaCopyPublic",{
    text: function() {
        var e = $("#rsaPublic").val();
        return e ? (msgSuccess("复制成功"),
        e) : !1
    }
}),
...
$("#rsaCreateBtn").click(function() {
    ...
    console.log(o),
    $("body").toggleClass("loading"),
    doPost(i, o, function(e) {
        200 === e.code || "200" === e.code ? ($("#rsaPublic").val(e.data.public),
        $("#rsaPrivate").val(e.data.private)) : alertError({
            con: e.msg
        }),
        $("body").toggleClass("loading")
    }, function() {
...
$("#lockUrl").click(function() {
    editor2.setValue(encodeURI(editor.getValue())),
    $("#editor7").show(),
    $("#editor6").addClass("left-editor"),
...
$("#unlockUrl").click(function() {
    ...
    $("#editor7").hide(),
    $("#editor6").removeClass("left-editor")
}),
...
$("#jjencode").click(function() {
    var e, t = editor.getValue(), n = $("#className").val() || "$", i = $("#palindrome").prop("checked");
    e = jjencode(n, t),
    i && (e = e.replace(/[,;]$/, ""),
...
$("#barcodeGenBtn").click(function() {
    var e = $("#codeText").val()
      ...
      , c = "left";
    $("#textleft").prop("checked") ? c = "left" : $("#textcenter").prop("checked") ? c = "center" : $("#textright").prop("checked") && (c = "right"),
    l || (t = ""),
    JsBarcode("#barcode1", e, {
        textPosition: "bottom",
        font: "cursive",
        fontOptions: "bold",
        background: o,
...
$("#fanyi").click(function() {
    if (!editor.getValue())
        return msgError("请输入要翻译的文本"),
        void 0;
    var e = bejsonHost + "Bejson/Api/Zh2en/toEnglish"
      , t = {
        word: editor.getValue()
    };
    "zh" === $("#language").val() && (e = bejsonHost + "Bejson/Api/Zh2en/toChinese",
    t = {
        eng_word: editor.getValue()
    }),
    $("body").toggleClass("loading"),
    doPost(e, t, function(e) {
...
$("#userfullreg button").click(function() {
    $("#codeText").val($(this).data("code")),
    $("#regdemo").val($(this).data("demo"))
}),
...
$("#regexCreateGenBtn").click(function() {
    ...
    if (null != e && "" != e) {
        for (var t = Object.keys(regexCreateCodes), n = Object.values(regexCreateCodes), i = "", o = 0; o < t.length; o++) {
            ...
            r = r.replace("{<1>}", $("#regdemo").val()),
            i += '<div class="thumbnail relative"><div class="caption"><h3>' + t[o] + '</h3><pre class="  linenums">' + r + '</pre></div><button class="btn btn-sm regex-create-copy">复制</button></div> '
        }
        $("#codes").html(i)
    }
}),
...
$("#sortWordsBtn").click(function() {
    ...
    var t = $(this);
    t.button("loading"),
    doPost(bejsonHost + "Bejson/Api/Sortwords/sortChinese", {
        word: e
    }, function(e) {
        var n = ""
          , i = e.data
...
document.getElementById("uploaderLogo") && getCaptcha(),
$("#captcha").click(function() {
    getCaptcha()
}),
$("#createLogo").click(function() {
    if (!$("#logoCaptcha").val())
        return msgError("请输入验证码"),
        void 0;
    if (uploaderLogo.getFiles().length) {
        $("#uploadLogoBtn").button("loading"),
        $("#createLogo").button("loading");
...
$("#uploaderLogo").on("click", ".btn-reset-file", function() {
    ...
    $("#uploadLogoBtn").button("loading"),
    $("#createLogo").button("loading"),
    $(uploaderLogo.getFiles()).each(function(t, n) {
        if ("file-" + n.id === e) {
            var i = n.getNative();
...
$("#ocrUploadeImg").click(function() {
    if (uploaderOcr.getFiles().length > 0) {
        var e = $(this);
        e.button("loading"),
        ocrQiniuUploader(e, uploaderOcr.getFiles()[0].getNative(), "#file-" + uploaderOcr.getFiles()[0].id)
    } else
        msgError("请上传本地图片")
}),
$("#uploaderOcr").on("click", ".btn-reset-file", function() {
    ...
    t.button("loading"),
    $(uploaderImg2Svg.getFiles()).each(function(n, i) {
...
$("#ocrSelectWebUrl").click(function() {
    confirmInput({
        ...
        btnTitle: ["取消", "生成"],
        success: function(e) {
            e ? ($("#confirmInputModal").modal("hide", "fit"),
            $("#ocrUploadeImg").button("loading"),
            $("body").toggleClass("loading"),
            doPost(bejsonHost + "Bejson/Api/DistinguishString/ocrFromPicture", {
                path: e,
                language: $("#orcLanguage").val()
...
$("#wordpressCheck").click(function() {
    ...
    var e = $("#codeText").val();
    if (!e)
        return msgError("请输入博客网址"),
        void 0;
    $("#res").html('<div class="alert" role="alert">查询中....请稍等</div>');
    var t = $(this);
    t.button("loading"),
    doPost(bejsonHost + "Bejson/Api/WordpressTheme/getThemInfo", {
        url: e
    }, function(e) {
        if (200 === e.code || "200" === e.code) {
            var n = "";
            n = -1 == e.data.screenshot.indexOf("http") ? '<a class="card col-sm-6 col-md-4" href="u">\n  <img src="http://' + e.data.screenshot + '" alt="">\n' + '  <div class="card-heading"><strong>解析结果</strong></div>\n' + '  <div class="card-content text-muted">' + e.data.desc + "</div>\n" + "</a>" : '<a class="card" href="u">\n  <img src="' + e.data.screenshot + '" alt="">\n' + '  <div class="card-heading"><strong>解析结果</strong></div>\n' + '  <div class="card-content text-muted">' + e.data.desc + "</div>\n" + "</a>",
            $("#res").html(n)
        } else
            $("#res").html('<div class="alert alert-danger" role="alert">' + e.msg + "</div>");
        t.button("reset")
    }, function() {
        t.button("reset"),
        msgError("获取失败，请稍候重试")
...
$("#pic2WeiboCheck").click(function() {
    if (!$("#codeText").val())
        return msgError("微博图片地址不能为空"),
        void 0;
    var e = $(this);
    e.button("loading"),
    doPost(bejsonHost + "Bejson/Api/PicToWeibo/toWeibo", {
        url: $("#codeText").val()
    }, function(t) {
        200 === t.code || "200" === t.code ? $("#res").html('<a href="' + t.data + '" target="_blank">图片出处:' + t.data + "</a>") : alertError({
            con: t.msg
        }),
        e.button("reset")
    }, function() {
...
$("#htmlJsJs2html").click(function() {
    htmlJsType = 2,
    -1 == editor.getValue().indexOf("var") ? msgError("转换值不是js代码!") : (htmlJsConvert(),
    $("#downloadEditor2").attr("data-suffix", $(this).attr("data-suffix")))
}),
$("#htmlJsDemo").click(function() {
    var e = '<div id="app" class="body-container">\n    <div class="spinner">\n      <div class="spinner-container container1">\n          <div class="circle1"></div>\n          <div class="circle2"></div>\n          <div class="circle3"></div>\n          <div class="circle4"></div>\n      </div>\n      <div class="spinner-container container2">\n          <div class="circle1"></div>\n          <div class="circle2"></div>\n          <div class="circle3"></div>\n          <div class="circle4"></div>\n      </div>\n      <div class="spinner-container container3">\n          <div class="circle1"></div>\n          <div class="circle2"></div>\n          <div class="circle3"></div>\n          <div class="circle4"></div>\n      </div>\n    </div>\n  </div>';
    editor.setValue(e)
}),
...
window.img2SvgFilename = "",
window.img2SvgKeystr = "",
new ClipboardJS(".svg-copy",{
    text: function(e) {
...
$("#hexInp").keyup(function() {
    var e = $(this).val().trim();
    if (e.startWith("#") && (e = e.substr(1, e.length)),
    3 == e.length) {
        var t = e.split("");
        _a1 = t[0],
        _a2 = t[1],
        _a3 = t[2],
        e = _a1 + _a1 + _a2 + _a2 + _a3 + _a3
    }
    var n = HexToRGB(e);
    appendRgb.checked && (n = "rgb(" + n + ")"),
    $("#outRgb").val(n),
    appendRgb.checked ? $(".hexspan").css({
        background: n
    }) : $(".hexspan").css({
        background: "rgb(" + n + ")"
    })
...
$("#rgbInp").keyup(function() {
    var e = $(this).val();
    e = e.toUpperCase(),
    e.startsWith("RGB") && (e = e.replace("RGB(", "").replace(")", ""));
    var t = "";
    -1 != e.indexOf(",") ? t = e.split(",") : -1 != e.indexOf(" ") && (t = e.split(" ")),
    $(".rgbspan").css({
...
$("#encodeLoadUrlImg").on("click", function() {
    ...
    $("#uploadQrcodeLogo").val(""),
    document.getElementById("uploadFile").value = "",
    t ? ($(n).data("logo", ""),
    renderLogo(n, t, e)) : (msgError("网络图片地址不能为空"),
    e.button("reset"))
}),
$("#encodeCreateQrcode").on("click", function() {
    ...
    var t = {}
      , n = $("#encode-canvas");
    return t.text = $("#encode-text").val(),
    t.render = $("#encode-render").val(),
    t.bgColor = $("#encode-bgcolor").val(),
    t.moduleColor = $("#encode-mcolor").val(),
    t.moduleSize = $("#encode-msize").val(),
    t.mode = Number($("#encode-mode").val()),
    t.ECLevel = Number($("#encode-eclevel").val()),
    t.margin = Number($("#encode-margin").val()),
    t.logo = $("#logo-canvas").data("logo"),
    t.error = function(t) {
        throw n.html(""),
        msgError("生成二维码错误，请检查您的设置"),
        e.button("reset"),
        $("#downloadQrcode").hide(),
        t
    }
    ...
    t.text ? (n.QREncode(t),
    $(this).button("reset"),
    "canvas" === $("#encode-render").val() ? $("#downloadQrcode").show() : $("#downloadQrcode").hide(),
    void 0) : (msgError("请输入文本"),
    $(this).button("reset"),
    void 0)
}),
...
$("#decodeQrcodeBtn").on("click", function() {
    ...
    result = $("#decode-canvas").QRDecode(function(e) {
        throw $("#decoderes").val(""),
        msgError("生成二维码失败，请检查二维码是否变形或有额外水印"),
        e
    }),
    result && ($("#decode-text").show(),
...
$("#uploadQrcodeLogo").change(function(e) {
    ...
    var t = $("#logo-canvas")[0]
      ...
      , i = new FileReader;
    i.onload = function(e) {
        $(t).data("logo", e.target.result),
        renderLogo(t, e.target.result)
    }
    ,
    n && i.readAsDataURL(n)
}),
...
window.imghandlerFilename = "",
$("body").on("click", ".image-handler-start", function() {
...
$("#createFavicon").click(function() {
    if (uploaderIcon.getFiles().length) {
        $("#uploadIconBtn").button("loading"),
        $("#createFavicon").button("loading");
        ...
        if ($(this).attr("data-id") === t) {
            ...
            return createIcon(globalIcoSrc, n),
            $("#uploadIconBtn").button("reset"),
            $("#createFavicon").button("reset"),
            void 0
        }
...
$("#imangeHandler").on("click", ".btn-reset-file", function() {
    ...
    $("#uploadIconBtn").button("loading"),
    $("#createFavicon").button("loading"),
    $(uploaderIcon.getFiles()).each(function(t, n) {
...
$("#shorturlClearBtn").click(function() {
    document.getElementById("shorturlContent").value = "",
    document.getElementById("shorturlResult").value = "",
    document.getElementById("shorturlContent").select()
}),
$("#shorturlEncode").click(function() {
    shorturlEncode(),
    $("#shorturlEncode").button("loading")
}),
$("#shorturlDecode").click(function() {
    shorturlDecode(),
    $("#shorturlDecode").button("loading")
}),
...
$("#uploaderFile2Pdf").on("click", ".btn-reset-file", function() {
    var e = $(this).parents(".file").attr("id")
      , t = $(".uploader-btn-browse");
    t.button("loading"),
    $(uploaderFile2Pdf.getFiles()).each(function(n, i) {
        "file-" + i.id === e && qiniuFile2PdfUploader(t, i, "#" + e)
    })
}),
$("#num2hzClearBtn").click(function() {
    document.getElementById("num2hzStr").value = "",
    document.getElementById("num2hzEstr").value = "",
    document.getElementById("num2hzEstr2").value = "",
    document.getElementById("num2hzStr").select()
}),
...
$("#softJavatools1").append(softParse(softJavatools)),
$("#softDevtools").append(softParse(softDevtools)),
$("#softNettools1").append(softParse(softNettoolsstr)),
$("#softUitools1").append(softParse(softUitools)),
$("#softOthertools1").append(softParse(softOthertools)),
$("#softSysenv1").append(softParse(softSysenv));
for (var blogs = [{
    title: "三叔的博客",
    user: "三叔",
    url: "http://sanshu.cn",
    desc: "有人的地方就有江湖。有缘我们江湖相见",
    tag: "Java,SEO,做站经验"
}, {
    title: "色魔科技",
    user: "色魔",
    ...
    if ("" != blog.title) {
        var tag = blog.tag
          , tagh = "";
        if (-1 != tag.indexOf(","))
            for (var tags = tag.split(","), j = 0; j < tags.length; j++)
                tagh += '<span class="btn btn-sm l-big-margin">' + tags[j] + "</span>";
        else
            tagh = '<span class="color5">' + blog.tag + "</span>";
...
if (document.getElementById("blogsDiv") && $("#blogsDiv").html(blogHtml),
...
$("#aceEditorExpand").click(function() {
    ...
    $("#aceEditor").addClass("aceFullEditor"),
    $("#aceEditorCollapse").show(),
    $("#aceEditorCopy").show(),
    aceEditor.resize()
}),
$("#aceEditorCollapse").click(function() {
    $("body").removeClass("overflow-hidden"),
    $("#aceEditor").removeClass("aceFullEditor"),
    $("#aceEditorCopy").hide(),
    $("#aceEditorCollapse").hide(),
    aceEditor.resize()
}),
...
$("#fs2 tr").hover(function() {
    $(this).find("i").eq(0).css("transform", "scale(2)"),
    $(this).find("i").eq(0).css("-webkit-transform", "scale(2)"),
    $(this).find("i").eq(0).css("-o-transform", "scale(2)"),
    $(this).find("i").eq(0).css("-ms-transform", "scale(2)")
}, function() {
    $(this).find("i").eq(0).css("transform", "scale(1)"),
    $(this).find("i").eq(0).css("-webkit-transform", "scale(1)"),
    $(this).find("i").eq(0).css("-o-transform", "scale(1)"),
    $(this).find("i").eq(0).css("-ms-transform", "scale(1)")
}),
...
$("#getColorBox td").click(function() {
    ...
    $("#getColorHex").val(e),
    $("#getColorAddon").css("background-color", e)
}),
...
$("#sql2pojoChangeBtn").click(function() {
    return editor.getValue() ? (sql2pojoOchange(),
    void 0) : (msgError("请输入sql语句"),
    void 0)
}),
...
$("#sqlviewCreate").click(function() {
    return editor.getValue() ? ($("#sqlviewCreate").button("loading"),
    sqlviewConvert(),
    void 0) : (msgError("请输入sql语句"),
    void 0)
}),
...
$("#properties2yamlDemo").click(function() {
    var e = "dubbo.registry.address=zookeeper://10.0.65.3:2181\ndubbo.admin.root.password=root\ndubbo.admin.guest.password=guest";
    editor.setValue(e)
}),
$("#properties2yamlConvert").click(function() {
    return editor.getValue() ? ($("#properties2yamlConvert").button("loading"),
    properties2yamlConvert(),
    void 0) : (msgError("请输入properties代码"),
    void 0)
}),
...
$("#checkIp").click(function() {
    return $("#queryIp").val() ? ($(this).button("loading"),
    $("#queryipBox").addClass("loading"),
    getIpinfo($("#queryIp").val()),
    void 0) : (msgError("请输入IP"),
    void 0)
}),
...
$("#ip2addrStart").click(function() {
    return "" === $("#ip2addrIp").val() ? (msgError("请填写IP"),
    void 0) : ($("#ip2addrStart").button("loading"),
    doPost(bejsonHost + "Bejson/Api/LocationByIP/getLocByIP", {
        ...
        if (200 === e.code || "200" === e.code)
            if (1 === t.data.status || "1" === t.data.status) {
                for (var n = t.data.data, i = n.country + " " + n.province + " " + n.city + " " + n.district + " 大概位置:" + n.pos, o = n.poi_list, r = "", a = 0; a < o.length; a++) {
                    r += " <tr>";
                    var s = o[a];
                    r += "<td>【" + s.name + '】</td><td class="address-con">' + s.address + '</td><td class="ip2addr-btn"><button class="btn" type="button">复制地址</button></td>',
                    r += "</tr>"
                }
                $("#addr").text(i),
                $("#addrs").html(r)
...
document.getElementById("useragentCua") && (userAgentParseHtml("pcd", userAgentPcj),
userAgentParseHtml("mbd", userAgentMbj),
userAgentParseHtml("wxInAndroid", useragentWxInAndroid),
userAgentParseHtml("wxInIos", useragentWxInIos),
new ClipboardJS(".copy-agent",{
    text: function(e) {
...
$("#ip2intClear").click(function() {
    document.getElementById("ip2intStr").value = "",
    document.getElementById("ip2intRstr").value = ""
}),
...
$("#xmlsortSort").click(function() {
    if (!editor.getValue())
        return msgError("请贴入xml代码"),
        void 0;
    var e = $(this);
    e.button("loading"),
    doPost(bejsonHost + "Bejson/Api/Xml/xmlsort", {
        xml: editor.getValue()
    }, function(t) {
...
$("#sql2charpCreate").click(function() {
    return editor.getValue() ? ($(this).button("loading"),
    doSql2csharppojo(),
    void 0) : (msgError("请贴入sql代码"),
    void 0)
});
